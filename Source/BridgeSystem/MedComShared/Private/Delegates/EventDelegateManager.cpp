...
void UEventDelegateManager::Initialize(FSubsystemCollectionBase& Collection)
{
...
void UEventDelegateManager::Deinitialize()
{
...
UEventDelegateManager* UEventDelegateManager::Get(const UObject* WorldContext)
{
    if (!WorldContext)
    {
...
void UEventDelegateManager::NotifyUIWidgetCreated(UUserWidget* Widget)
{
...
void UEventDelegateManager::NotifyUIWidgetDestroyed(UUserWidget* Widget)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyUIVisibilityChanged(UUserWidget* Widget, bool bIsVisible)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyHealthUpdated(float CurrentHealth, float MaxHealth, float HealthPercent)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyStaminaUpdated(float CurrentStamina, float MaxStamina, float StaminaPercent)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyCrosshairUpdated(float Spread, float Recoil)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyCrosshairColorChanged(const FLinearColor& NewColor)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyUI(const FString& Message, float Duration)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyCharacterScreenOpened(UObject* Screen, const FGameplayTag& DefaultTab)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyCharacterScreenClosed(UObject* Screen)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyTabBarInitialized(UObject* TabBar, const FGameplayTag& TabBarTag)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyUIEventGeneric(UObject* Source, const FGameplayTag& EventTag, const FString& EventData)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyTabClicked(UObject* TabWidget, const FGameplayTag& TabTag)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyTabSelectionChanged(UObject* TabController, const FGameplayTag& OldTab, const FGameplayTag& NewTab)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyScreenActivated(UObject* Screen, const FGameplayTag& ScreenTag)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyScreenDeactivated(UObject* Screen, const FGameplayTag& ScreenTag)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyInventoryUIRefreshRequested(const FGameplayTag& ContainerTag)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyUIContainerUpdateRequested(UUserWidget* ContainerWidget, const FGameplayTag& ContainerType)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyUISlotInteraction(UUserWidget* ContainerWidget, int32 SlotIndex, const FGameplayTag& InteractionType)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyUIDragStarted(UUserWidget* SourceWidget, const FDragDropUIData& DragData)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyUIDragCompleted(UUserWidget* SourceWidget, UUserWidget* TargetWidget, bool bSuccess)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyUIEvent(const UObject* Source, const FGameplayTag& EventTag, const FString& EventData)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyEquipmentUpdated()
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyActiveWeaponChanged(AActor* NewActiveWeapon)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyEquipmentEvent(UObject* Equipment, FGameplayTag EventTag, const FString& EventData)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyEquipmentStateChanged(const FGameplayTag& OldState, const FGameplayTag& NewState, bool bWasInterrupted)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::BroadcastEquipmentOperationRequest(const FEquipmentOperationRequest& Request)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::BroadcastEquipmentOperationCompleted(const FEquipmentOperationResult& Result)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyAmmoChanged(float CurrentAmmo, float RemainingAmmo, float MagazineSize)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyWeaponStateChanged(const FGameplayTag& OldState, const FGameplayTag& NewState, bool bWasInterrupted)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyWeaponFired(const FVector& Origin, const FVector& Impact, bool bSuccess, FName ShotType)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyWeaponSpreadUpdated(float NewSpread)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyWeaponReloadStart()
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyWeaponReloadEnd()
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyFireModeChanged(const FGameplayTag& NewFireMode, float CurrentSpread)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyFireModeProviderChanged(const FGameplayTag& FireModeTag, bool bEnabled)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::BroadcastWeaponSwitchStarted(int32 FromSlot, int32 ToSlot)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::BroadcastWeaponSwitchCompleted(int32 FromSlot, int32 ToSlot)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyEquipmentSlotUpdated(int32 SlotIndex, const FGameplayTag& SlotType, bool bIsOccupied)
{
...
void UEventDelegateManager::NotifyEquipmentDropValidation(const FDragDropUIData& DragData, int32 TargetSlot, bool bIsValid, const FText& Message)
{
...
void UEventDelegateManager::NotifyEquipmentUIRefreshRequested(UUserWidget* Widget)
{
...
void UEventDelegateManager::NotifyMovementSpeedChanged(float OldSpeed, float NewSpeed, bool bIsSprinting)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyMovementStateChanged(FGameplayTag NewState, bool bIsTransitioning)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyJumpStateChanged(bool bIsJumping)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyCrouchStateChanged(bool bIsCrouching)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyLanded(float ImpactVelocity)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyMovementModeChanged(FName PreviousMode, FName NewMode, FGameplayTag StateTag)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyLoadoutTableLoaded(UDataTable* LoadoutTable, int32 LoadedCount)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyLoadoutChanged(const FName& LoadoutID, APlayerState* PlayerState, bool bSuccess)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyLoadoutApplied(const FName& LoadoutID, UObject* TargetObject, const FGameplayTag& ComponentType, bool bSuccess)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyTooltipRequested(const FItemUIData& ItemData, const FVector2D& ScreenPosition)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyTooltipHideRequested()
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::NotifyTooltipUpdatePosition(const FVector2D& ScreenPosition)
{
    if (!ValidateSystemState()) return;
...
void UEventDelegateManager::BroadcastGenericEvent(const UObject* Source, const FGameplayTag& EventTag, const FString& EventData)
{
    if (!ValidateSystemState()) return;
...
FDelegateHandle UEventDelegateManager::SubscribeToGenericEvent(const FGameplayTag& EventTag, const FGenericEventDelegate& Delegate)
{
...
void UEventDelegateManager::UnsubscribeFromGenericEvent(const FDelegateHandle& Handle)
{
...
void UEventDelegateManager::UnsubscribeFromNativeEvent(const FString& EventType, const FDelegateHandle& Handle)
{
    if (!ValidateSystemState() || !Handle.IsValid())
    {
        return;
...
void UEventDelegateManager::UniversalUnsubscribe(const FDelegateHandle& Handle)
{
    if (!ValidateSystemState() || !Handle.IsValid())
    {
        return;
...
void UEventDelegateManager::LogSubscriptionStatus() const
{
...
void UEventDelegateManager::ClearAllSubscriptions()
{
...
int32 UEventDelegateManager::GetNativeSubscriberCount() const
{
    int32 Count = 0;
...
bool UEventDelegateManager::ValidateSystemState() const
{
    if (!bIsInitialized)
    {
...
void UEventDelegateManager::NotifyUIItemDropped(UUserWidget* ContainerWidget, const FDragDropUIData& DragData, int32 TargetSlot)
{
    if (!ValidateSystemState()) return;
