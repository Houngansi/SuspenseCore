...
UEventDelegateManager* IMedComEquipmentInterface::GetDelegateManagerStatic(const UObject* WorldContextObject)
{
    /**
    ...
    {
        UE_LOG(LogTemp, Warning, TEXT("IMedComEquipmentInterface::GetDelegateManagerStatic - Null world context"));
        return nullptr;
    }
    ...
    if (!World)
    {
        UE_LOG(LogTemp, Warning, TEXT("IMedComEquipmentInterface::GetDelegateManagerStatic - Cannot get world from context"));
        return nullptr;
    }
    ...
    if (!GameInstance)
    {
        UE_LOG(LogTemp, Warning, TEXT("IMedComEquipmentInterface::GetDelegateManagerStatic - No game instance"));
        return nullptr;
    }
...
void IMedComEquipmentInterface::BroadcastEquipmentStateChanged(
    ...
    bool bInterrupted)
{
    ...
    UEventDelegateManager* Manager = GetDelegateManagerStatic(Equipment);
    if (Manager)
    {
...
void IMedComEquipmentInterface::BroadcastEquipmentOperationEvent(
    const UObject* Equipment,
...
void IMedComEquipmentInterface::BroadcastEquipmentPropertyChanged(
    const UObject* Equipment,
