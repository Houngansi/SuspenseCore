...
UEventDelegateManager* IMedComInteractInterface::GetDelegateManagerStatic(const UObject* WorldContextObject)
{
...
void IMedComInteractInterface::BroadcastInteractionStarted(
    ...
    const FGameplayTag& InteractionType)
{
    ...
    UEventDelegateManager* Manager = GetDelegateManagerStatic(Interactable);
    if (Manager)
    {
...
void IMedComInteractInterface::BroadcastInteractionCompleted(
    const UObject* Interactable,
    APlayerController* Instigator,
    bool bSuccess)
{
...
void IMedComInteractInterface::BroadcastInteractionFocusChanged(
    const UObject* Interactable,
    APlayerController* Instigator,
    bool bGainedFocus)
{
