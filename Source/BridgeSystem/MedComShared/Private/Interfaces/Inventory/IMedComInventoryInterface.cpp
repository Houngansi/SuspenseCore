...
UEventDelegateManager* IMedComInventoryInterface::GetDelegateManagerStatic(const UObject* WorldContextObject)
{
    /**
    ...
    UEventDelegateManager* DelegateManager = GameInstance->GetSubsystem<UEventDelegateManager>();
    if (!DelegateManager)
    {
...
bool IMedComInventoryInterface::GetUnifiedDataForBroadcast(
...
void IMedComInventoryInterface::BroadcastItemAdded(
    ...
    int32 SlotIndex)
{
    ...
    UEventDelegateManager* Manager = GetDelegateManagerStatic(Inventory);
    if (!Manager)
    {
...
void IMedComInventoryInterface::BroadcastItemRemoved(
    const UObject* Inventory,
    const FName& ItemID,
    int32 Quantity,
    int32 SlotIndex)
...
void IMedComInventoryInterface::BroadcastItemMoved(
    const UObject* Inventory,
...
void IMedComInventoryInterface::BroadcastInventoryError(
    const UObject* Inventory,
    ...
    const FString& Context)
{
    ...
    // Используем helper из FInventoryOperationResult для конвертации enum в строку
    ...
    if (ErrorCode == EInventoryErrorCode::NetworkError || ErrorCode == EInventoryErrorCode::NotInitialized)
    {
        UE_LOG(LogMedComShared, Error, 
...
void IMedComInventoryInterface::BroadcastWeightLimitExceeded(
    const UObject* Inventory,
    const FInventoryItemInstance& ItemInstance,
    ...
    float AvailableWeight)
{
    ...
    BroadcastInventoryError(Inventory, EInventoryErrorCode::WeightLimit, ErrorContext);
