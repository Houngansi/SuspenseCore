...
namespace InventoryUtils
{
     ...
     */
    bool GetUnifiedItemData(const UObject* WorldContextObject, const FName& ItemID, FMedComUnifiedItemData& OutData)
    {
        // Используем централизованный accessor для получения ItemManager
        UMedComItemManager* ItemManager = FItemSystemAccess::GetItemManager(WorldContextObject);
        if (!ItemManager)
        {
     ...
     */
    float GetDefaultMaxDurability(const FMedComUnifiedItemData& UnifiedData)
    {
     ...
     */
    void InitializeRuntimeProperties(FInventoryItemInstance& Instance, const FMedComUnifiedItemData& UnifiedData)
    {
 ...
 */
FInventoryItemInstance CreateItemInstance(const UObject* WorldContextObject, const FName& ItemID, int32 Quantity)
{
     ...
     */
    bool CanPlaceItemAt(const UObject* WorldContextObject, const FInventoryItemInstance& Item, 
     ...
     */
    TArray<int32> GetOccupiedCellIndices(const UObject* WorldContextObject, const FInventoryItemInstance& Item, int32 GridWidth)
    {
     ...
     */
    bool CanStackItems(const UObject* WorldContextObject, const FInventoryItemInstance& Item1, const FInventoryItemInstance& Item2)
    {
     ...
     */
    float CalculateInstanceWeight(const UObject* WorldContextObject, const FInventoryItemInstance& Instance)
    {
