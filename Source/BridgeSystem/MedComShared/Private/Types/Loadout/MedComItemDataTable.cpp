...
//==================================================================
// FMedComUnifiedItemData Implementation
//==================================================================

FMCPickupData FMedComUnifiedItemData::ToPickupData(int32 Quantity) const
{
...
FMCEquipmentData FMedComUnifiedItemData::ToEquipmentData() const
{
...
bool FMedComUnifiedItemData::IsValid() const
{
    // Базовая валидация
    if (ItemID.IsNone())
        return false;
...
TArray<FText> FMedComUnifiedItemData::GetValidationErrors() const
{
    TArray<FText> Errors;
...
void FMedComUnifiedItemData::SanitizeData()
{
...
FGameplayTag FMedComUnifiedItemData::GetEffectiveItemType() const
{
...
bool FMedComUnifiedItemData::MatchesTags(const FGameplayTagContainer& Tags) const
{
    if (Tags.IsEmpty())
    {
        return true;
...
FLinearColor FMedComUnifiedItemData::GetRarityColor() const
{
...
#if WITH_EDITOR
void FMedComUnifiedItemData::OnDataTableChanged(const UDataTable* InDataTable, const FName InRowName)
{
