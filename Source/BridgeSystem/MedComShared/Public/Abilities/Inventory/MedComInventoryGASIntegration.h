// MedComCore/Abilities/Inventory/MedComInventoryGASIntegration.h
...
#include "MedComInventoryGASIntegration.generated.h"
...
class MEDCOMSHARED_API UMedComInventoryGASIntegration : public UObject
{
    GENERATED_BODY()
