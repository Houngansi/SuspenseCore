...
#include "Types/Equipment/EquipmentTypes.h" // Используем структуры из единого источника
#include "Engine/Engine.h"
#include "Subsystems/GameInstanceSubsystem.h"
#include "EventDelegateManager.generated.h"
 ...
 * Для полноценных операций используйте FEquipmentOperationRequest из EquipmentTypes.h
 */
...
// Equipment System Native Delegates - используем правильные типы из EquipmentTypes.h
...
// ВАЖНО: Используем структуры из EquipmentTypes.h
...
public:
    ...
    static UEventDelegateManager* Get(const UObject* WorldContext);
    ...
    /** Fired when equipment operation is requested - используем структуры из EquipmentTypes.h */
    ...
    /** Fired when equipment operation completes - используем структуры из EquipmentTypes.h */
    ...
    // Equipment System - используем правильные типы из EquipmentTypes.h
