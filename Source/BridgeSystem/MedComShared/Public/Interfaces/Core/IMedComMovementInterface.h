...
#include "IMedComMovementInterface.generated.h"

UINTERFACE(MinimalAPI, Blueprintable)
class UMedComMovementInterface : public UInterface
{
    GENERATED_BODY()
};
 ...
 */
class MEDCOMSHARED_API IMedComMovementInterface
{
    GENERATED_BODY()
...
public:
    ...
    static class UEventDelegateManager* GetDelegateManagerStatic(const UObject* WorldContextObject);
};