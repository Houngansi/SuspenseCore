...
#include "IMedComEquipmentRules.generated.h"
...
class UMedComEquipmentRules : public UInterface
{
    GENERATED_BODY()
};
 ...
 */
class MEDCOMSHARED_API IMedComEquipmentRules
{
    GENERATED_BODY()
...
public:
    ...
    virtual FRuleEvaluationResult CheckConflictingEquipment(
        ...
        const FInventoryItemInstance& NewItem) const = 0;
     ...
     */
    virtual bool Initialize(TScriptInterface<class IMedComEquipmentDataProvider> DataProvider) { return true; }
