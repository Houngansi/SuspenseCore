...
#include "IMedComEventDispatcher.generated.h"
...
class UMedComEventDispatcher : public UInterface
{
    GENERATED_BODY()
};
 ...
 */
class MEDCOMSHARED_API IMedComEventDispatcher
{
    GENERATED_BODY()
...
public:
     ...
     */
    virtual void BroadcastEvent(const FEquipmentEventData& Event) = 0;
    
    /**
     * Queue event for later processing
     * @param Event Event to queue
     */
    virtual void QueueEvent(const FEquipmentEventData& Event) = 0;
