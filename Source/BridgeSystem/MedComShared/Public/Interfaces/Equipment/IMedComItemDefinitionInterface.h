...
#include "IMedComItemDefinitionInterface.generated.h"
...
class UMedComItemDefinitionInterface : public UInterface
{
    GENERATED_BODY()
};

class MEDCOMSHARED_API IMedComItemDefinitionInterface
{
    GENERATED_BODY()
