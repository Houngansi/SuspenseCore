...
#include "IMedComItemFactoryInterface.generated.h"
...
class UMedComItemFactoryInterface : public UInterface
{
    GENERATED_BODY()
};
 ...
 */
class MEDCOMSHARED_API IMedComItemFactoryInterface
{
    GENERATED_BODY()
...
public:
    ...
    AActor* CreatePickupFromSpawnData(
        const FPickupSpawnData& SpawnData,
        UWorld* World,
        const FTransform& Transform
    );
