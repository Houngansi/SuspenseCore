...
#include "IMedComCrosshairWidgetInterface.generated.h"

// Forward declarations - только базовые UE типы
class UEventDelegateManager;

UINTERFACE(MinimalAPI, BlueprintType)
class UMedComCrosshairWidgetInterface : public UInterface
{
    GENERATED_BODY()
};
 ...
 */
class MEDCOMSHARED_API IMedComCrosshairWidgetInterface
{
    GENERATED_BODY()
