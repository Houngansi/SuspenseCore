...
#include "IMedComDropTargetInterface.generated.h"

// Forward declarations
class UDragDropOperation; // Используем базовый класс

UINTERFACE(MinimalAPI, BlueprintType)
class UMedComDropTargetInterface : public UInterface
{
    GENERATED_BODY()
};
 ...
 */
class MEDCOMSHARED_API IMedComDropTargetInterface
{
    GENERATED_BODY()
