...
#include "IMedComEquipmentUIBridgeWidget.generated.h"

UINTERFACE(MinimalAPI, BlueprintType)
class UMedComEquipmentUIBridgeWidget : public UInterface
{
    GENERATED_BODY()
};
...
public:
    ...
    void SetEquipmentInterface(const TScriptInterface<IMedComEquipmentInterface>& InEquipment);
     ...
     */
    UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "Equipment|UI")
    TScriptInterface<IMedComEquipmentInterface> GetEquipmentInterface() const;
     ...
     */
    static IMedComEquipmentUIBridgeWidget* GetEquipmentUIBridge(const UObject* WorldContext);

    /**
     * Set global bridge instance
     * @param Bridge Bridge to set
     */
    static void SetGlobalEquipmentBridge(IMedComEquipmentUIBridgeWidget* Bridge);
