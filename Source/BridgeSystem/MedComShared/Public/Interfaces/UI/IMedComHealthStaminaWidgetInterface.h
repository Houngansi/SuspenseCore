...
#include "IMedComHealthStaminaWidgetInterface.generated.h"
...
class UMedComHealthStaminaWidgetInterface : public UInterface
{
    GENERATED_BODY()
};
 ...
 */
class MEDCOMSHARED_API IMedComHealthStaminaWidgetInterface
{
    GENERATED_BODY()
