...
#include "IMedComInventoryUIBridgeWidget.generated.h"

// Forward declarations
struct FDragDropUIData;

UINTERFACE(MinimalAPI, BlueprintType)
class UMedComInventoryUIBridgeWidget : public UInterface
{
    GENERATED_BODY()
};
 ...
 */
class MEDCOMSHARED_API IMedComInventoryUIBridgeWidget
{
    GENERATED_BODY()
...
public:
    ...
    FInventoryOperationResult AddItemToInventory(const FInventoryItemInstance& ItemInstance);
     ...
     */
    UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "UI|Bridge|Operations")
    FInventoryOperationResult RemoveItemFromInventory(const FGuid& ItemInstanceID);
     ...
     */
    UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "UI|Bridge|Operations")
    bool CanAddItemToInventory(const FInventoryItemInstance& ItemInstance) const;
     ...
     */
    static IMedComInventoryUIBridgeWidget* GetInventoryUIBridge(const UObject* WorldContext);
     ...
     */
    static TScriptInterface<IMedComInventoryUIBridgeWidget> GetGlobalBridge(const UObject* WorldContext = nullptr);
 
    /**
     * Set global bridge instance
     * @param Bridge Bridge instance to set
     */
    static void SetGlobalBridge(IMedComInventoryUIBridgeWidget* Bridge);
     ...
     */
    static TScriptInterface<IMedComInventoryUIBridgeWidget> MakeScriptInterface(IMedComInventoryUIBridgeWidget* RawInterface);
};