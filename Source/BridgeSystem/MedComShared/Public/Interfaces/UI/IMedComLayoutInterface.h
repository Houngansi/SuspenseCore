...
#include "IMedComLayoutInterface.generated.h"

UINTERFACE(MinimalAPI, Blueprintable)
class UMedComLayoutInterface : public UInterface
{
	GENERATED_BODY()
};
 ...
 */
class MEDCOMSHARED_API IMedComLayoutInterface
{
	GENERATED_BODY()
