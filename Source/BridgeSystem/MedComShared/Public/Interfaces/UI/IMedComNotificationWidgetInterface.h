...
#include "IMedComNotificationWidgetInterface.generated.h"
...
class UMedComNotificationWidgetInterface : public UInterface
{
    GENERATED_BODY()
};
 ...
 */
class MEDCOMSHARED_API IMedComNotificationWidgetInterface
{
    GENERATED_BODY()
