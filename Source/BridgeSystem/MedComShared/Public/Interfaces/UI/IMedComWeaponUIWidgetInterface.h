...
#include "IMedComWeaponUIWidgetInterface.generated.h"
...
class UMedComWeaponUIWidgetInterface : public UInterface
{
    GENERATED_BODY()
};
 ...
 */
class MEDCOMSHARED_API IMedComWeaponUIWidgetInterface
{
    GENERATED_BODY()
...
public:
    ...
    // Events should be generated by weapon components that own the data
};