...
#include "IMedComWeaponAnimationInterface.generated.h"
...
class UMedComWeaponAnimationInterface : public UInterface
{
    GENERATED_BODY()
};
 ...
 */
class MEDCOMSHARED_API IMedComWeaponAnimationInterface
{
    GENERATED_BODY()
