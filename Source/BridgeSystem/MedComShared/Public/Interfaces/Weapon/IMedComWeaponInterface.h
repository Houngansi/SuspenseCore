...
#include "IMedComWeaponInterface.generated.h"
...
struct MEDCOMSHARED_API FWeaponInitializationResult
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FWeaponFireParams
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FWeaponStateFlags
{
    GENERATED_BODY()
...
class UMedComWeaponInterface : public UInterface
{
    GENERATED_BODY()
};
 ...
 * - Accuracy and spread
 * 
 * Weapons should implement both IMedComEquipmentInterface and IMedComWeaponInterface
 */
class MEDCOMSHARED_API IMedComWeaponInterface
{
    GENERATED_BODY()
...
public:
    ...
    FWeaponInitializationResult InitializeFromItemData(const FInventoryItemInstance& ItemInstance);
    ...
    bool GetWeaponItemData(FMedComUnifiedItemData& OutData) const;
     ...
     */
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Weapon|Data")
    FInventoryItemInstance GetItemInstance() const;
     ...
     */
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Weapon|Ammo")
    FInventoryAmmoState GetAmmoState() const;
