// MedComShared/Public/ItemSystem/ItemSystemAccess.h
 ...
 * 
 *   UMedComItemManager* ItemManager = FItemSystemAccess::GetItemManager(this);
 *   if (!ItemManager)
 *   {
 ...
 */
class MEDCOMSHARED_API FItemSystemAccess
{
public:
    /**
     ...
     * 
     * NAVIGATION CHAIN:
     * WorldContextObject → UWorld → UGameInstance → UMedComItemManager (Subsystem)
     * 
     * ERROR HANDLING:
     ...
     * @return Valid ItemManager pointer or nullptr if chain is broken
     */
    static UMedComItemManager* GetItemManagerWithDiagnostics(
