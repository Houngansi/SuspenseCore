...
struct MEDCOMSHARED_API FInventoryItemInstance
{
    GENERATED_BODY()
     ...
     */
    static FInventoryItemInstance Create()
    {
     ...
     */
    static FInventoryItemInstance Create(const FName& InItemID, int32 InQuantity = 1)
    {
        FInventoryItemInstance Instance;
     ...
     */
    static FInventoryItemInstance CreateWithID(const FName& InItemID, const FGuid& InInstanceID, int32 InQuantity = 1)
    {
        FInventoryItemInstance Instance;
        Instance.ItemID = InItemID;
    ...
    friend uint32 GetTypeHash(const FInventoryItemInstance& Instance)
    {
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FInventoryCell
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FPickupSpawnData
{
    GENERATED_BODY()
     ...
     */
    FPickupSpawnData(const FName& InItemID, int32 InQuantity = 1)
        : ItemID(InItemID)
     ...
     */
    FInventoryItemInstance CreateInventoryInstance() const
    {
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FEquipmentSlotData
{
    GENERATED_BODY()
     ...
     */
    explicit FEquipmentSlotData(const FInventoryItemInstance& InInstance, float InEquipTime = 0.0f)
    ...
    void Clear()
    {
        ItemInstance = FInventoryItemInstance::Create();
        EquipTime = 0.0f;
        LastChangeTime = 0.0f;
    }
     ...
     * @param CurrentTime Текущее время
     */
    void EquipItem(const FInventoryItemInstance& NewInstance, float CurrentTime)
    {
