// MedComShared/Public/Types/Inventory/InventoryUtils.h
 ...
 * - All functions are exported with MEDCOMSHARED_API for cross-module usage
...
namespace InventoryUtils
{
     ...
     */
    MEDCOMSHARED_API bool GetUnifiedItemData(
     ...
     */
    MEDCOMSHARED_API FInventoryItemInstance CreateItemInstance(
        const UObject* WorldContextObject,
        const FName& ItemID, 
        int32 Quantity = 1);
     ...
     */
    MEDCOMSHARED_API FVector2D GetItemGridSize(
        const UObject* WorldContextObject,
        const FName& ItemID, 
     ...
     */
    MEDCOMSHARED_API bool CanPlaceItemAt(
        const UObject* WorldContextObject,
     ...
     */
    MEDCOMSHARED_API TArray<int32> GetOccupiedCellIndices(
        const UObject* WorldContextObject,
        const FInventoryItemInstance& Item, 
        int32 GridWidth);
     ...
     */
    MEDCOMSHARED_API bool CanStackItems(
        const UObject* WorldContextObject,
        const FInventoryItemInstance& Item1, 
        const FInventoryItemInstance& Item2);
     ...
     */
    MEDCOMSHARED_API int32 GetMaxStackSize(
        const UObject* WorldContextObject,
        const FName& ItemID);
     ...
     */
    MEDCOMSHARED_API float GetItemWeight(
        const UObject* WorldContextObject,
        const FName& ItemID);
     ...
     */
    MEDCOMSHARED_API float CalculateInstanceWeight(
        const UObject* WorldContextObject,
     ...
     */
    MEDCOMSHARED_API bool IsItemAllowedInInventory(
        const UObject* WorldContextObject,
        const FName& ItemID, 
