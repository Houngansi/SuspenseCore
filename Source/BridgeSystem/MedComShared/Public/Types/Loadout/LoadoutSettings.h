...
struct MEDCOMSHARED_API FEquipmentSlotConfig
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FInventoryConfig
{
    GENERATED_BODY()
    ...
    FInventoryConfig(const FText& InName, int32 InWidth, int32 InHeight, float InMaxWeight)
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FLoadoutConfiguration : public FTableRowBase
{
    GENERATED_BODY()
    ...
    FInventoryConfig MainInventory;
    
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Loadout|Inventory")
    TMap<FName, FInventoryConfig> AdditionalInventories;
    ...
    FLoadoutConfiguration()
    {
        ...
        MainInventory = FInventoryConfig(
    ...
    const FInventoryConfig* GetInventoryConfig(const FName& InventoryName = NAME_None) const
    {
    ...
    void AddAdditionalInventory(const FName& InventoryName, const FInventoryConfig& Config)
    {
...
public:
    virtual void OnDataTableChanged(const UDataTable* InDataTable, const FName InRowName) override
    {
        ...
        for (const FPickupSpawnData& StartingItem : MainInventory.StartingItems)
        {
