...
#include "MedComLoadoutManager.generated.h"
...
class MEDCOMSHARED_API UMedComLoadoutManager : public UGameInstanceSubsystem
{
    GENERATED_BODY()
...
public:
     ...
     */
    const FInventoryConfig* GetInventoryConfig(const FName& LoadoutID, const FName& InventoryName = NAME_None) const;
    ...
    bool GetInventoryConfigBP(const FName& LoadoutID, const FName& InventoryName, FInventoryConfig& OutConfig) const;
     ...
     * @param InventoryObject Object implementing IMedComInventoryInterface
     ...
     * @param EquipmentObject Object implementing IMedComEquipmentInterface
     * @param LoadoutID Loadout to apply
     * @return True if successfully applied
     */
    UFUNCTION(BlueprintCallable, Category = "Loadout", meta = (CallInEditor = "true"))
     ...
     * @param LoadoutObject Object implementing IMedComLoadoutInterface
     * @param LoadoutID Loadout to apply
...
private:
     ...
     */
    UEventDelegateManager* GetEventDelegateManager() const;
