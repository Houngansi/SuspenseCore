...
struct FCompressedItemData
{
    ...
    explicit FCompressedItemData(const FInventoryItemInstance& Instance, int32 Slot)
    {
    ...
    FInventoryItemInstance Decompress() const
    {
...
struct MEDCOMSHARED_API FNetworkOperationRequest
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FNetworkOperationResponse
{
    GENERATED_BODY()
 ...
 */
USTRUCT()
struct MEDCOMSHARED_API FLatencyCompensationData
{
    GENERATED_BODY()
