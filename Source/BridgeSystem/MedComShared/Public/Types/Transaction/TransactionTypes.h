...
struct MEDCOMSHARED_API FEquipmentDelta
{
    GENERATED_BODY()
    ...
    UPROPERTY(BlueprintReadOnly, Category = "Delta")
    FInventoryItemInstance ItemBefore;
    
    /** Состояние предмета после изменения */
    UPROPERTY(BlueprintReadOnly, Category = "Delta")
    FInventoryItemInstance ItemAfter;
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FTransactionOperation
{
    GENERATED_BODY()
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Operation")
    FInventoryItemInstance SecondaryItemBefore;
    
    /** Дополнительное состояние предмета после операции */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Operation")
    FInventoryItemInstance SecondaryItemAfter;
    ...
    static FTransactionOperation Create(
        ...
        int32 InSlotIndex,
        const FInventoryItemInstance& InItemBefore,
        const FInventoryItemInstance& InItemAfter)
    {
        FTransactionOperation Operation;
        Operation.OperationId = FGuid::NewGuid();
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FTransactionConflict
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FTransactionMetrics
{
    GENERATED_BODY()
