...
struct MEDCOMSHARED_API FSlotUIData
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FItemUIData
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FContainerUIData
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FDragDropUIData
{
    GENERATED_BODY()
 ...
 * RENAMED from FSlotValidationResult to avoid conflict with EquipmentTypes.h
 * This is specifically for UI validation, not gameplay validation
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FUISlotValidationResult
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FSmartDropZone
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FDragDropResult
{
    GENERATED_BODY()
