...
#include "FInventoryAmmoState.generated.h"

/**
 * Структура для хранения состояния патронов в оружии
 */
USTRUCT(BlueprintType)
struct MEDCOMSHARED_API FInventoryAmmoState
{
    GENERATED_BODY()
     ...
     */
    FInventoryAmmoState(float InCurrentAmmo, float InRemainingAmmo, const FGameplayTag& InAmmoType)
