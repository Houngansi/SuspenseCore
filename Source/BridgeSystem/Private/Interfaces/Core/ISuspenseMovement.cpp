...
void ISuspenseMovement::NotifyMovementSpeedChanged(const UObject* Source, float OldSpeed, float NewSpeed, bool bIsSprinting)
{
    ...
    USuspenseEventManager* Manager = GetDelegateManagerStatic(Source);
    if (Manager)
    {
...
USuspenseEventManager* ISuspenseMovement::GetDelegateManagerStatic(const UObject* WorldContextObject)
{
    ...
    return USuspenseEventManager::Get(WorldContextObject);
}