...
#include "Interfaces/Core/ISuspenseEnemy.h"
#include "Delegates/SuspenseEventManager.h"
#include "Engine/World.h"
#include "Engine/GameInstance.h"

USuspenseEventManager* ISuspenseEnemy::GetDelegateManagerStatic(const UObject* WorldContextObject)
{
...
void ISuspenseEnemy::BroadcastEnemyWeaponChanged(const UObject* Enemy, AActor* NewWeapon)
{
	...
	USuspenseEventManager* Manager = GetDelegateManagerStatic(Enemy);
	if (Manager)
	{
