...
#include "SuspenseEquipmentServiceLocator.generated.h"
 ...
 */
DECLARE_DELEGATE_TwoParams(FServiceInjectionDelegate, UObject* /*ServiceInstance*/, USuspenseEquipmentServiceLocator* /*Locator*/);
...
struct FServiceRegistration
{
    ...
    /** Stable identifier of the service (provided by ISuspenseEquipmentService::GetServiceTag on the instance). */
 ...
 * - Works purely via ISuspenseEquipmentService and gameplay tags.
...
public:
    ...
    /** Accessor. */
    static USuspenseEquipmentServiceLocator* Get(const UObject* WorldContext);
