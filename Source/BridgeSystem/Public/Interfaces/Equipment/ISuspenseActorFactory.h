...
#include "ISuspenseActorFactory.generated.h"
...
class USuspenseActorFactory : public UInterface
{
    GENERATED_BODY()
};
 ...
 */
class BRIDGESYSTEM_API ISuspenseActorFactory
{
    GENERATED_BODY()
...
public:
     ...
     */
    virtual bool ConfigureEquipmentActor(AActor* Actor, const FSuspenseInventoryItemInstance& ItemInstance) = 0;
