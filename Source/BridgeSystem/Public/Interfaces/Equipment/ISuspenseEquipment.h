...
#include "ISuspenseEquipment.generated.h"
 ...
 * - Оружейная специфика в ISuspenseWeapon
 ...
 */
class BRIDGESYSTEM_API ISuspenseEquipment
{
    GENERATED_BODY()
...
public:
    ...
    FSuspenseInventoryOperationResult EquipItemInstance(const FSuspenseInventoryItemInstance& ItemInstance, bool bForceEquip = false);
     ...
     */
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Equipment|Operations")
    FSuspenseInventoryOperationResult SwapEquipmentWith(const TScriptInterface<ISuspenseEquipment>& OtherEquipment);
     ...
     * 
     * Для детальной функциональности оружия используйте ISuspenseWeapon.
     * 
...
//==================================================================
     ...
     * @return Указатель на менеджер делегатов или nullptr если недоступен
     */
    virtual USuspenseEventManager* GetDelegateManagerPtr() const { return nullptr; }
