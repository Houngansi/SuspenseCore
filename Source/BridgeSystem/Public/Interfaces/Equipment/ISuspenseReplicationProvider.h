...
#include "ISuspenseReplicationProvider.generated.h"
...
class USuspenseReplicationProvider : public UInterface
{
    GENERATED_BODY()
};
 ...
 */
class BRIDGESYSTEM_API ISuspenseReplicationProvider
{
    GENERATED_BODY()
