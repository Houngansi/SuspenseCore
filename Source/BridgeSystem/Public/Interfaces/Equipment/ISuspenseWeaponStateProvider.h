...
#include "ISuspenseWeaponStateProvider.generated.h"
...
class USuspenseWeaponStateProvider : public UInterface
{
    GENERATED_BODY()
};
 ...
 */
class BRIDGESYSTEM_API ISuspenseWeaponStateProvider
{
    GENERATED_BODY()
