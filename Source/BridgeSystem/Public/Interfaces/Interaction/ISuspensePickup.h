 ...
 */
class BRIDGESYSTEM_API ISuspensePickup
{
    GENERATED_BODY()
...
public:
     ...
     * This is the primary identifier linking to FSuspenseUnifiedItemData
     ...
     */
    UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "Pickup")
    bool CreateItemInstance(FSuspenseInventoryItemInstance& OutInstance) const;
