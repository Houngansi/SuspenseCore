...
#include "ISuspenseInventoryItem.generated.h"
 ...
 * - Полная интеграция с FSuspenseInventoryItemInstance
...
class BRIDGESYSTEM_API ISuspenseInventoryItemInterface
{
    GENERATED_BODY()
...
public:
     ...
     */
    virtual bool GetItemData(FSuspenseUnifiedItemData& OutItemData) const = 0;
     ...
     */
    virtual const FSuspenseInventoryItemInstance& GetItemInstance() const = 0;
    
    /**
     * Замена runtime экземпляра
     */
    virtual bool SetItemInstance(const FSuspenseInventoryItemInstance& InInstance) = 0;
