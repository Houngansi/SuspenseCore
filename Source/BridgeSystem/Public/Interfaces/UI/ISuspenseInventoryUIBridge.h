...
class USuspenseInventoryUIBridgeInterface : public UInterface
{
    GENERATED_BODY()
};
 ...
 */
class BRIDGESYSTEM_API ISuspenseInventoryUIBridgeInterface
{
    GENERATED_BODY()
...
public:
     ...
     */
    static ISuspenseInventoryUIBridgeInterface* GetInventoryUIBridge(const UObject* WorldContext);
     ...
     */
    static TScriptInterface<ISuspenseInventoryUIBridgeInterface> GetGlobalBridge(const UObject* WorldContext = nullptr);

    /**
     * Set global bridge instance
     * @param Bridge Bridge instance to set
     */
    static void SetGlobalBridge(ISuspenseInventoryUIBridgeInterface* Bridge);
     ...
     */
    static TScriptInterface<ISuspenseInventoryUIBridgeInterface> MakeScriptInterface(ISuspenseInventoryUIBridgeInterface* RawInterface);
};