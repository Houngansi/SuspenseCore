...
#include "ISuspenseCoreAbilityProvider.generated.h"
...
class USuspenseCoreAbilityProvider : public UInterface
{
    GENERATED_BODY()
};

/**
 * SuspenseCore Interface for ability providers
 *
...
public:
     ...
     * @return Pointer to SuspenseCore delegate manager or nullptr if not available
     */
