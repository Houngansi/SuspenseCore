...
USTRUCT(BlueprintType)
struct BRIDGESYSTEM_API FSlotValidationResult
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct BRIDGESYSTEM_API FEquipmentStateSnapshot
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct BRIDGESYSTEM_API FEquipmentComparisonResult
{
    GENERATED_BODY()
