...
#include "Types/Loadout/LoadoutSettings.h"  // Для EEquipmentSlotType

// Define proper log category
DEFINE_LOG_CATEGORY_STATIC(LogEquipmentExecutor, Log, All);

// Constructor
UMedComEquipmentOperationExecutor::UMedComEquipmentOperationExecutor()
{
...
void UMedComEquipmentOperationExecutor::BeginPlay()
{
    Super::BeginPlay();
...
void UMedComEquipmentOperationExecutor::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
    // Reset statistics
    ResetStatistics();
...
bool UMedComEquipmentOperationExecutor::BuildPlan(
...
bool UMedComEquipmentOperationExecutor::ValidatePlan(
...
float UMedComEquipmentOperationExecutor::EstimatePlanExecutionTime(const FTransactionPlan& Plan) const
{
...
bool UMedComEquipmentOperationExecutor::IsPlanIdempotent(const FTransactionPlan& Plan) const
{
...
void UMedComEquipmentOperationExecutor::Expand_Equip(
...
void UMedComEquipmentOperationExecutor::Expand_Unequip(
    const FEquipmentOperationRequest& In,
    FTransactionPlan& Out) const
{
...
void UMedComEquipmentOperationExecutor::Expand_Move(
    const FEquipmentOperationRequest& In,
    FTransactionPlan& Out) const
{
...
void UMedComEquipmentOperationExecutor::Expand_Drop(
    const FEquipmentOperationRequest& In,
    FTransactionPlan& Out) const
{
...
void UMedComEquipmentOperationExecutor::Expand_Swap(
    const FEquipmentOperationRequest& In,
    FTransactionPlan& Out) const
{
...
void UMedComEquipmentOperationExecutor::Expand_QuickSwitch(
    const FEquipmentOperationRequest& In,
    FTransactionPlan& Out) const
{
...
void UMedComEquipmentOperationExecutor::Expand_Transfer(
    const FEquipmentOperationRequest& In,
    FTransactionPlan& Out) const
{
...
void UMedComEquipmentOperationExecutor::Expand_Reload(
    const FEquipmentOperationRequest& In,
    FTransactionPlan& Out) const
{
...
void UMedComEquipmentOperationExecutor::Expand_Repair(
    const FEquipmentOperationRequest& In,
    FTransactionPlan& Out) const
{
...
void UMedComEquipmentOperationExecutor::Expand_Upgrade(
    const FEquipmentOperationRequest& In,
    FTransactionPlan& Out) const
{
...
void UMedComEquipmentOperationExecutor::Expand_Modify(
    const FEquipmentOperationRequest& In,
    FTransactionPlan& Out) const
{
...
void UMedComEquipmentOperationExecutor::Expand_Combine(
    const FEquipmentOperationRequest& In,
    FTransactionPlan& Out) const
{
...
void UMedComEquipmentOperationExecutor::Expand_Split(
    const FEquipmentOperationRequest& In,
    FTransactionPlan& Out) const
{
...
bool UMedComEquipmentOperationExecutor::ValidateStep(
...
FSlotValidationResult UMedComEquipmentOperationExecutor::ValidateOperation(
...
FSlotValidationResult UMedComEquipmentOperationExecutor::ValidateEquip(
    const FEquipmentOperationRequest& Request) const
{
    ...
    {
        const FInventoryItemInstance ExistingItem = DataProvider->GetSlotItem(Request.TargetSlotIndex);
...
FSlotValidationResult UMedComEquipmentOperationExecutor::ValidateUnequip(
    const FEquipmentOperationRequest& Request) const
{
...
FSlotValidationResult UMedComEquipmentOperationExecutor::ValidateSwap(
    const FEquipmentOperationRequest& Request) const
{
    if (!DataProvider.GetInterface())
    {
    ...
    FInventoryItemInstance ItemA = DataProvider->GetSlotItem(Request.SourceSlotIndex);
    FInventoryItemInstance ItemB = DataProvider->GetSlotItem(Request.TargetSlotIndex);
...
FSlotValidationResult UMedComEquipmentOperationExecutor::ValidateMove(
    const FEquipmentOperationRequest& Request) const
{
    if (!DataProvider.GetInterface())
    {
    ...
    FInventoryItemInstance Item = DataProvider->GetSlotItem(Request.SourceSlotIndex);
...
FSlotValidationResult UMedComEquipmentOperationExecutor::ValidateDrop(
    const FEquipmentOperationRequest& Request) const
{
    if (!DataProvider.GetInterface() || !DataProvider->IsValidSlotIndex(Request.SourceSlotIndex))
    {
...
FSlotValidationResult UMedComEquipmentOperationExecutor::ValidateQuickSwitch(
    const FEquipmentOperationRequest& Request) const
{
    if (!DataProvider.GetInterface())
    {
...
//========================================
// IMedComEquipmentOperations Implementation (Legacy)
//========================================

FEquipmentOperationResult UMedComEquipmentOperationExecutor::ExecuteOperation(
    const FEquipmentOperationRequest& Request)
{
...
FEquipmentOperationResult UMedComEquipmentOperationExecutor::EquipItem(
...
FEquipmentOperationResult UMedComEquipmentOperationExecutor::UnequipItem(int32 SlotIndex)
{
    FEquipmentOperationRequest Request;
...
FEquipmentOperationResult UMedComEquipmentOperationExecutor::SwapItems(
    int32 SlotIndexA,
    int32 SlotIndexB)
{
    FEquipmentOperationRequest Request;
...
FEquipmentOperationResult UMedComEquipmentOperationExecutor::MoveItem(
    int32 SourceSlot,
    int32 TargetSlot)
{
    FEquipmentOperationRequest Request;
...
FEquipmentOperationResult UMedComEquipmentOperationExecutor::DropItem(int32 SlotIndex)
{
    FEquipmentOperationRequest Request;
...
FEquipmentOperationResult UMedComEquipmentOperationExecutor::QuickSwitchWeapon()
{
    FEquipmentOperationRequest Request;
...
TArray<FEquipmentOperationResult> UMedComEquipmentOperationExecutor::GetOperationHistory(
...
bool UMedComEquipmentOperationExecutor::CanUndoLastOperation() const
{
    // Undo is now managed by the service/transaction layer
    return false;
}

FEquipmentOperationResult UMedComEquipmentOperationExecutor::UndoLastOperation()
{
    // Undo is now managed by the service/transaction layer
    return FEquipmentOperationResult::CreateFailure(
        FGuid::NewGuid(),
...
bool UMedComEquipmentOperationExecutor::Initialize(
    TScriptInterface<IMedComEquipmentDataProvider> InDataProvider,
    TScriptInterface<IMedComSlotValidator> InValidator)
{
...
bool UMedComEquipmentOperationExecutor::IsInitialized() const
{
    return DataProvider.GetInterface() != nullptr;
}

void UMedComEquipmentOperationExecutor::ResetStatistics()
{
...
FString UMedComEquipmentOperationExecutor::GetStatistics() const
{
...
FGuid UMedComEquipmentOperationExecutor::GenerateOperationId() const
{
    return FGuid::NewGuid();
}

int32 UMedComEquipmentOperationExecutor::FindBestSlotForItem(
...
bool UMedComEquipmentOperationExecutor::IsWeaponSlot(int32 SlotIndex) const
{
...
int32 UMedComEquipmentOperationExecutor::GetWeaponSlotPriority(EEquipmentSlotType SlotType) const
{
    return GetWeaponSlotPriorityStatic(SlotType);
}

int32 UMedComEquipmentOperationExecutor::GetCurrentActiveWeaponSlot() const
{
    if (!DataProvider.GetInterface())
    {
        return INDEX_NONE;
...
int32 UMedComEquipmentOperationExecutor::FindNextWeaponSlot(int32 CurrentSlot) const
{
    if (!DataProvider.GetInterface())
    {
        return INDEX_NONE;
...
bool UMedComEquipmentOperationExecutor::IsFirearmSlot(int32 SlotIndex) const
{
    if (!DataProvider.GetInterface() || !DataProvider->IsValidSlotIndex(SlotIndex))
    {
        return false;
...
bool UMedComEquipmentOperationExecutor::IsMeleeWeaponSlot(int32 SlotIndex) const
{
    if (!DataProvider.GetInterface() || !DataProvider->IsValidSlotIndex(SlotIndex))
    {
        return false;
...
EEquipmentSlotType UMedComEquipmentOperationExecutor::GetWeaponSlotType(int32 SlotIndex) const
{
    if (!DataProvider.GetInterface() || !DataProvider->IsValidSlotIndex(SlotIndex))
    {
