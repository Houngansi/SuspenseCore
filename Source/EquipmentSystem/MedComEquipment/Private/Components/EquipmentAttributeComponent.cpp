...
UEquipmentAttributeComponent::UEquipmentAttributeComponent()
{
...
void UEquipmentAttributeComponent::BeginPlay()
{
    Super::BeginPlay();
    ...
    if (GetOwner() && GetOwner()->HasAuthority() && GetWorld())
    {
        ...
        GetWorld()->GetTimerManager().SetTimer(
            TimerHandle,
            this,
            &UEquipmentAttributeComponent::CollectReplicatedAttributes,
...
void UEquipmentAttributeComponent::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
    Super::GetLifetimeReplicatedProps(OutLifetimeProps);
    
    DOREPLIFETIME(UEquipmentAttributeComponent, ReplicatedAttributes);
    DOREPLIFETIME(UEquipmentAttributeComponent, ReplicatedAttributeSetClasses);
    DOREPLIFETIME(UEquipmentAttributeComponent, AttributeReplicationVersion);
}

void UEquipmentAttributeComponent::InitializeWithItemInstance(AActor* InOwner, UAbilitySystemComponent* InASC, const FInventoryItemInstance& ItemInstance)
{
...
void UEquipmentAttributeComponent::Cleanup()
{
...
void UEquipmentAttributeComponent::UpdateEquippedItem(const FInventoryItemInstance& ItemInstance)
{
    // Update base item
...
void UEquipmentAttributeComponent::OnEquipmentInitialized()
{
...
void UEquipmentAttributeComponent::OnEquippedItemChanged(const FInventoryItemInstance& OldItem, const FInventoryItemInstance& NewItem)
{
...
void UEquipmentAttributeComponent::CreateAttributeSetsForItem(const FMedComUnifiedItemData& ItemData)
{
    if (!CachedASC)
    {
...
void UEquipmentAttributeComponent::CleanupAttributeSets()
{
    if (!CachedASC)
    {
        return;
...
void UEquipmentAttributeComponent::ApplyInitializationEffect(UAttributeSet* AttributeSet, TSubclassOf<UGameplayEffect> InitEffect, const FMedComUnifiedItemData& ItemData)
{
...
void UEquipmentAttributeComponent::ApplyItemEffects(const FMedComUnifiedItemData& ItemData)
{
    if (!CachedASC)
    {
...
void UEquipmentAttributeComponent::RemoveItemEffects()
{
    if (!CachedASC)
    {
        return;
...
void UEquipmentAttributeComponent::ApplyPassiveEffects(const FMedComUnifiedItemData& ItemData)
{
...
void UEquipmentAttributeComponent::ApplyGrantedAbilities(const FMedComUnifiedItemData& ItemData)
{
...
int32 UEquipmentAttributeComponent::PredictAttributeChange(const FString& AttributeName, float NewValue)
{
...
void UEquipmentAttributeComponent::ConfirmAttributePrediction(int32 PredictionKey, bool bSuccess, float ActualValue)
{
...
bool UEquipmentAttributeComponent::GetAttributeValue(const FString& AttributeName, float& OutValue) const
{
...
void UEquipmentAttributeComponent::SetAttributeValue(const FString& AttributeName, float NewValue, bool bForceReplication)
{
    FScopeLock Lock(&AttributeCacheCriticalSection);
...
TMap<FString, float> UEquipmentAttributeComponent::GetAllAttributeValues() const
{
...
bool UEquipmentAttributeComponent::HasAttribute(const FString& AttributeName) const
{
    float DummyValue;
    return GetAttributeValue(AttributeName, DummyValue);
}

bool UEquipmentAttributeComponent::GetAttributeByTag(const FGameplayTag& AttributeTag, float& OutValue) const
{
...
void UEquipmentAttributeComponent::ForceAttributeReplication()
{
    if (GetOwner() && GetOwner()->HasAuthority())
    {
        CollectReplicatedAttributes();
...
void UEquipmentAttributeComponent::CollectReplicatedAttributes()
{
    if (!GetOwner() || !GetOwner()->HasAuthority())
    {
        return;
...
void UEquipmentAttributeComponent::ApplyReplicatedAttributes()
{
...
void UEquipmentAttributeComponent::OnRep_ReplicatedAttributes()
{
...
void UEquipmentAttributeComponent::OnRep_AttributeSetClasses()
{
...
void UEquipmentAttributeComponent::ServerSetAttributeValue_Implementation(const FString& AttributeName, float NewValue)
{
    SetAttributeValue(AttributeName, NewValue, true);
}

bool UEquipmentAttributeComponent::ServerSetAttributeValue_Validate(const FString& AttributeName, float NewValue)
{
    return !AttributeName.IsEmpty();
}

void UEquipmentAttributeComponent::ServerApplyItemEffects_Implementation(const FName& ItemID)
{
    FMedComUnifiedItemData ItemData;
...
bool UEquipmentAttributeComponent::ServerApplyItemEffects_Validate(const FName& ItemID)
{
    return !ItemID.IsNone();
}

void UEquipmentAttributeComponent::ServerRemoveItemEffects_Implementation()
{
    RemoveItemEffects();
}

bool UEquipmentAttributeComponent::ServerRemoveItemEffects_Validate()
{
    return true;
}
...
FProperty* UEquipmentAttributeComponent::FindAttributeProperty(UAttributeSet* AttributeSet, const FString& AttributeName) const
{
    if (!AttributeSet)
    {
        return nullptr;
...
float UEquipmentAttributeComponent::GetAttributeValueFromProperty(UAttributeSet* AttributeSet, FProperty* Property) const
{
...
void UEquipmentAttributeComponent::SetAttributeValueToProperty(UAttributeSet* AttributeSet, FProperty* Property, float Value)
{
    if (!AttributeSet || !Property)
    {
        return;
...
FGameplayAttribute UEquipmentAttributeComponent::GetGameplayAttributeFromProperty(UAttributeSet* AttributeSet, FProperty* Property) const
{
    if (!AttributeSet || !Property)
    {
