...
UEquipmentComponentBase::UEquipmentComponentBase()
{
...
void UEquipmentComponentBase::BeginPlay()
{
    ...
    if (!GetOwner()->HasAuthority() && GetWorld())
    {
        GetWorld()->GetTimerManager().SetTimer(
            *new FTimerHandle(),
            this,
            &UEquipmentComponentBase::CleanupExpiredPredictions,
            1.0f,
            true
        );
    }
...
void UEquipmentComponentBase::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void UEquipmentComponentBase::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
    Super::GetLifetimeReplicatedProps(OutLifetimeProps);
    
    DOREPLIFETIME(UEquipmentComponentBase, bIsInitialized);
    DOREPLIFETIME(UEquipmentComponentBase, EquippedItemInstance);
    DOREPLIFETIME(UEquipmentComponentBase, ComponentVersion);
    DOREPLIFETIME(UEquipmentComponentBase, EquipmentCycleCounter);
}

void UEquipmentComponentBase::Initialize(AActor* InOwner, UAbilitySystemComponent* InASC)
{
    if (!InOwner || !InASC)
    {
...
void UEquipmentComponentBase::InitializeWithItemInstance(AActor* InOwner, UAbilitySystemComponent* InASC, const FInventoryItemInstance& ItemInstance)
{
...
void UEquipmentComponentBase::Cleanup()
{
    if (!bIsInitialized)
    {
        return;
    ...
    FInventoryItemInstance OldItem = EquippedItemInstance;
...
void UEquipmentComponentBase::UpdateEquippedItem(const FInventoryItemInstance& NewItemInstance)
{
    if (!bIsInitialized)
    {
...
void UEquipmentComponentBase::SetEquippedItemInstance(const FInventoryItemInstance& ItemInstance)
{
    FInventoryItemInstance OldItem = EquippedItemInstance;
    ...
    else if (OldItem.IsValid())
    {
        ...
        FMedComUnifiedItemData OldItemData;
...
int32 UEquipmentComponentBase::StartClientPrediction(const FInventoryItemInstance& PredictedInstance)
{
...
void UEquipmentComponentBase::ConfirmClientPrediction(int32 PredictionKey, bool bSuccess, const FInventoryItemInstance& ActualInstance)
{
    // Find prediction
...
void UEquipmentComponentBase::CleanupExpiredPredictions()
{
    if (!GetWorld())
    {
        return;
...
UMedComItemManager* UEquipmentComponentBase::GetItemManager() const
{
    FScopeLock Lock(&CacheCriticalSection);
...
UEventDelegateManager* UEquipmentComponentBase::GetDelegateManager() const
{
    FScopeLock Lock(&CacheCriticalSection);
...
bool UEquipmentComponentBase::GetEquippedItemData(FMedComUnifiedItemData& OutItemData) const
{
...
float UEquipmentComponentBase::GetEquippedItemProperty(const FName& PropertyName, float DefaultValue) const
{
    if (!EquippedItemInstance.IsValid())
    {
        return DefaultValue;
...
void UEquipmentComponentBase::SetEquippedItemProperty(const FName& PropertyName, float Value)
{
    if (!EquippedItemInstance.IsValid())
    {
...
void UEquipmentComponentBase::InitializeCoreReferences()
{
...
bool UEquipmentComponentBase::ValidateSystemReferences() const
{
    bool bValid = true;
...
bool UEquipmentComponentBase::ValidateDelegateManager() const
{
    UEventDelegateManager* Manager = GetDelegateManager();
    return IsValid(Manager);
}

void UEquipmentComponentBase::OnEquipmentInitialized()
{
    // Base implementation - override in derived classes
}

void UEquipmentComponentBase::OnEquippedItemChanged(const FInventoryItemInstance& OldItem, const FInventoryItemInstance& NewItem)
{
    // Base implementation - override in derived classes
...
bool UEquipmentComponentBase::ExecuteOnServer(const FString& FuncName, TFunction<void()> ServerCode)
{
...
void UEquipmentComponentBase::LogEventBroadcast(const FString& EventName, bool bSuccess) const
{
...
void UEquipmentComponentBase::OnRep_EquippedItemInstance(const FInventoryItemInstance& OldInstance)
{
...
void UEquipmentComponentBase::OnRep_ComponentState()
{
...
void UEquipmentComponentBase::BroadcastItemEquipped(const FInventoryItemInstance& ItemInstance, const FGameplayTag& SlotType)
{
...
void UEquipmentComponentBase::BroadcastItemUnequipped(const FInventoryItemInstance& ItemInstance, const FGameplayTag& SlotType)
{
    if (!ValidateDelegateManager())
    {
...
void UEquipmentComponentBase::BroadcastEquipmentPropertyChanged(const FName& PropertyName, float OldValue, float NewValue)
{
    if (!ValidateDelegateManager())
    {
    ...
    IMedComEquipmentInterface::BroadcastEquipmentPropertyChanged(
...
void UEquipmentComponentBase::BroadcastEquipmentStateChanged(const FGameplayTag& OldState, const FGameplayTag& NewState, bool bInterrupted)
{
    if (!ValidateDelegateManager())
    {
...
void UEquipmentComponentBase::BroadcastEquipmentEvent(const FGameplayTag& EventTag, const FString& EventData)
{
    if (!ValidateDelegateManager())
    {
...
void UEquipmentComponentBase::BroadcastEquipmentUpdated()
{
    if (!ValidateDelegateManager())
    {
...
void UEquipmentComponentBase::BroadcastAmmoChanged(float CurrentAmmo, float RemainingAmmo, float MagazineSize)
{
    if (!ValidateDelegateManager())
    {
...
void UEquipmentComponentBase::BroadcastWeaponFired(const FVector& Origin, const FVector& Impact, bool bSuccess, const FGameplayTag& FireMode)
{
    if (!ValidateDelegateManager())
    {
...
void UEquipmentComponentBase::BroadcastFireModeChanged(const FGameplayTag& NewFireMode, const FText& FireModeDisplayName)
{
    if (!ValidateDelegateManager())
    {
...
void UEquipmentComponentBase::BroadcastWeaponReload(bool bStarted, float ReloadDuration)
{
    if (!ValidateDelegateManager())
    {
...
void UEquipmentComponentBase::BroadcastWeaponSpreadUpdated(float NewSpread, float MaxSpread)
{
    if (!ValidateDelegateManager())
    {
...
//================================================
// IMedComAbilityProvider Implementation
//================================================

void UEquipmentComponentBase::InitializeAbilityProvider_Implementation(UAbilitySystemComponent* InASC)
{
    CachedASC = InASC;
    EQUIPMENT_LOG(Log, TEXT("Ability provider initialized"));
}

FGameplayAbilitySpecHandle UEquipmentComponentBase::GrantAbility_Implementation(TSubclassOf<UGameplayAbility> AbilityClass, int32 Level, int32 InputID)
{
...
void UEquipmentComponentBase::RemoveAbility_Implementation(FGameplayAbilitySpecHandle AbilityHandle)
{
...
FActiveGameplayEffectHandle UEquipmentComponentBase::ApplyEffectToSelf_Implementation(TSubclassOf<UGameplayEffect> EffectClass, float Level)
{
...
void UEquipmentComponentBase::RemoveEffect_Implementation(FActiveGameplayEffectHandle EffectHandle)
{
