...
UMedComEquipmentAbilityConnector::UMedComEquipmentAbilityConnector()
{
    PrimaryComponentTick.bCanEverTick = false;
    SetIsReplicatedByDefault(false);
}

void UMedComEquipmentAbilityConnector::BeginPlay()
{
    Super::BeginPlay();
...
void UMedComEquipmentAbilityConnector::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
bool UMedComEquipmentAbilityConnector::Initialize(
...
//==================================================================
// IMedComAbilityConnector Interface - Core Implementation
//==================================================================

TArray<FGameplayAbilitySpecHandle> UMedComEquipmentAbilityConnector::GrantEquipmentAbilities(
    const FInventoryItemInstance& ItemInstance)
{
    return GrantAbilitiesForSlot(INDEX_NONE, ItemInstance);
}

int32 UMedComEquipmentAbilityConnector::RemoveGrantedAbilities(const TArray<FGameplayAbilitySpecHandle>& Handles)
{
...
TArray<FActiveGameplayEffectHandle> UMedComEquipmentAbilityConnector::ApplyEquipmentEffects(
    const FInventoryItemInstance& ItemInstance)
{
    return ApplyEffectsForSlot(INDEX_NONE, ItemInstance);
}

int32 UMedComEquipmentAbilityConnector::RemoveAppliedEffects(const TArray<FActiveGameplayEffectHandle>& Handles)
{
...
bool UMedComEquipmentAbilityConnector::UpdateEquipmentAttributes(
    const FInventoryItemInstance& ItemInstance)
{
...
UAttributeSet* UMedComEquipmentAbilityConnector::GetEquipmentAttributeSet(int32 SlotIndex) const
{
...
bool UMedComEquipmentAbilityConnector::ActivateEquipmentAbility(
...
TArray<FGameplayAbilitySpecHandle> UMedComEquipmentAbilityConnector::GrantAbilitiesForSlot(
    int32 SlotIndex, const FInventoryItemInstance& ItemInstance)
{
...
int32 UMedComEquipmentAbilityConnector::RemoveAbilitiesForSlot(int32 SlotIndex)
{
...
TArray<FActiveGameplayEffectHandle> UMedComEquipmentAbilityConnector::ApplyEffectsForSlot(
    int32 SlotIndex, const FInventoryItemInstance& ItemInstance)
{
...
int32 UMedComEquipmentAbilityConnector::RemoveEffectsForSlot(int32 SlotIndex)
{
...
void UMedComEquipmentAbilityConnector::ClearAll()
{
...
int32 UMedComEquipmentAbilityConnector::CleanupInvalidHandles()
{
...
bool UMedComEquipmentAbilityConnector::ValidateConnector(TArray<FString>& OutErrors) const
{
    OutErrors.Empty();
    bool bIsValid = true;
...
FString UMedComEquipmentAbilityConnector::GetDebugInfo() const
{
    FString DebugInfo;
...
void UMedComEquipmentAbilityConnector::LogStatistics() const
{
...
TArray<FGameplayAbilitySpecHandle> UMedComEquipmentAbilityConnector::GrantAbilitiesFromItemData(
    const FMedComUnifiedItemData& ItemData,
    const FInventoryItemInstance& ItemInstance,
    int32 SlotIndex)
{
    TArray<FGameplayAbilitySpecHandle> GrantedHandles;
...
TArray<FActiveGameplayEffectHandle> UMedComEquipmentAbilityConnector::ApplyEffectsFromItemData(
    const FMedComUnifiedItemData& ItemData,
    const FInventoryItemInstance& ItemInstance,
    int32 SlotIndex)
{
...
UAttributeSet* UMedComEquipmentAbilityConnector::CreateAttributeSetFromItemData(
    const FMedComUnifiedItemData& ItemData,
    const FInventoryItemInstance& ItemInstance,
    int32 SlotIndex)
{
...
FGameplayAbilitySpecHandle UMedComEquipmentAbilityConnector::GrantSingleAbility(
...
FActiveGameplayEffectHandle UMedComEquipmentAbilityConnector::ApplySingleEffect(
...
bool UMedComEquipmentAbilityConnector::InitializeAttributeSet(
...
UMedComItemManager* UMedComEquipmentAbilityConnector::GetItemManager() const
{
...
bool UMedComEquipmentAbilityConnector::EnsureValidExecution(const FString& FunctionName) const
{
