...
// ----------------------------------------------------
FInventoryItemInstanceNet UMedComEquipmentNetworkDispatcher::ToNet(const FInventoryItemInstance& In)
{
...
FInventoryItemInstance UMedComEquipmentNetworkDispatcher::FromNet(const FInventoryItemInstanceNet& In)
{
	FInventoryItemInstance Out;
	Out.ItemID       = In.ItemID;
	Out.InstanceID   = In.InstanceID;
	Out.Quantity     = In.Quantity;
	Out.AnchorIndex  = In.AnchorIndex;
...
FNetworkOperationRequestNet UMedComEquipmentNetworkDispatcher::ToNet(const FNetworkOperationRequest& In)
{
...
FNetworkOperationRequest UMedComEquipmentNetworkDispatcher::FromNet(const FNetworkOperationRequestNet& In)
{
...
UMedComEquipmentNetworkDispatcher::UMedComEquipmentNetworkDispatcher()
{
...
void UMedComEquipmentNetworkDispatcher::BeginPlay()
{
	Super::BeginPlay();
...
void UMedComEquipmentNetworkDispatcher::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	{
...
void UMedComEquipmentNetworkDispatcher::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
FGuid UMedComEquipmentNetworkDispatcher::SendOperationToServer(const FNetworkOperationRequest& Request)
{
...
void UMedComEquipmentNetworkDispatcher::SendOperationToClients(const FNetworkOperationRequest& /*Request*/, const TArray<APlayerController*>& /*TargetClients*/)
{
	UE_LOG(LogEquipmentNetwork, Verbose, TEXT("SendOperationToClients: Not implemented at dispatcher level"));
}

void UMedComEquipmentNetworkDispatcher::HandleServerResponse(const FNetworkOperationResponse& Response)
{
...
FGuid UMedComEquipmentNetworkDispatcher::BatchOperations(const TArray<FNetworkOperationRequest>& Operations)
{
...
bool UMedComEquipmentNetworkDispatcher::CancelOperation(const FGuid& RequestId)
{
	FScopeLock Lock(&QueueLock);
...
bool UMedComEquipmentNetworkDispatcher::RetryOperation(const FGuid& RequestId)
{
...
TArray<FNetworkOperationRequest> UMedComEquipmentNetworkDispatcher::GetPendingOperations() const
{
	FScopeLock Lock(&QueueLock);
...
void UMedComEquipmentNetworkDispatcher::FlushPendingOperations(bool /*bForce*/)
{
	ProcessQueue();
}

void UMedComEquipmentNetworkDispatcher::SetOperationTimeout(float Seconds)
{
	CurrentTimeout = FMath::Max(0.1f, Seconds);
}

FString UMedComEquipmentNetworkDispatcher::GetNetworkStatistics() const
{
...
bool UMedComEquipmentNetworkDispatcher::IsOperationPending(const FGuid& RequestId) const
{
	FScopeLock Lock(&QueueLock);
...
void UMedComEquipmentNetworkDispatcher::SetSecurityService(UEquipmentNetworkServiceImpl* InSecurityService)
{
	SecurityService = InSecurityService;
}

void UMedComEquipmentNetworkDispatcher::SetOperationExecutor(TScriptInterface<IMedComEquipmentOperations> InExecutor)
{
	OperationExecutor = InExecutor;
}

void UMedComEquipmentNetworkDispatcher::ConfigureRetryPolicy(int32 MaxRetries, float RetryDelay, float InBackoffFactor, float InMaxJitter)
{
...
void UMedComEquipmentNetworkDispatcher::ConfigureBatching(int32 BatchSize, float BatchInterval)
{
	MaxBatchSize  = FMath::Max(1, BatchSize);
	BatchWaitTime = FMath::Max(0.0f, BatchInterval);
}

void UMedComEquipmentNetworkDispatcher::ConfigureIdempotency(int32 CacheSize, float EntryLifetime)
{
	MaxIdempotencyCacheSize = FMath::Max(1, CacheSize);
	IdempotencyLifetime     = FMath::Max(1.0f, EntryLifetime);
}

bool UMedComEquipmentNetworkDispatcher::ValidateRequestSecurity(const FNetworkOperationRequest& Request)
{
...
bool UMedComEquipmentNetworkDispatcher::VerifyServerSecurity(const FNetworkOperationRequest& Request, APlayerController* SendingPlayer)
{
...
void UMedComEquipmentNetworkDispatcher::ProcessQueue()
{
...
bool UMedComEquipmentNetworkDispatcher::SendOperation(FOperationQueueEntry& Entry)
{
...
float UMedComEquipmentNetworkDispatcher::CalculateRetryDelay(int32 RetryCount) const
{
...
void UMedComEquipmentNetworkDispatcher::SendWithPriority(ENetworkOperationPriority Priority, const FNetworkOperationRequest& Request)
{
	switch (Priority)
	{
...
void UMedComEquipmentNetworkDispatcher::HandleTimeout(const FGuid& OperationId)
{
	FScopeLock Lock(&QueueLock);
	for (FOperationQueueEntry& Entry : OperationQueue)
	{
...
void UMedComEquipmentNetworkDispatcher::UpdateResponseTimeStats(float ResponseTime)
{
	FScopeLock Lock(&StatsLock);
...
bool UMedComEquipmentNetworkDispatcher::ShouldBatchOperation(ENetworkOperationPriority Priority) const
{
	return Priority == ENetworkOperationPriority::Normal;
}

FOperationQueueEntry* UMedComEquipmentNetworkDispatcher::FindQueueEntry(const FGuid& OperationId)
{
	FScopeLock Lock(&QueueLock);
...
FString UMedComEquipmentNetworkDispatcher::SerializeResult(const FEquipmentOperationResult& Result) const
{
	const FString Err = Result.ErrorMessage.ToString();
	return FString::Printf(TEXT("%d|%s"), Result.bSuccess ? 1 : 0, *Err);
}

bool UMedComEquipmentNetworkDispatcher::DeserializeResult(const FString& Data, FEquipmentOperationResult& OutResult) const
{
...
uint64 UMedComEquipmentNetworkDispatcher::CalculateRequestHash(const FNetworkOperationRequest& Request) const
{
	FSHA1 Sha;
...
bool UMedComEquipmentNetworkDispatcher::CheckIdempotency(const FNetworkOperationRequest& Request, FEquipmentOperationResult& OutCachedResult)
{
...
void UMedComEquipmentNetworkDispatcher::StoreIdempotentResult(const FNetworkOperationRequest& Request, const FEquipmentOperationResult& Result)
{
...
void UMedComEquipmentNetworkDispatcher::CleanIdempotencyCache()
{
	FScopeLock Lock(&IdempotencyLock);
	const float Now = GetWorld() ? GetWorld()->GetTimeSeconds() : 0.0f;
...
bool UMedComEquipmentNetworkDispatcher::ServerExecuteOperation_Validate(const FNetworkOperationRequestNet& RequestNet)
{
	return RequestNet.Operation.OperationType != EEquipmentOperationType::None;
}

void UMedComEquipmentNetworkDispatcher::ServerExecuteOperation_Implementation(const FNetworkOperationRequestNet& RequestNet)
{
...
bool UMedComEquipmentNetworkDispatcher::ServerExecuteBatch_Validate(const FGuid& /*BatchId*/, const TArray<FNetworkOperationRequestNet>& RequestsNet)
{
	return RequestsNet.Num() > 0 && RequestsNet.Num() <= MaxBatchSize;
}

void UMedComEquipmentNetworkDispatcher::ServerExecuteBatch_Implementation(const FGuid& BatchId, const TArray<FNetworkOperationRequestNet>& RequestsNet)
{
	APlayerController* Sender = Cast<APlayerController>(GetOwner());
...
bool UMedComEquipmentNetworkDispatcher::ServerExecuteLowPriority_Validate(const FNetworkOperationRequestNet& RequestNet)
{
	return RequestNet.Operation.OperationType != EEquipmentOperationType::None;
}

void UMedComEquipmentNetworkDispatcher::ServerExecuteLowPriority_Implementation(const FNetworkOperationRequestNet& RequestNet)
{
	FNetworkOperationRequest Request = FromNet(RequestNet);
...
void UMedComEquipmentNetworkDispatcher::ClientReceiveResponse_Implementation(
...
void UMedComEquipmentNetworkDispatcher::ClientReceiveBatchResponse_Implementation(
...
void UMedComEquipmentNetworkDispatcher::MulticastOperationResult_Implementation(const FGuid& OperationId, bool bSuccess)
{
...
void UMedComEquipmentNetworkDispatcher::MulticastLowPriorityResult_Implementation(const FGuid& OperationId, bool bSuccess)
{
	UE_LOG(LogEquipmentNetwork, Verbose,
