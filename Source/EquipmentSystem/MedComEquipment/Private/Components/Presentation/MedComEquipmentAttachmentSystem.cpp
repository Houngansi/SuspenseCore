...
UMedComEquipmentAttachmentSystem::UMedComEquipmentAttachmentSystem()
...
void UMedComEquipmentAttachmentSystem::BeginPlay()
{
	Super::BeginPlay();
...
void UMedComEquipmentAttachmentSystem::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	UEquipmentServiceLocator* Locator = UEquipmentServiceLocator::Get(this);
	if (Locator)
	{
...
void UMedComEquipmentAttachmentSystem::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
bool UMedComEquipmentAttachmentSystem::AttachEquipment(
	AActor* Equipment,
...
bool UMedComEquipmentAttachmentSystem::DetachEquipment(AActor* Equipment, bool bMaintainWorldTransform)
{
...
bool UMedComEquipmentAttachmentSystem::UpdateAttachment(
	AActor* Equipment,
...
FEquipmentAttachmentState UMedComEquipmentAttachmentSystem::GetAttachmentState(AActor* Equipment) const
{
...
FName UMedComEquipmentAttachmentSystem::FindBestSocket(
...
bool UMedComEquipmentAttachmentSystem::SwitchAttachmentState(
	AActor* Equipment,
	bool bMakeActive,
	float /*Duration*/)
{
...
FEquipmentAttachmentConfig UMedComEquipmentAttachmentSystem::GetSlotAttachmentConfig(
	int32 /*SlotIndex*/,
...
bool UMedComEquipmentAttachmentSystem::ValidateSocket(
	USceneComponent* Target,
...
USkeletalMeshComponent* UMedComEquipmentAttachmentSystem::FindPrimarySkelMesh(AActor* Character) const
{
...
USceneComponent* UMedComEquipmentAttachmentSystem::GetAttachmentTarget(AActor* Character) const
{
...
bool UMedComEquipmentAttachmentSystem::AttachToCharacter(AActor* Equipment, AActor* TargetCharacter,
...
bool UMedComEquipmentAttachmentSystem::DetachFromCharacter(AActor* Equipment, AActor* /*TargetCharacter*/, bool bSmooth)
{
	return DetachEquipment(Equipment, /*bMaintainWorldTransform=*/bSmooth);
}

bool UMedComEquipmentAttachmentSystem::InternalAttach(
	AActor* Equipment,
	USceneComponent* Target,
...
void UMedComEquipmentAttachmentSystem::UpdateTransitions(float DeltaTime)
{
	FEquipmentRWGuard Rw(AttachmentStateLock, ELockType::Write);
...
const FSocketMappingConfig* UMedComEquipmentAttachmentSystem::FindSocketMapping(const FGameplayTag& ItemType) const
{
...
void UMedComEquipmentAttachmentSystem::MarkSocketOccupied(const FName& SocketName, AActor* Equipment)
{
	FEquipmentRWGuard Rw(SocketOccupationLock, ELockType::Write);
	OccupiedSockets.Add(SocketName, Equipment);
}

void UMedComEquipmentAttachmentSystem::ClearSocketOccupation(const FName& SocketName)
{
	FEquipmentRWGuard Rw(SocketOccupationLock, ELockType::Write);
	OccupiedSockets.Remove(SocketName);
}

USceneComponent* UMedComEquipmentAttachmentSystem::GetEquipmentRootComponent(AActor* Equipment) const
{
	return Equipment ? Equipment->GetRootComponent() : nullptr;
}

void UMedComEquipmentAttachmentSystem::InitializeDefaultMappings()
{
	{
...
void UMedComEquipmentAttachmentSystem::BroadcastAttachmentEvent(const FGameplayTag& EventTag, AActor* Equipment, bool bSuccess)
{
	FEquipmentEventData Ev;
...
void UMedComEquipmentAttachmentSystem::LogAttachmentOperation(const FString& Operation, const FString& Details) const
{
	UE_LOG(LogEquipmentOperation, Verbose, TEXT("[AttachmentSystem] %s: %s"), *Operation, *Details);
}

void UMedComEquipmentAttachmentSystem::RemoveSocketMapping(const FGameplayTag& ItemType)
{
...
TArray<AActor*> UMedComEquipmentAttachmentSystem::GetAllAttachedEquipment() const
{
	TArray<AActor*> Out;
	FEquipmentRWGuard Rw(AttachmentStateLock, ELockType::Read);
...
bool UMedComEquipmentAttachmentSystem::IsEquipmentAttached(AActor* Equipment) const
{
	FEquipmentRWGuard Rw(AttachmentStateLock, ELockType::Read);
...
void UMedComEquipmentAttachmentSystem::ForceUpdateAllAttachments()
{
	FEquipmentRWGuard Rw(AttachmentStateLock, ELockType::Read);
...
FString UMedComEquipmentAttachmentSystem::GetAttachmentStatistics() const
{
	FEquipmentRWGuard Rw(AttachmentStateLock, ELockType::Read);
