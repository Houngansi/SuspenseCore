...
// ==============================================
const TMap<EEquipmentSlotType, TArray<FGameplayTag>> UMedComEquipmentSlotValidator::TypeCompatibilityMatrix =
	UMedComEquipmentSlotValidator::CreateTypeCompatibilityMatrix();

// ==============================================
// ctor
// ==============================================
UMedComEquipmentSlotValidator::UMedComEquipmentSlotValidator()
{
...
FSlotValidationResult UMedComEquipmentSlotValidator::CanPlaceItemInSlot(
...
FSlotValidationResult UMedComEquipmentSlotValidator::ValidateSlotConfiguration(
...
FSlotValidationResult UMedComEquipmentSlotValidator::CheckSlotRequirements(
	const FEquipmentSlotConfig& SlotConfig,
...
bool UMedComEquipmentSlotValidator::IsItemTypeCompatibleWithSlot(
...
FSlotValidationResultEx UMedComEquipmentSlotValidator::CanPlaceItemInSlotEx(
	const FEquipmentSlotConfig& SlotConfig,
	const FInventoryItemInstance& ItemInstance) const
{
...
FBatchValidationResult UMedComEquipmentSlotValidator::ValidateBatch(const FBatchValidationRequest& Request) const
{
	const double Start = FPlatformTime::Seconds();
...
bool UMedComEquipmentSlotValidator::QuickValidateOperations(
	const TArray<FTransactionOperation>& Operations,
	const TScriptInterface<IMedComEquipmentDataProvider>& DataProvider) const
{
...
TArray<int32> UMedComEquipmentSlotValidator::FindOperationConflicts(
	const TArray<FTransactionOperation>& Operations,
	const TScriptInterface<IMedComEquipmentDataProvider>& DataProvider) const
{
	TArray<int32> Result;
...
TArray<int32> UMedComEquipmentSlotValidator::FindCompatibleSlots(
	const FGameplayTag& ItemType,
	const TScriptInterface<IMedComEquipmentDataProvider>& DataProvider) const
{
	TArray<int32> Out;
...
TArray<int32> UMedComEquipmentSlotValidator::GetSlotsByType(
...
int32 UMedComEquipmentSlotValidator::GetFirstEmptySlotOfType(
	EEquipmentSlotType EquipmentType,
	const TScriptInterface<IMedComEquipmentDataProvider>& DataProvider) const
{
...
bool UMedComEquipmentSlotValidator::RegisterValidationRule(
...
bool UMedComEquipmentSlotValidator::UnregisterValidationRule(const FGameplayTag& RuleTag)
{
	FScopeLock L(&RulesLock);
...
void UMedComEquipmentSlotValidator::SetRuleEnabled(const FGameplayTag& RuleTag, bool bEnabled)
{
	FScopeLock L(&RulesLock);
...
TArray<FGameplayTag> UMedComEquipmentSlotValidator::GetRegisteredRules() const
{
	FScopeLock L(&RulesLock);
...
void UMedComEquipmentSlotValidator::InitializeDefaultRules()
{
	InitializeBuiltInRules();
}

void UMedComEquipmentSlotValidator::ClearValidationCache()
{
	UE_LOG(LogEquipmentValidation, Error, 
...
FString UMedComEquipmentSlotValidator::GetValidationStatistics() const
{
...
void UMedComEquipmentSlotValidator::SetItemDataProvider(TSharedPtr<IMedComItemDataProvider> Provider)
{
...
void UMedComEquipmentSlotValidator::SetSlotRestrictions(const FGameplayTag& SlotTag, const FSlotRestrictionData& Restrictions)
{
	FScopeLock DL(&DataLock);
...
FSlotRestrictionData UMedComEquipmentSlotValidator::GetSlotRestrictions(const FGameplayTag& SlotTag) const
{
	FScopeLock DL(&DataLock);
...
void UMedComEquipmentSlotValidator::SetSlotCompatibilityMatrix(int32 SlotIndex, const TArray<FSlotCompatibilityEntry>& Entries)
{
	FScopeLock DL(&DataLock);
...
uint32 UMedComEquipmentSlotValidator::GetCurrentDataVersion() const
{
	...
	// Опциональная контрактная точка: IMedComEquipmentDataProvider может иметь метод GetDataVersion().
	uint32 Version = 0;
...
FSlotValidationResult UMedComEquipmentSlotValidator::CanPlaceItemInSlot_NoLock(
	const FEquipmentSlotConfig& SlotConfig,
	const FInventoryItemInstance& ItemInstance) const
{
...
FSlotValidationResult UMedComEquipmentSlotValidator::ExecuteValidationRules_NoLock(
...
FSlotValidationResultEx UMedComEquipmentSlotValidator::ExecuteValidationRulesEx_NoLock(
	const FInventoryItemInstance& ItemInstance,
	const FEquipmentSlotConfig& SlotConfig,
	const FSlotRestrictionData* Restrictions) const
{
...
void UMedComEquipmentSlotValidator::InitializeBuiltInRules()
{
	FScopeLock L(&RulesLock);
	...
	TypeRule.RuleFunction = [this](const FInventoryItemInstance& Item, const FEquipmentSlotConfig& Slot, const FSlotRestrictionData*)
	{
	...
	LevelRule.RuleFunction = [this](const FInventoryItemInstance& Item, const FEquipmentSlotConfig&, const FSlotRestrictionData*)
	{
	...
	WeightRule.RuleFunction = [this](const FInventoryItemInstance& Item, const FEquipmentSlotConfig&, const FSlotRestrictionData* R)
	{
		if (!R) return true;
	...
	UniqueRule.RuleFunction = [this](const FInventoryItemInstance& Item, const FEquipmentSlotConfig& Slot, const FSlotRestrictionData* R)
	{
...
FSlotValidationResult UMedComEquipmentSlotValidator::ValidateItemType(
	const FInventoryItemInstance& ItemInstance,
	const FEquipmentSlotConfig& SlotConfig) const
{
	FMedComUnifiedItemData Data;
...
FSlotValidationResult UMedComEquipmentSlotValidator::ValidateItemLevel(
	const FInventoryItemInstance& ItemInstance,
	const FEquipmentSlotConfig& /*SlotConfig*/) const
{
...
FSlotValidationResult UMedComEquipmentSlotValidator::ValidateItemWeight(
	const FInventoryItemInstance& ItemInstance,
	const FEquipmentSlotConfig& /*SlotConfig*/,
	const FSlotRestrictionData& Restrictions) const
{
...
FSlotValidationResult UMedComEquipmentSlotValidator::ValidateUniqueItem(
	const FInventoryItemInstance& ItemInstance,
	const FEquipmentSlotConfig& /*SlotConfig*/,
	...
	const TScriptInterface<IMedComEquipmentDataProvider>& DataProvider) const
{
	...
	for (int32 i = 0; i < Count; ++i)
	{
		...
		const FInventoryItemInstance Other = DataProvider->GetSlotItem(i);
...
bool UMedComEquipmentSlotValidator::GetItemData(const FName& ItemID, FMedComUnifiedItemData& OutData) const
{
...
bool UMedComEquipmentSlotValidator::ItemHasTag(
	const FInventoryItemInstance& ItemInstance,
...
TArray<FGameplayTag> UMedComEquipmentSlotValidator::GetCompatibleItemTypes(EEquipmentSlotType SlotType) const
{
...
int32 UMedComEquipmentSlotValidator::GetResultCodeForFailure(EEquipmentValidationFailure FailureType) const
{
	switch (FailureType)
	{
...
bool UMedComEquipmentSlotValidator::CheckSlotCompatibilityConflicts(
	int32 SlotIndexA,
	int32 SlotIndexB,
	const TScriptInterface<IMedComEquipmentDataProvider>& DataProvider) const
{
...
bool UMedComEquipmentSlotValidator::GetCachedValidation(
...
bool UMedComEquipmentSlotValidator::GetCachedValidationEx(
	const FString& CacheKey,
...
void UMedComEquipmentSlotValidator::CacheValidationResult(
	const FString& CacheKey,
...
void UMedComEquipmentSlotValidator::CacheValidationResultEx(
	const FString& CacheKey,
...
FString UMedComEquipmentSlotValidator::GenerateCacheKey(
...
void UMedComEquipmentSlotValidator::CleanExpiredCacheEntries() const
{
	const uint32 Version = GetCurrentDataVersion();
...
TMap<EEquipmentSlotType, TArray<FGameplayTag>> UMedComEquipmentSlotValidator::CreateTypeCompatibilityMatrix()
{
