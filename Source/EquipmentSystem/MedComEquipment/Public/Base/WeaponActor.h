 ...
 */
UCLASS()
class MEDCOMEQUIPMENT_API AWeaponActor : public AEquipmentActorBase,
                                         public IMedComWeaponInterface,
                                         public IMedComFireModeProviderInterface
{
    GENERATED_BODY()
...
public:
    ...
    //================================================
    // AEquipmentActorBase overrides (S3/S4 pipeline)
    //================================================
    ...
    //================================================
    // IMedComWeaponInterface (facade -> components)
    //================================================
    virtual FWeaponInitializationResult InitializeFromItemData_Implementation(const FInventoryItemInstance& ItemInstance) override;
    virtual bool GetWeaponItemData_Implementation(FMedComUnifiedItemData& OutData) const override;
    virtual FInventoryItemInstance GetItemInstance_Implementation() const override;
    ...
    //================================================
    // IMedComFireModeProviderInterface (proxy to component)
    //================================================
...
protected:
    ...
    void SetupComponentsFromItemData(const FMedComUnifiedItemData& ItemData);
    ...
    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="Components", meta=(AllowPrivateAccess="true"))
    UWeaponFireModeComponent* FireModeComponent;
