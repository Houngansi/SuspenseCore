...
#include "Types/Loadout/LoadoutSettings.h" // For updated EEquipmentSlotType (Primary/Secondary/Holster/Scabbard)
#include "GameplayTagContainer.h"
#include <atomic>
#include "MedComEquipmentOperationExecutor.generated.h"
...
class MEDCOMEQUIPMENT_API UMedComEquipmentOperationExecutor
	: public UActorComponent
	, public IMedComEquipmentOperations
{
	GENERATED_BODY()

public:
	UMedComEquipmentOperationExecutor();
	virtual ~UMedComEquipmentOperationExecutor() = default;
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Equipment|Operations|Planning")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Equipment|Operations|Planning", BlueprintPure)
	...
	// =====================================================
	// IMedComEquipmentOperations Implementation (Compatibility)
	// =====================================================
	...
	virtual FEquipmentOperationResult EquipItem(const FInventoryItemInstance& ItemInstance, int32 SlotIndex) override;
	...
	UFUNCTION(BlueprintCallable, Category="Equipment|Operations|Stats", BlueprintPure)
	...
	/** Reset statistics */
	UFUNCTION(BlueprintCallable, Category="Equipment|Operations|Stats")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Equipment|Operations|Validation")
...
protected:
	...
	int32 FindBestSlotForItem(const FInventoryItemInstance& ItemInstance) const;
...
private:
	...
	UPROPERTY()
	TScriptInterface<IMedComSlotValidator> SlotValidator;
