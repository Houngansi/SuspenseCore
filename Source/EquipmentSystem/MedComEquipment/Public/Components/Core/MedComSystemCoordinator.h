...
#include "MedComSystemCoordinator.generated.h"
...
class MEDCOMEQUIPMENT_API UMedComSystemCoordinator : public UActorComponent
{
    GENERATED_BODY()

public:
    UMedComSystemCoordinator();
    ...
    UFUNCTION(BlueprintCallable, Category="Equipment|Coordinator")
...
protected:
    /** Get ServiceLocator */
    UEquipmentServiceLocator* GetLocator() const;
