...
#include "Interfaces/Equipment/IMedComWeaponStateProvider.h"
#include "GameplayTagContainer.h"
#include "MedComWeaponStateManager.generated.h"
...
class MEDCOMEQUIPMENT_API UMedComWeaponStateManager : public UActorComponent, public IMedComWeaponStateProvider
{
    GENERATED_BODY()

public:
    UMedComWeaponStateManager();
    ...
    //~ Begin IMedComWeaponStateProvider Interface
    ...
    //~ End IMedComWeaponStateProvider Interface
    ...
    bool Initialize(
        ...
        TScriptInterface<IMedComEventDispatcher> EventDispatcher
    );
