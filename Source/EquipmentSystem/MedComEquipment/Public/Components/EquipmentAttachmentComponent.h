...
#include "EquipmentAttachmentComponent.generated.h"

// Forward declarations
class USceneComponent;
class USkeletalMeshComponent;
class UEquipmentMeshComponent;
class UMedComWeaponStanceComponent;
...
class MEDCOMEQUIPMENT_API UEquipmentAttachmentComponent : public UEquipmentComponentBase
{
    GENERATED_BODY()

public:
    UEquipmentAttachmentComponent();
     ...
     */
    virtual void InitializeWithItemInstance(AActor* InOwner, UAbilitySystemComponent* InASC, const FInventoryItemInstance& ItemInstance) override;
     ...
     */
    virtual void UpdateEquippedItem(const FInventoryItemInstance& NewItemInstance) override;
    ...
    void LinkStanceComponent(UMedComWeaponStanceComponent* StanceComponent);
     ...
     */
    TArray<FSocketSearchResult> GetValidSocketsForItem(const FMedComUnifiedItemData& ItemData, USkeletalMeshComponent* TargetMesh) const;
...
protected:
     ...
     */
    virtual void OnEquippedItemChanged(const FInventoryItemInstance& OldItem, const FInventoryItemInstance& NewItem) override;
     ...
     * @return Spawned actor or nullptr
     */
    AActor* SpawnEquipmentActor(const FMedComUnifiedItemData& ItemData);
     ...
     */
    FName FindBestAttachmentSocket(USkeletalMeshComponent* TargetMesh, const FMedComUnifiedItemData& ItemData, bool bForActive) const;
...
private:
    ...
    mutable TScriptInterface<IMedComWeaponAnimationInterface> CachedAnimationInterface;
    ...
    UPROPERTY()
    TWeakObjectPtr<UMedComWeaponStanceComponent> LinkedStanceComponent;
