...
#include "EquipmentAttributeComponent.generated.h"
...
class MEDCOMEQUIPMENT_API UEquipmentAttributeComponent : public UEquipmentComponentBase
{
    GENERATED_BODY()

public:
    UEquipmentAttributeComponent();
     ...
     */
    virtual void UpdateEquippedItem(const FInventoryItemInstance& ItemInstance) override;
    ...
    void ApplyItemEffects(const FMedComUnifiedItemData& ItemData);
...
protected:
     ...
     */
    void CreateAttributeSetsForItem(const FMedComUnifiedItemData& ItemData);
     ...
     */
    void ApplyInitializationEffect(UAttributeSet* AttributeSet, TSubclassOf<UGameplayEffect> InitEffect, const FMedComUnifiedItemData& ItemData);

    /**
     * Apply passive effects from item data
     * @param ItemData Item data containing effect classes
     */
    void ApplyPassiveEffects(const FMedComUnifiedItemData& ItemData);

    /**
     * Apply granted abilities from item data
     * @param ItemData Item data containing abilities
     */
    void ApplyGrantedAbilities(const FMedComUnifiedItemData& ItemData);
