...
struct FEquipmentComponentPredictionData
{
    ...
    UPROPERTY()
    FInventoryItemInstance PredictedItem;
 ...
 */
UCLASS(Abstract)
class MEDCOMEQUIPMENT_API UEquipmentComponentBase : public UActorComponent, public IMedComAbilityProvider
{
    GENERATED_BODY()

public:
    UEquipmentComponentBase();
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Equipment")
    virtual void InitializeWithItemInstance(AActor* InOwner, UAbilitySystemComponent* InASC, const FInventoryItemInstance& ItemInstance);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Equipment")
    virtual void UpdateEquippedItem(const FInventoryItemInstance& NewItemInstance);
    ...
    int32 StartClientPrediction(const FInventoryItemInstance& PredictedInstance);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Equipment|Prediction")
    void ConfirmClientPrediction(int32 PredictionKey, bool bSuccess, const FInventoryItemInstance& ActualInstance);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Equipment|Data")
    const FInventoryItemInstance& GetEquippedItemInstance() const { return EquippedItemInstance; }
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Equipment|Data")
    virtual void SetEquippedItemInstance(const FInventoryItemInstance& ItemInstance);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Equipment|Data")
    bool GetEquippedItemData(FMedComUnifiedItemData& OutItemData) const;
    ...
    void BroadcastItemEquipped(const FInventoryItemInstance& ItemInstance, const FGameplayTag& SlotType);
    void BroadcastItemUnequipped(const FInventoryItemInstance& ItemInstance, const FGameplayTag& SlotType);
...
protected:
     ...
     */
    virtual void OnEquippedItemChanged(const FInventoryItemInstance& OldItem, const FInventoryItemInstance& NewItem);
    ...
    UFUNCTION()
    void OnRep_EquippedItemInstance(const FInventoryItemInstance& OldInstance);
