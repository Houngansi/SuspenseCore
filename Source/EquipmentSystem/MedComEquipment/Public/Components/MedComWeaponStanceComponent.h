...
#include "MedComWeaponStanceComponent.generated.h"
...
class MEDCOMEQUIPMENT_API UMedComWeaponStanceComponent : public UActorComponent
{
	GENERATED_BODY()

public:
	UMedComWeaponStanceComponent();

	//~UObject
	virtual void GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const override;

	// -------- API, которое дергает UEquipmentAttachmentComponent --------
