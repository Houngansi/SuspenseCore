...
#include "MedComEquipmentNetworkDispatcher.generated.h"
...
class MEDCOMEQUIPMENT_API UMedComEquipmentNetworkDispatcher
	: public UActorComponent
	, public IMedComNetworkDispatcher
{
	GENERATED_BODY()
public:
	UMedComEquipmentNetworkDispatcher();
	...
	// Wiring / Config
	UFUNCTION(BlueprintCallable, Category="Equipment|Network|Security")
	...
	void SetOperationExecutor(TScriptInterface<IMedComEquipmentOperations> InExecutor);
	UFUNCTION(BlueprintCallable, Category="Equipment|Network")
...
private:
	...
	static FInventoryItemInstanceNet   ToNet(const FInventoryItemInstance& In);
	static FInventoryItemInstance      FromNet(const FInventoryItemInstanceNet& In);
