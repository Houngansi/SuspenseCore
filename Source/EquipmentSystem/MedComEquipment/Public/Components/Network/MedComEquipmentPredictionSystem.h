...
#include "MedComEquipmentPredictionSystem.generated.h"
...
class MEDCOMEQUIPMENT_API UMedComEquipmentPredictionSystem : public UActorComponent, public IMedComPredictionManager
{
    GENERATED_BODY()
public:
    UMedComEquipmentPredictionSystem();
    ...
    bool Initialize(TScriptInterface<IMedComEquipmentDataProvider> InDataProvider,TScriptInterface<IMedComEquipmentOperations> InOperationExecutor);
    UFUNCTION(BlueprintCallable,Category="Equipment|Prediction")
    void SetNetworkDispatcher(UMedComEquipmentNetworkDispatcher* InDispatcher);
    UFUNCTION(BlueprintCallable,Category="Equipment|Prediction")
    void SetReplicationManager(UMedComEquipmentReplicationManager* InReplicationManager);
    UFUNCTION(BlueprintCallable,Category="Equipment|Prediction")
...
private:
    ...
    UPROPERTY() TScriptInterface<IMedComEquipmentOperations> OperationExecutor;
    UPROPERTY() UMedComEquipmentNetworkDispatcher* NetworkDispatcher=nullptr;
    UPROPERTY() UMedComEquipmentReplicationManager* ReplicationManager=nullptr;
