...
#include "MedComEquipmentReplicationManager.generated.h"
...
struct FReplicatedSlotItem : public FFastArraySerializerItem
{
    ...
    UPROPERTY() FInventoryItemInstance ItemInstance;
...
struct FSlotReplicationState
{
    GENERATED_BODY()
    UPROPERTY() int32 SlotIndex=INDEX_NONE;
    UPROPERTY() FInventoryItemInstance LastReplicatedItem;
...
class MEDCOMEQUIPMENT_API UMedComEquipmentReplicationManager : public UActorComponent, public IMedComReplicationProvider
{
    GENERATED_BODY()
public:
    ...
    UFUNCTION(BlueprintCallable,Category="Equipment|Replication")
...
protected:
    ...
    FString GenerateSlotHMAC(const FInventoryItemInstance& SlotData)const;
    bool VerifySlotHMAC(const FInventoryItemInstance& SlotData,const FString& HMACSignature)const;
    ...
    void OnDataChanged(int32 SlotIndex,const FInventoryItemInstance& NewData);
