...
#include "Interfaces/Equipment/IMedComActorFactory.h"
...
#include "MedComEquipmentActorFactory.generated.h"
...
class MEDCOMEQUIPMENT_API UMedComEquipmentActorFactory : public UActorComponent, public IMedComActorFactory
{
    GENERATED_BODY()

public:
    UMedComEquipmentActorFactory();
    ...
    //~ Begin IMedComActorFactory Interface
    ...
    virtual bool ConfigureEquipmentActor(AActor* Actor, const FInventoryItemInstance& ItemInstance) override;
    ...
    //~ End IMedComActorFactory Interface
