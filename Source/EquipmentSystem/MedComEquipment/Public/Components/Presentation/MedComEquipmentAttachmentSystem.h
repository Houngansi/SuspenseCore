...
#include "Interfaces/Equipment/IMedComAttachmentProvider.h"
...
#include "MedComEquipmentAttachmentSystem.generated.h"
...
class MEDCOMEQUIPMENT_API UMedComEquipmentAttachmentSystem : public UActorComponent, public IMedComAttachmentProvider
{
	GENERATED_BODY()

public:
	UMedComEquipmentAttachmentSystem();
	...
	//~ Begin IMedComAttachmentProvider Interface
	...
	//~ End IMedComAttachmentProvider Interface
