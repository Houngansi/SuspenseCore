// MedComWeightRulesEngine.h © MedCom Team. All Rights Reserved.
...
#include "MedComWeightRulesEngine.generated.h"
...
class MEDCOMEQUIPMENT_API UMedComWeightRulesEngine : public UObject
{
    GENERATED_BODY()
public:
    UMedComWeightRulesEngine();
    ...
    UFUNCTION(BlueprintCallable, Category="Weight Rules")
    float CalculateItemWeight(const FInventoryItemInstance& Item) const;
    ...
    UFUNCTION(BlueprintCallable, Category="Weight Rules")
    TArray<int32> FindHeaviestItems(const TArray<FInventoryItemInstance>& Items, int32 TopN = 3) const;
...
protected:
    ...
    float GetItemRuntimeWeight(const FInventoryItemInstance& Item) const;
