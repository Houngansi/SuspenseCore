...
#include "MedComEquipmentTransactionProcessor.generated.h"
...
class MEDCOMEQUIPMENT_API UMedComEquipmentTransactionProcessor : public UActorComponent, public IMedComTransactionManager
{
    GENERATED_BODY()

public:
    UMedComEquipmentTransactionProcessor();
    virtual ~UMedComEquipmentTransactionProcessor();
    ...
    //========================================
    // IMedComTransactionManager Implementation
    //========================================
     ...
     */
    IMedComEquipmentDataProvider* GetDataProvider() const { return DataProvider.GetInterface(); }
