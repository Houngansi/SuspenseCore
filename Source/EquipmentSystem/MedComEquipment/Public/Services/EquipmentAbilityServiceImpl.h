...
#include "EquipmentAbilityServiceImpl.generated.h"

// Forward declarations
class UMedComEquipmentAbilityConnector;
 ...
 */
UCLASS()
class MEDCOMEQUIPMENT_API UEquipmentAbilityServiceImpl : public UObject, public IEquipmentService
{
    GENERATED_BODY()

public:
    UEquipmentAbilityServiceImpl();
    virtual ~UEquipmentAbilityServiceImpl();
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Equipment|Abilities")
    UMedComEquipmentAbilityConnector* GetOrCreateConnectorForEquipment(
...
protected:
    ...
    UMedComEquipmentAbilityConnector* CreateConnectorForEquipment(
        AActor* EquipmentActor,
        AActor* OwnerActor
    );
...
private:
    ...
    //========================================
    UPROPERTY()
    TMap<TWeakObjectPtr<AActor>, UMedComEquipmentAbilityConnector*> EquipmentConnectors;
