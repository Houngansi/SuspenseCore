...
#include "EquipmentDataServiceImpl.generated.h"
...
UCLASS()
class MEDCOMEQUIPMENT_API UEquipmentDataServiceImpl : public UObject, 
    public IEquipmentDataService
{
    GENERATED_BODY()

public:
    UEquipmentDataServiceImpl();
    virtual ~UEquipmentDataServiceImpl();
 ...
 virtual IMedComEquipmentDataProvider* GetDataProvider() override;
 virtual IMedComTransactionManager* GetTransactionManager() override;
  ...
  * 
  * @param InDataStore Ready data storage component (UObject* will be cast to UMedComEquipmentDataStore*)
  * @param InTransactionProcessor Ready transaction processing component (UObject* will be cast to UMedComEquipmentTransactionProcessor*)
  */
  ...
  * 
  * @param InValidator Validator component (UObject* will be cast to UMedComEquipmentSlotValidator*)
  */
 virtual void SetValidator(UObject* InValidator) override;
    ...
    FInventoryItemInstance GetSlotItemCached(int32 SlotIndex) const;
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Equipment|Data")
    TMap<int32, FInventoryItemInstance> BatchGetSlotItems(const TArray<int32>& SlotIndices) const;
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Equipment|Data")
    FGuid BatchUpdateSlots(const TMap<int32, FInventoryItemInstance>& Updates);
...
protected:
     ...
     */
    void UpdateCacheEntry(int32 SlotIndex, const FInventoryItemInstance& Item) const;
    
    /**
     * Batch update cache entries with single lock
     */
    void BatchUpdateCache(const TMap<int32, FInventoryItemInstance>& Items) const;
...
private:
    ...
    UPROPERTY()
    UMedComEquipmentDataStore* DataStore = nullptr;
    
    /** Transaction processor for ACID operations */
    UPROPERTY()
    UMedComEquipmentTransactionProcessor* TransactionProcessor = nullptr;
    
    /** Slot validator for business logic */
    UPROPERTY()
    UMedComEquipmentSlotValidator* SlotValidator = nullptr;
    ...
    TScriptInterface<IMedComTransactionManager> TransactionManagerInterface;

 UPROPERTY(Transient)
    TObjectPtr<UMedComItemManager> ItemManager = nullptr;
    //========================================
    // Thread Safety
    //========================================
    ...
    mutable TSharedPtr<FEquipmentCacheManager<int32, FInventoryItemInstance>> ItemCache;
