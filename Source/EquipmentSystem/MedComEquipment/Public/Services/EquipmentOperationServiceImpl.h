...
#include <atomic>
#include "EquipmentOperationServiceImpl.generated.h"

class UEquipmentValidationServiceImpl;

DECLARE_LOG_CATEGORY_EXTERN(LogEquipmentOperations, Log, All);
 ...
 */
UCLASS(Config=Game)
class MEDCOMEQUIPMENT_API UEquipmentOperationServiceImpl : public UObject,
    public IEquipmentOperationService
{
    GENERATED_BODY()

public:
    UEquipmentOperationServiceImpl();
    virtual ~UEquipmentOperationServiceImpl();
    ...
    virtual IMedComEquipmentOperations* GetOperationsExecutor() override;
    ...
    UFUNCTION(BlueprintCallable, Category="Equipment|Operations")
    void SetOperationsExecutor(TScriptInterface<IMedComEquipmentOperations> InExecutor);
...
private:
    ...
    */
    ...
    // Core Dependencies
    UPROPERTY()
    TScriptInterface<IMedComEquipmentOperations> OperationsExecutor;
    ...
    UPROPERTY()
    TScriptInterface<IMedComEquipmentRules> RulesEngine;
    ...
    UPROPERTY(Transient)
    TWeakObjectPtr<UEquipmentValidationServiceImpl> ValidationServiceObject;
