...
#include <atomic>
#include "EquipmentValidationServiceImpl.generated.h"
...
{
    TMap<int32, FInventoryItemInstance> SlotItems;
    ...
    // Get item at slot
    FInventoryItemInstance GetItemAtSlot(int32 SlotIndex) const;
};
 ...
 */
UCLASS()
class MEDCOMEQUIPMENT_API UEquipmentValidationServiceImpl : public UObject,
    public IEquipmentValidationService
{
    GENERATED_BODY()

public:
    UEquipmentValidationServiceImpl();
    virtual ~UEquipmentValidationServiceImpl();
    ...
    virtual IMedComEquipmentRules* GetRulesEngine() override;
...
private:
    ...
    UPROPERTY(Transient)
    TWeakObjectPtr<UEquipmentServiceLocator> ServiceLocatorRef;
    //========================================
    // Core Dependencies
    //========================================
    ...
    UPROPERTY()
    TScriptInterface<IMedComEquipmentRules> Rules;
