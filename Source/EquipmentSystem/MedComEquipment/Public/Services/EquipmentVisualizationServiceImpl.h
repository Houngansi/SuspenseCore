...
#include "EquipmentVisualizationServiceImpl.generated.h"
 ...
 */
UCLASS()
class MEDCOMEQUIPMENT_API UEquipmentVisualizationServiceImpl final : public UObject, public IEquipmentService
{
	GENERATED_BODY()
