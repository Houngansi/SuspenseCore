...
#include "MedComSystemCoordinatorSubsystem.generated.h"
 ...
 * 
 * ARCHITECTURE:
 * - Owns UMedComSystemCoordinator (persistent, not temporary)
...
class MEDCOMEQUIPMENT_API UMedComSystemCoordinatorSubsystem : public UGameInstanceSubsystem
{
    GENERATED_BODY()

public:
    UMedComSystemCoordinatorSubsystem();
     ...
     */
    UFUNCTION(BlueprintPure, Category="MedCom|Services")
    UMedComSystemCoordinator* GetCoordinator() const { return Coordinator; }
...
private:
     ...
     */
    UPROPERTY(Transient)
    TObjectPtr<UMedComSystemCoordinator> Coordinator = nullptr;
