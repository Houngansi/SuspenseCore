...
USuspenseEquipmentInventoryBridge::USuspenseEquipmentInventoryBridge()
{
    PrimaryComponentTick.bCanEverTick = false;
}

void USuspenseEquipmentInventoryBridge::BeginPlay()
{
    Super::BeginPlay();
}

void USuspenseEquipmentInventoryBridge::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
bool USuspenseEquipmentInventoryBridge::Initialize(
    ...
    TScriptInterface<ISuspenseTransactionManager> InTransactionMgr)
{
    ...
    if (USuspenseEquipmentServiceLocator* Locator = USuspenseEquipmentServiceLocator::Get(GetWorld()))
    {
    ...
    EventDelegateManager = GameInstance->GetSubsystem<USuspenseEventManager>();
...
void USuspenseEquipmentInventoryBridge::SetInventoryInterface(TScriptInterface<ISuspenseInventory> InInventoryInterface)
{
...
void USuspenseEquipmentInventoryBridge::HandleEquipmentOperationRequest(
...
FSuspenseInventoryOperationResult USuspenseEquipmentInventoryBridge::ExecuteTransfer_FromEquipToInventory(
...
FSuspenseInventoryOperationResult USuspenseEquipmentInventoryBridge::TransferFromInventory(const FInventoryTransferRequest& Request)
{
    return ExecuteTransfer_FromInventoryToEquip(Request);
}

FSuspenseInventoryOperationResult USuspenseEquipmentInventoryBridge::TransferToInventory(const FInventoryTransferRequest& Request)
{
    return ExecuteTransfer_FromEquipToInventory(Request);
}

FSuspenseInventoryOperationResult USuspenseEquipmentInventoryBridge::SwapBetweenInventoryAndEquipment(
...
void USuspenseEquipmentInventoryBridge::SynchronizeWithInventory()
{
...
bool USuspenseEquipmentInventoryBridge::CanEquipFromInventory(const FSuspenseInventoryItemInstance& Item, int32 TargetSlot) const
{
    ...
    if (USuspenseEquipmentOperationExecutor* Executor =
        Cast<USuspenseEquipmentOperationExecutor>(EquipmentOperations.GetObject()))
    {
...
bool USuspenseEquipmentInventoryBridge::CanUnequipToInventory(int32 SourceSlot) const
{
    if (!EquipmentDataProvider.GetInterface() || !InventoryInterface.GetInterface())
    {
        return false;
...
FSuspenseInventoryOperationResult USuspenseEquipmentInventoryBridge::ExecuteTransfer_FromInventoryToEquip(
    const FInventoryTransferRequest& Request)
{
...
void USuspenseEquipmentInventoryBridge::BroadcastUnequippedEvent(
    ...
    int32 SlotIndex)
{
    ...
    FSuspenseEquipmentEventData EvOut;
    ...
    TSharedPtr<FSuspenseEquipmentEventBus> EventBus = FSuspenseEquipmentEventBus::Get();
    if (EventBus.IsValid())
    {
...
FSuspenseInventoryOperationResult USuspenseEquipmentInventoryBridge::ExecuteSwap_InventoryToEquipment(
...
FGuid USuspenseEquipmentInventoryBridge::BeginBridgeTransaction()
{
    FScopeLock Lock(&TransactionLock);
...
bool USuspenseEquipmentInventoryBridge::CommitBridgeTransaction(const FGuid& TransactionID)
{
    FScopeLock Lock(&TransactionLock);
...
bool USuspenseEquipmentInventoryBridge::RollbackBridgeTransaction(const FGuid& TransactionID)
{
    FScopeLock Lock(&TransactionLock);
...
bool USuspenseEquipmentInventoryBridge::ValidateInventorySpace(const FSuspenseInventoryItemInstance& Item) const
{
    if (!InventoryInterface.GetInterface())
    {
        return false;
...
bool USuspenseEquipmentInventoryBridge::ValidateEquipmentSlot(int32 SlotIndex, const FSuspenseInventoryItemInstance& Item) const
{
    if (!EquipmentDataProvider.GetInterface())
    {
        return false;
...
bool USuspenseEquipmentInventoryBridge::InventoryHasSpace(const FSuspenseInventoryItemInstance& Item) const
{
...
void USuspenseEquipmentInventoryBridge::CleanupExpiredReservations()
{
...
bool USuspenseEquipmentInventoryBridge::FindItemInInventory(const FName& ItemId, FSuspenseInventoryItemInstance& OutInstance) const
{
    if (!InventoryInterface.GetInterface())
    {
        return false;
...
AActor* USuspenseEquipmentInventoryBridge::ResolveCharacterTarget() const
{
...
void USuspenseEquipmentInventoryBridge::BroadcastEquippedEvent(const FSuspenseInventoryItemInstance& Item, int32 SlotIndex)
{
    ...
    FSuspenseEquipmentEventData EvIn;
...
void USuspenseEquipmentInventoryBridge::BroadcastSwapEvents(
    ...
    int32 SlotIndex)
{
    ...
    if (OldItem.IsValid())
    {
        ...
        if (UnequippedTag.IsValid())
        {
            ...
            FSuspenseEquipmentEventBus::Get()->Broadcast(EvOut);
...
FSlotValidationResult USuspenseEquipmentOperationExecutor::CanEquipItemToSlot(
