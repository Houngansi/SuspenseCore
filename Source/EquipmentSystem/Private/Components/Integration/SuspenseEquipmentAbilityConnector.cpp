...
USuspenseEquipmentAbilityConnector::USuspenseEquipmentAbilityConnector()
{
...
void USuspenseEquipmentAbilityConnector::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
bool USuspenseEquipmentAbilityConnector::Initialize(
...
//==================================================================
// ISuspenseAbilityConnector Interface - Core Implementation
//==================================================================

TArray<FGameplayAbilitySpecHandle> USuspenseEquipmentAbilityConnector::GrantEquipmentAbilities(
    const FSuspenseInventoryItemInstance& ItemInstance)
{
    return GrantAbilitiesForSlot(INDEX_NONE, ItemInstance);
}

int32 USuspenseEquipmentAbilityConnector::RemoveGrantedAbilities(const TArray<FGameplayAbilitySpecHandle>& Handles)
{
...
TArray<FActiveGameplayEffectHandle> USuspenseEquipmentAbilityConnector::ApplyEquipmentEffects(
    const FSuspenseInventoryItemInstance& ItemInstance)
{
    return ApplyEffectsForSlot(INDEX_NONE, ItemInstance);
}

int32 USuspenseEquipmentAbilityConnector::RemoveAppliedEffects(const TArray<FActiveGameplayEffectHandle>& Handles)
{
...
bool USuspenseEquipmentAbilityConnector::UpdateEquipmentAttributes(
    const FSuspenseInventoryItemInstance& ItemInstance)
{
...
UAttributeSet* USuspenseEquipmentAbilityConnector::GetEquipmentAttributeSet(int32 SlotIndex) const
{
...
bool USuspenseEquipmentAbilityConnector::ActivateEquipmentAbility(
...
TArray<FGameplayAbilitySpecHandle> USuspenseEquipmentAbilityConnector::GrantAbilitiesForSlot(
...
TArray<FActiveGameplayEffectHandle> USuspenseEquipmentAbilityConnector::ApplyEffectsForSlot(
    int32 SlotIndex, const FSuspenseInventoryItemInstance& ItemInstance)
{
...
void USuspenseEquipmentAbilityConnector::ClearAll()
{
...
int32 USuspenseEquipmentAbilityConnector::CleanupInvalidHandles()
{
...
bool USuspenseEquipmentAbilityConnector::ValidateConnector(TArray<FString>& OutErrors) const
{
    OutErrors.Empty();
    bool bIsValid = true;
...
TArray<FGameplayAbilitySpecHandle> USuspenseEquipmentAbilityConnector::GrantAbilitiesFromItemData(
...
TArray<FActiveGameplayEffectHandle> USuspenseEquipmentAbilityConnector::ApplyEffectsFromItemData(
    const FSuspenseUnifiedItemData& ItemData,
    const FSuspenseInventoryItemInstance& ItemInstance,
    int32 SlotIndex)
{
...
UAttributeSet* USuspenseEquipmentAbilityConnector::CreateAttributeSetFromItemData(
    const FSuspenseUnifiedItemData& ItemData,
    const FSuspenseInventoryItemInstance& ItemInstance,
    int32 SlotIndex)
{
...
FGameplayAbilitySpecHandle USuspenseEquipmentAbilityConnector::GrantSingleAbility(
...
FActiveGameplayEffectHandle USuspenseEquipmentAbilityConnector::ApplySingleEffect(
...
bool USuspenseEquipmentAbilityConnector::InitializeAttributeSet(
...
USuspenseItemManager* USuspenseEquipmentAbilityConnector::GetItemManager() const
{
...
bool USuspenseEquipmentAbilityConnector::EnsureValidExecution(const FString& FunctionName) const
{
