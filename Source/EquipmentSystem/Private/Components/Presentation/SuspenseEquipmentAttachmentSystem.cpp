...
void USuspenseEquipmentAttachmentSystem::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
bool USuspenseEquipmentAttachmentSystem::AttachEquipment(
	AActor* Equipment,
...
bool USuspenseEquipmentAttachmentSystem::DetachEquipment(AActor* Equipment, bool bMaintainWorldTransform)
{
...
bool USuspenseEquipmentAttachmentSystem::UpdateAttachment(
	AActor* Equipment,
...
FEquipmentAttachmentState USuspenseEquipmentAttachmentSystem::GetAttachmentState(AActor* Equipment) const
{
...
FName USuspenseEquipmentAttachmentSystem::FindBestSocket(
...
bool USuspenseEquipmentAttachmentSystem::SwitchAttachmentState(
	AActor* Equipment,
	bool bMakeActive,
	float /*Duration*/)
{
...
FEquipmentAttachmentConfig USuspenseEquipmentAttachmentSystem::GetSlotAttachmentConfig(
	int32 /*SlotIndex*/,
...
bool USuspenseEquipmentAttachmentSystem::ValidateSocket(
	USceneComponent* Target,
...
USkeletalMeshComponent* USuspenseEquipmentAttachmentSystem::FindPrimarySkelMesh(AActor* Character) const
{
...
USceneComponent* USuspenseEquipmentAttachmentSystem::GetAttachmentTarget(AActor* Character) const
{
...
bool USuspenseEquipmentAttachmentSystem::AttachToCharacter(AActor* Equipment, AActor* TargetCharacter,
...
bool USuspenseEquipmentAttachmentSystem::DetachFromCharacter(AActor* Equipment, AActor* /*TargetCharacter*/, bool bSmooth)
{
	return DetachEquipment(Equipment, /*bMaintainWorldTransform=*/bSmooth);
}

bool USuspenseEquipmentAttachmentSystem::InternalAttach(
	AActor* Equipment,
	USceneComponent* Target,
...
void USuspenseEquipmentAttachmentSystem::UpdateTransitions(float DeltaTime)
{
	FEquipmentRWGuard Rw(AttachmentStateLock, ELockType::Write);
...
const FSocketMappingConfig* USuspenseEquipmentAttachmentSystem::FindSocketMapping(const FGameplayTag& ItemType) const
{
...
void USuspenseEquipmentAttachmentSystem::MarkSocketOccupied(const FName& SocketName, AActor* Equipment)
{
	FEquipmentRWGuard Rw(SocketOccupationLock, ELockType::Write);
	OccupiedSockets.Add(SocketName, Equipment);
}

void USuspenseEquipmentAttachmentSystem::ClearSocketOccupation(const FName& SocketName)
{
	FEquipmentRWGuard Rw(SocketOccupationLock, ELockType::Write);
	OccupiedSockets.Remove(SocketName);
}

USceneComponent* USuspenseEquipmentAttachmentSystem::GetEquipmentRootComponent(AActor* Equipment) const
{
	return Equipment ? Equipment->GetRootComponent() : nullptr;
}

void USuspenseEquipmentAttachmentSystem::InitializeDefaultMappings()
{
	{
...
void USuspenseEquipmentAttachmentSystem::RemoveSocketMapping(const FGameplayTag& ItemType)
{
...
TArray<AActor*> USuspenseEquipmentAttachmentSystem::GetAllAttachedEquipment() const
{
	TArray<AActor*> Out;
	FEquipmentRWGuard Rw(AttachmentStateLock, ELockType::Read);
...
bool USuspenseEquipmentAttachmentSystem::IsEquipmentAttached(AActor* Equipment) const
{
	FEquipmentRWGuard Rw(AttachmentStateLock, ELockType::Read);
...
void USuspenseEquipmentAttachmentSystem::ForceUpdateAllAttachments()
{
	FEquipmentRWGuard Rw(AttachmentStateLock, ELockType::Read);
...
FString USuspenseEquipmentAttachmentSystem::GetAttachmentStatistics() const
{
	FEquipmentRWGuard Rw(AttachmentStateLock, ELockType::Read);
