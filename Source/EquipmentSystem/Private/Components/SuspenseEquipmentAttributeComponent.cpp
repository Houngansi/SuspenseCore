...
USuspenseEquipmentAttributeComponent::USuspenseEquipmentAttributeComponent()
{
...
void USuspenseEquipmentAttributeComponent::BeginPlay()
{
    ...
    if (GetOwner() && GetOwner()->HasAuthority() && GetWorld())
    {
        ...
        GetWorld()->GetTimerManager().SetTimer(
            TimerHandle,
            this,
            &USuspenseEquipmentAttributeComponent::CollectReplicatedAttributes,
...
void USuspenseEquipmentAttributeComponent::InitializeWithItemInstance(AActor* InOwner, UAbilitySystemComponent* InASC, const FSuspenseInventoryItemInstance& ItemInstance)
{
...
void USuspenseEquipmentAttributeComponent::Cleanup()
{
...
void USuspenseEquipmentAttributeComponent::UpdateEquippedItem(const FSuspenseInventoryItemInstance& ItemInstance)
{
    // Update base item
...
void USuspenseEquipmentAttributeComponent::CreateAttributeSetsForItem(const FSuspenseUnifiedItemData& ItemData)
{
    if (!CachedASC)
    {
...
void USuspenseEquipmentAttributeComponent::CleanupAttributeSets()
{
    if (!CachedASC)
    {
        return;
...
void USuspenseEquipmentAttributeComponent::ApplyInitializationEffect(UAttributeSet* AttributeSet, TSubclassOf<UGameplayEffect> InitEffect, const FSuspenseUnifiedItemData& ItemData)
{
...
void USuspenseEquipmentAttributeComponent::ApplyItemEffects(const FSuspenseUnifiedItemData& ItemData)
{
    if (!CachedASC)
    {
...
void USuspenseEquipmentAttributeComponent::RemoveItemEffects()
{
    if (!CachedASC)
    {
        return;
...
void USuspenseEquipmentAttributeComponent::ApplyPassiveEffects(const FSuspenseUnifiedItemData& ItemData)
{
...
void USuspenseEquipmentAttributeComponent::ApplyGrantedAbilities(const FSuspenseUnifiedItemData& ItemData)
{
...
int32 USuspenseEquipmentAttributeComponent::PredictAttributeChange(const FString& AttributeName, float NewValue)
{
...
void USuspenseEquipmentAttributeComponent::ConfirmAttributePrediction(int32 PredictionKey, bool bSuccess, float ActualValue)
{
...
bool USuspenseEquipmentAttributeComponent::HasAttribute(const FString& AttributeName) const
{
    float DummyValue;
    return GetAttributeValue(AttributeName, DummyValue);
}

bool USuspenseEquipmentAttributeComponent::GetAttributeByTag(const FGameplayTag& AttributeTag, float& OutValue) const
{
...
void USuspenseEquipmentAttributeComponent::ForceAttributeReplication()
{
    if (GetOwner() && GetOwner()->HasAuthority())
    {
        CollectReplicatedAttributes();
...
void USuspenseEquipmentAttributeComponent::CollectReplicatedAttributes()
{
    if (!GetOwner() || !GetOwner()->HasAuthority())
    {
        return;
...
void USuspenseEquipmentAttributeComponent::ApplyReplicatedAttributes()
{
...
void USuspenseEquipmentAttributeComponent::OnRep_ReplicatedAttributes()
{
...
void USuspenseEquipmentAttributeComponent::OnRep_AttributeSetClasses()
{
...
void USuspenseEquipmentAttributeComponent::ServerSetAttributeValue_Implementation(const FString& AttributeName, float NewValue)
{
    SetAttributeValue(AttributeName, NewValue, true);
}

bool USuspenseEquipmentAttributeComponent::ServerSetAttributeValue_Validate(const FString& AttributeName, float NewValue)
{
    return !AttributeName.IsEmpty();
}

void USuspenseEquipmentAttributeComponent::ServerApplyItemEffects_Implementation(const FName& ItemID)
{
    FSuspenseUnifiedItemData ItemData;
...
bool USuspenseEquipmentAttributeComponent::ServerApplyItemEffects_Validate(const FName& ItemID)
{
    return !ItemID.IsNone();
}

void USuspenseEquipmentAttributeComponent::ServerRemoveItemEffects_Implementation()
{
    RemoveItemEffects();
}

bool USuspenseEquipmentAttributeComponent::ServerRemoveItemEffects_Validate()
{
    return true;
}
...
FProperty* USuspenseEquipmentAttributeComponent::FindAttributeProperty(UAttributeSet* AttributeSet, const FString& AttributeName) const
{
    if (!AttributeSet)
    {
        return nullptr;
...
float USuspenseEquipmentAttributeComponent::GetAttributeValueFromProperty(UAttributeSet* AttributeSet, FProperty* Property) const
{
...
void USuspenseEquipmentAttributeComponent::SetAttributeValueToProperty(UAttributeSet* AttributeSet, FProperty* Property, float Value)
{
    if (!AttributeSet || !Property)
    {
        return;
...
FGameplayAttribute USuspenseEquipmentAttributeComponent::GetGameplayAttributeFromProperty(UAttributeSet* AttributeSet, FProperty* Property) const
{
    if (!AttributeSet || !Property)
    {
