...
USuspenseEquipmentComponentBase::USuspenseEquipmentComponentBase()
{
...
void USuspenseEquipmentComponentBase::BeginPlay()
{
    Super::BeginPlay();
    ...
    if (!GetOwner()->HasAuthority() && GetWorld())
    {
        GetWorld()->GetTimerManager().SetTimer(
            *new FTimerHandle(),
            this,
            &USuspenseEquipmentComponentBase::CleanupExpiredPredictions,
            1.0f,
            true
        );
    }
...
void USuspenseEquipmentComponentBase::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void USuspenseEquipmentComponentBase::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
    Super::GetLifetimeReplicatedProps(OutLifetimeProps);

    DOREPLIFETIME(USuspenseEquipmentComponentBase, bIsInitialized);
    DOREPLIFETIME(USuspenseEquipmentComponentBase, EquippedItemInstance);
    DOREPLIFETIME(USuspenseEquipmentComponentBase, ComponentVersion);
    DOREPLIFETIME(USuspenseEquipmentComponentBase, EquipmentCycleCounter);
}

void USuspenseEquipmentComponentBase::Initialize(AActor* InOwner, UAbilitySystemComponent* InASC)
{
    if (!InOwner || !InASC)
    {
...
void USuspenseEquipmentComponentBase::InitializeWithItemInstance(AActor* InOwner, UAbilitySystemComponent* InASC, const FSuspenseInventoryItemInstance& ItemInstance)
{
...
void USuspenseEquipmentComponentBase::Cleanup()
{
    if (!bIsInitialized)
    {
        return;
...
void USuspenseEquipmentComponentBase::UpdateEquippedItem(const FSuspenseInventoryItemInstance& NewItemInstance)
{
    if (!bIsInitialized)
    {
...
void USuspenseEquipmentComponentBase::SetEquippedItemInstance(const FSuspenseInventoryItemInstance& ItemInstance)
{
    FSuspenseInventoryItemInstance OldItem = EquippedItemInstance;
...
int32 USuspenseEquipmentComponentBase::StartClientPrediction(const FSuspenseInventoryItemInstance& PredictedInstance)
{
...
void USuspenseEquipmentComponentBase::ConfirmClientPrediction(int32 PredictionKey, bool bSuccess, const FSuspenseInventoryItemInstance& ActualInstance)
{
    // Find prediction
...
void USuspenseEquipmentComponentBase::CleanupExpiredPredictions()
{
    if (!GetWorld())
    {
        return;
...
USuspenseItemManager* USuspenseEquipmentComponentBase::GetItemManager() const
{
    FScopeLock Lock(&CacheCriticalSection);
...
USuspenseEventManager* USuspenseEquipmentComponentBase::GetDelegateManager() const
{
    FScopeLock Lock(&CacheCriticalSection);
...
bool USuspenseEquipmentComponentBase::GetEquippedItemData(FSuspenseUnifiedItemData& OutItemData) const
{
...
float USuspenseEquipmentComponentBase::GetEquippedItemProperty(const FName& PropertyName, float DefaultValue) const
{
    if (!EquippedItemInstance.IsValid())
    {
        return DefaultValue;
...
void USuspenseEquipmentComponentBase::SetEquippedItemProperty(const FName& PropertyName, float Value)
{
    if (!EquippedItemInstance.IsValid())
    {
...
void USuspenseEquipmentComponentBase::InitializeCoreReferences()
{
...
bool USuspenseEquipmentComponentBase::ValidateSystemReferences() const
{
    bool bValid = true;
...
bool USuspenseEquipmentComponentBase::ValidateDelegateManager() const
{
    USuspenseEventManager* Manager = GetDelegateManager();
    return IsValid(Manager);
}

void USuspenseEquipmentComponentBase::OnEquipmentInitialized()
{
    // Base implementation - override in derived classes
}

void USuspenseEquipmentComponentBase::OnEquippedItemChanged(const FSuspenseInventoryItemInstance& OldItem, const FSuspenseInventoryItemInstance& NewItem)
{
    // Base implementation - override in derived classes
...
bool USuspenseEquipmentComponentBase::ExecuteOnServer(const FString& FuncName, TFunction<void()> ServerCode)
{
...
void USuspenseEquipmentComponentBase::LogEventBroadcast(const FString& EventName, bool bSuccess) const
{
...
void USuspenseEquipmentComponentBase::OnRep_EquippedItemInstance(const FSuspenseInventoryItemInstance& OldInstance)
{
...
void USuspenseEquipmentComponentBase::OnRep_ComponentState()
{
...
void USuspenseEquipmentComponentBase::BroadcastItemEquipped(const FSuspenseInventoryItemInstance& ItemInstance, const FGameplayTag& SlotType)
{
...
void USuspenseEquipmentComponentBase::BroadcastItemUnequipped(const FSuspenseInventoryItemInstance& ItemInstance, const FGameplayTag& SlotType)
{
    if (!ValidateDelegateManager())
    {
...
void USuspenseEquipmentComponentBase::BroadcastEquipmentPropertyChanged(const FName& PropertyName, float OldValue, float NewValue)
{
    if (!ValidateDelegateManager())
    {
...
void USuspenseEquipmentComponentBase::BroadcastEquipmentStateChanged(const FGameplayTag& OldState, const FGameplayTag& NewState, bool bInterrupted)
{
    if (!ValidateDelegateManager())
    {
...
void USuspenseEquipmentComponentBase::BroadcastEquipmentEvent(const FGameplayTag& EventTag, const FString& EventData)
{
    if (!ValidateDelegateManager())
    {
...
void USuspenseEquipmentComponentBase::BroadcastEquipmentUpdated()
{
    if (!ValidateDelegateManager())
    {
...
void USuspenseEquipmentComponentBase::BroadcastAmmoChanged(float CurrentAmmo, float RemainingAmmo, float MagazineSize)
{
    if (!ValidateDelegateManager())
    {
...
void USuspenseEquipmentComponentBase::BroadcastWeaponFired(const FVector& Origin, const FVector& Impact, bool bSuccess, const FGameplayTag& FireMode)
{
    if (!ValidateDelegateManager())
    {
...
void USuspenseEquipmentComponentBase::BroadcastFireModeChanged(const FGameplayTag& NewFireMode, const FText& FireModeDisplayName)
{
    if (!ValidateDelegateManager())
    {
...
void USuspenseEquipmentComponentBase::BroadcastWeaponReload(bool bStarted, float ReloadDuration)
{
    if (!ValidateDelegateManager())
    {
...
void USuspenseEquipmentComponentBase::BroadcastWeaponSpreadUpdated(float NewSpread, float MaxSpread)
{
    if (!ValidateDelegateManager())
    {
...
void USuspenseEquipmentComponentBase::InitializeAbilityProvider_Implementation(UAbilitySystemComponent* InASC)
{
    CachedASC = InASC;
    EQUIPMENT_LOG(Log, TEXT("Ability provider initialized"));
}

FGameplayAbilitySpecHandle USuspenseEquipmentComponentBase::GrantAbility_Implementation(TSubclassOf<UGameplayAbility> AbilityClass, int32 Level, int32 InputID)
{
...
void USuspenseEquipmentComponentBase::RemoveAbility_Implementation(FGameplayAbilitySpecHandle AbilityHandle)
{
...
FActiveGameplayEffectHandle USuspenseEquipmentComponentBase::ApplyEffectToSelf_Implementation(TSubclassOf<UGameplayEffect> EffectClass, float Level)
{
...
void USuspenseEquipmentComponentBase::RemoveEffect_Implementation(FActiveGameplayEffectHandle EffectHandle)
{
