...
void USuspenseWeaponFireModeComponent::BeginPlay()
{
    Super::BeginPlay();
...
void USuspenseWeaponFireModeComponent::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
    Super::GetLifetimeReplicatedProps(OutLifetimeProps);
    
    // Only replicate the current index - everything else comes from DataTable
    DOREPLIFETIME(USuspenseWeaponFireModeComponent, CurrentFireModeIndex);
}

void USuspenseWeaponFireModeComponent::Cleanup()
{
...
bool USuspenseWeaponFireModeComponent::InitializeFromWeapon(TScriptInterface<ISuspenseWeapon> WeaponInterface)
{
    if (!WeaponInterface)
    {
...
bool USuspenseWeaponFireModeComponent::InitializeFromWeaponData_Implementation(const FSuspenseUnifiedItemData& WeaponData)
{
...
void USuspenseWeaponFireModeComponent::ClearFireModes_Implementation()
{
    RemoveFireModeAbilities();
    FireModes.Empty();
    BlockedFireModes.Empty();
...
bool USuspenseWeaponFireModeComponent::CycleToNextFireMode_Implementation()
{
    if (FireModes.Num() <= 1)
    {
        return false;
...
bool USuspenseWeaponFireModeComponent::CycleToPreviousFireMode_Implementation()
{
    if (FireModes.Num() <= 1)
    {
        return false;
...
bool USuspenseWeaponFireModeComponent::SetFireMode_Implementation(const FGameplayTag& FireModeTag)
{
...
bool USuspenseWeaponFireModeComponent::SetFireModeByIndex_Implementation(int32 Index)
{
    // Validate index
...
FGameplayTag USuspenseWeaponFireModeComponent::GetCurrentFireMode_Implementation() const
{
    if (FireModes.IsValidIndex(CurrentFireModeIndex))
    {
...
FFireModeRuntimeData USuspenseWeaponFireModeComponent::GetCurrentFireModeData_Implementation() const
{
    if (FireModes.IsValidIndex(CurrentFireModeIndex))
    {
...
bool USuspenseWeaponFireModeComponent::IsFireModeAvailable_Implementation(const FGameplayTag& FireModeTag) const
{
    int32 Index = FindFireModeIndex(FireModeTag);
    if (Index == INDEX_NONE)
    {
...
TArray<FFireModeRuntimeData> USuspenseWeaponFireModeComponent::GetAllFireModes_Implementation() const
{
    return FireModes;
}

TArray<FGameplayTag> USuspenseWeaponFireModeComponent::GetAvailableFireModes_Implementation() const
{
...
int32 USuspenseWeaponFireModeComponent::GetAvailableFireModeCount_Implementation() const
{
    int32 Count = 0;
...
bool USuspenseWeaponFireModeComponent::SetFireModeEnabled_Implementation(const FGameplayTag& FireModeTag, bool bEnabled)
{
    int32 Index = FindFireModeIndex(FireModeTag);
    if (Index == INDEX_NONE)
    {
...
void USuspenseWeaponFireModeComponent::SetFireModeBlocked_Implementation(const FGameplayTag& FireModeTag, bool bBlocked)
{
    if (bBlocked)
    {
...
bool USuspenseWeaponFireModeComponent::IsFireModeBlocked_Implementation(const FGameplayTag& FireModeTag) const
{
    return BlockedFireModes.Contains(FireModeTag);
}

bool USuspenseWeaponFireModeComponent::GetFireModeData_Implementation(const FGameplayTag& FireModeTag, FFireModeRuntimeData& OutData) const
{
    int32 Index = FindFireModeIndex(FireModeTag);
    if (Index == INDEX_NONE)
    {
...
TSubclassOf<UGameplayAbility> USuspenseWeaponFireModeComponent::GetFireModeAbility_Implementation(const FGameplayTag& FireModeTag) const
{
    int32 Index = FindFireModeIndex(FireModeTag);
    if (Index != INDEX_NONE)
    {
...
int32 USuspenseWeaponFireModeComponent::GetFireModeInputID_Implementation(const FGameplayTag& FireModeTag) const
{
    int32 Index = FindFireModeIndex(FireModeTag);
    if (Index != INDEX_NONE)
    {
...
USuspenseEventManager* USuspenseWeaponFireModeComponent::GetDelegateManager() const
{
    return Super::GetDelegateManager();
}

ISuspenseWeapon* USuspenseWeaponFireModeComponent::GetWeaponInterface() const
{
...
bool USuspenseWeaponFireModeComponent::GetWeaponData(FSuspenseUnifiedItemData& OutData) const
{
...
void USuspenseWeaponFireModeComponent::LoadFireModesFromData(const FSuspenseUnifiedItemData& WeaponData)
{
    FireModes.Empty();
...
void USuspenseWeaponFireModeComponent::GrantFireModeAbilities()
{
    if (!CachedASC)
    {
...
void USuspenseWeaponFireModeComponent::RemoveFireModeAbilities()
{
    if (!CachedASC)
    {
        return;
...
int32 USuspenseWeaponFireModeComponent::FindFireModeIndex(const FGameplayTag& FireModeTag) const
{
    for (int32 i = 0; i < FireModes.Num(); ++i)
    {
...
void USuspenseWeaponFireModeComponent::BroadcastFireModeChanged()
{
    if (!FireModes.IsValidIndex(CurrentFireModeIndex))
    {
        return;
...
void USuspenseWeaponFireModeComponent::OnRep_CurrentFireModeIndex()
{
