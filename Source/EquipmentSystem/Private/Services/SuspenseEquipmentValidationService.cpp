...
void USuspenseEquipmentValidationService::EnsureValidConfig()
{
    // Sanitize CacheTTL
...
bool USuspenseEquipmentValidationService::InitializeService(const FServiceInitParams& Params)
{
    ...
    if (!InitializeDependencies())
    {
        ...
        UE_LOG(LogSuspenseEquipmentValidation, Error, TEXT("InitializeService: Failed to initialize dependencies"));
        ServiceMetrics.RecordError();
        return false;
    }
    ...
    {
        ServiceState = EServiceLifecycleState::Failed;
        UE_LOG(LogSuspenseEquipmentValidation, Error, TEXT("InitializeService: Failed to create rules coordinator"));
        ServiceMetrics.RecordError();
        return false;
    }
    ...
    {
        ServiceState = EServiceLifecycleState::Failed;
        UE_LOG(LogSuspenseEquipmentValidation, Error, TEXT("InitializeService: Failed to initialize rules coordinator"));
        ServiceMetrics.RecordError();
        return false;
    }
...
bool USuspenseEquipmentValidationService::ShutdownService(bool bForce)
{
...
FGameplayTag USuspenseEquipmentValidationService::GetServiceTag() const
{
...
FGameplayTagContainer USuspenseEquipmentValidationService::GetRequiredDependencies() const
{
...
bool USuspenseEquipmentValidationService::ValidateService(TArray<FText>& OutErrors) const
{
...
void USuspenseEquipmentValidationService::ResetService()
{
...
FString USuspenseEquipmentValidationService::GetServiceStats() const
{
...
ISuspenseEquipmentRules* USuspenseEquipmentValidationService::GetRulesEngine()
{
...
void USuspenseEquipmentValidationService::ClearValidationCache()
{
    ...
    UE_LOG(LogSuspenseEquipmentValidation, Verbose, TEXT("Validation cache cleared"));
}
...
FSlotValidationResult USuspenseEquipmentValidationService::ValidateEquipmentOperation(const FEquipmentOperationRequest& Request)
{
    SCOPED_SERVICE_TIMER("Validation.ValidateEquipmentOperation");
    return ValidateSingleRequest(Request, true);
}

FSlotValidationResult USuspenseEquipmentValidationService::ValidateSingleRequest(
...
FSlotValidationResult USuspenseEquipmentValidationService::ValidateSingleRequestParallel(
    const FEquipmentOperationRequest& Request)
{
...
FSlotValidationResult USuspenseEquipmentValidationService::ValidateInTransaction(
    const FEquipmentOperationRequest& Request,
...
FSlotValidationBatchResult USuspenseEquipmentValidationService::BatchValidateEx(
...
TArray<FSlotValidationResult> USuspenseEquipmentValidationService::BatchValidate(
...
FBatchValidationReport USuspenseEquipmentValidationService::BatchValidateWithReport(
    const TArray<FEquipmentOperationRequest>& Requests,
    bool bAtomic)
{
...
TArray<FSlotValidationResult> USuspenseEquipmentValidationService::ProcessParallelBatch(
    const TArray<FEquipmentOperationRequest>& Requests)
{
...
TArray<FSlotValidationResult> USuspenseEquipmentValidationService::ProcessSequentialBatch(
    const TArray<FEquipmentOperationRequest>& Requests,
    bool bStopOnFailure)
{
...
FBatchValidationReport USuspenseEquipmentValidationService::ProcessBatchWithShadowSnapshot(
    const TArray<FEquipmentOperationRequest>& Requests)
{
...
FSlotValidationResult USuspenseEquipmentValidationService::ValidateAgainstShadowSnapshot(
    const FEquipmentOperationRequest& Request,
...
void USuspenseEquipmentValidationService::DispatchBufferedEvents(const TArray<FBufferedValidationEvent>& Events)
{
    if (!IsInGameThread())
    {
...
void USuspenseEquipmentValidationService::ValidateAsync(
    const FEquipmentOperationRequest& Request,
...
bool USuspenseEquipmentValidationService::ExportMetricsToCSV(const FString& AbsoluteFilePath) const
{
...
void USuspenseEquipmentValidationService::OnRulesOrConfigChanged()
{
...
uint32 USuspenseEquipmentValidationService::GenerateCacheKey(const FEquipmentOperationRequest& Request) const
{
...
uint32 USuspenseEquipmentValidationService::GetStableActorIdentifier(AActor* Actor) const
{
    if (!Actor)
    {
        return 0u;
...
void USuspenseEquipmentValidationService::PublishValidationEvent(
...
EEquipmentValidationFailure USuspenseEquipmentValidationService::DetermineFailureType(const FRuleEvaluationResult& RuleResult) const
{
