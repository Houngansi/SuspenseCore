...
USuspenseSystemCoordinator::USuspenseSystemCoordinator()
{
...
bool USuspenseSystemCoordinator::ShouldCreateSubsystem(UObject* Outer) const
{
...
void USuspenseSystemCoordinator::Initialize(FSubsystemCollectionBase& Collection)
{
    ...
    PostWorldInitHandle = FWorldDelegates::OnPostWorldInitialization.AddUObject(
        this, &USuspenseSystemCoordinator::OnPostWorldInitialization);

    PostLoadMapHandle = FCoreUObjectDelegates::PostLoadMapWithWorld.AddUObject(
        this, &USuspenseSystemCoordinator::OnPostLoadMapWithWorld);
...
void USuspenseSystemCoordinator::Deinitialize()
{
...
void USuspenseSystemCoordinator::OnPostWorldInitialization(UWorld* World, const UWorld::InitializationValues IVS)
{
    check(IsInGameThread());
...
void USuspenseSystemCoordinator::OnPostLoadMapWithWorld(UWorld* LoadedWorld)
{
    check(IsInGameThread());
...
void USuspenseSystemCoordinator::EnsureServicesRegistered(UWorld* ForWorld)
{
    check(IsInGameThread());
...
void USuspenseSystemCoordinator::RebindAllWorldBindableServices(UWorld* ForWorld)
{
    check(IsInGameThread());
...
void USuspenseSystemCoordinator::ValidateAndLog()
{
    check(IsInGameThread());
    bServicesReady = false;
...
UWorld* USuspenseSystemCoordinator::TryGetCurrentWorldSafe() const
{
...
void USuspenseSystemCoordinator::ForceRebindWorld(UWorld* World)
{
    if (!World)
    {
...
void USuspenseSystemCoordinator::DebugDumpServicesState()
{
...
void USuspenseSystemCoordinator::DebugForceRebind()
{
