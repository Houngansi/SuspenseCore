...
FSlotValidationResult USuspenseCoreEquipmentOperationExecutor::ValidateEquip(
    const FEquipmentOperationRequest& Request) const
{
...
FSlotValidationResult USuspenseCoreEquipmentOperationExecutor::ValidateUnequip(
    const FEquipmentOperationRequest& Request) const
{
...
FSlotValidationResult USuspenseCoreEquipmentOperationExecutor::ValidateSwap(
    const FEquipmentOperationRequest& Request) const
{
    if (!DataProvider.GetInterface())
    {
...
FSlotValidationResult USuspenseCoreEquipmentOperationExecutor::ValidateQuickSwitch(
    const FEquipmentOperationRequest& Request) const
{
    if (!DataProvider.GetInterface())
    {
...
FEquipmentOperationResult USuspenseCoreEquipmentOperationExecutor::UnequipItem(int32 SlotIndex)
{
    FEquipmentOperationRequest Request;
...
FEquipmentOperationResult USuspenseCoreEquipmentOperationExecutor::SwapItems(
    int32 SlotIndexA,
    int32 SlotIndexB)
{
    FEquipmentOperationRequest Request;
...
FEquipmentOperationResult USuspenseCoreEquipmentOperationExecutor::MoveItem(
    int32 SourceSlot,
    int32 TargetSlot)
{
    FEquipmentOperationRequest Request;
...
FEquipmentOperationResult USuspenseCoreEquipmentOperationExecutor::DropItem(int32 SlotIndex)
{
    FEquipmentOperationRequest Request;
...
FEquipmentOperationResult USuspenseCoreEquipmentOperationExecutor::QuickSwitchWeapon()
{
    FEquipmentOperationRequest Request;
...
TArray<FEquipmentOperationResult> USuspenseCoreEquipmentOperationExecutor::GetOperationHistory(
...
bool USuspenseCoreEquipmentOperationExecutor::CanUndoLastOperation() const
{
    // Undo is now managed by the service/transaction layer
    return false;
}

FEquipmentOperationResult USuspenseCoreEquipmentOperationExecutor::UndoLastOperation()
{
    // Undo is now managed by the service/transaction layer
    return FEquipmentOperationResult::CreateFailure(
        FGuid::NewGuid(),
...
bool USuspenseCoreEquipmentOperationExecutor::IsInitialized() const
{
...
FString USuspenseCoreEquipmentOperationExecutor::GetStatistics() const
{
...
FGuid USuspenseCoreEquipmentOperationExecutor::GenerateOperationId() const
{
...
bool USuspenseCoreEquipmentOperationExecutor::IsWeaponSlot(int32 SlotIndex) const
{
...
int32 USuspenseCoreEquipmentOperationExecutor::GetCurrentActiveWeaponSlot() const
{
    if (!DataProvider.GetInterface())
    {
        return INDEX_NONE;
...
int32 USuspenseCoreEquipmentOperationExecutor::FindNextWeaponSlot(int32 CurrentSlot) const
{
    if (!DataProvider.GetInterface())
    {
        return INDEX_NONE;
...
bool USuspenseCoreEquipmentOperationExecutor::IsFirearmSlot(int32 SlotIndex) const
{
    if (!DataProvider.GetInterface() || !DataProvider->IsValidSlotIndex(SlotIndex))
    {
        return false;
...
bool USuspenseCoreEquipmentOperationExecutor::IsMeleeWeaponSlot(int32 SlotIndex) const
{
    if (!DataProvider.GetInterface() || !DataProvider->IsValidSlotIndex(SlotIndex))
    {
        return false;
