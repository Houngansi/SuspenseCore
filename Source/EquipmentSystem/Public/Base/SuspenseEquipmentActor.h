...
#include "SuspenseEquipmentActor.generated.h"

class UAbilitySystemComponent;
class UAttributeSet;
class USuspenseEquipmentMeshComponent;
class USuspenseEquipmentAttributeComponent;
class USuspenseEquipmentAttachmentComponent;
...
class EQUIPMENTSYSTEM_API ASuspenseEquipmentActor : public AActor, public ISuspenseEquipment
{
    GENERATED_BODY()

public:
    ASuspenseEquipmentActor();
...
protected:
    ...
    USuspenseEquipmentMeshComponent*        MeshComponent;

    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="SuspenseCore|Equipment|Components")
    USuspenseEquipmentAttributeComponent*   AttributeComponent;

    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="SuspenseCore|Equipment|Components")
    USuspenseEquipmentAttachmentComponent*  AttachmentComponent;
