...
class USuspenseWeaponAmmoComponent;
class USuspenseWeaponFireModeComponent;
 ...
 */
UCLASS()
class EQUIPMENTSYSTEM_API ASuspenseWeaponActor : public ASuspenseEquipmentActor,
...
public:
    ...
    //================================================
    // ASuspenseEquipmentActor overrides (S3/S4 pipeline)
    //================================================
...
protected:
    ...
    USuspenseWeaponAmmoComponent* AmmoComponent;

    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="Components", meta=(AllowPrivateAccess="true"))
    USuspenseWeaponFireModeComponent* FireModeComponent;
