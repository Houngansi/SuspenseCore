...
#include "SuspenseEquipmentDataStore.generated.h"
...
class EQUIPMENTSYSTEM_API USuspenseEquipmentDataStore : public UActorComponent, public ISuspenseEquipmentDataProvider
{
    GENERATED_BODY()

public:
    USuspenseEquipmentDataStore();
    virtual ~USuspenseEquipmentDataStore();
