...
#include "SuspenseWeaponStateManager.generated.h"
...
class EQUIPMENTSYSTEM_API USuspenseWeaponStateManager : public UActorComponent, public ISuspenseWeaponStateProvider
{
    GENERATED_BODY()

public:
    USuspenseWeaponStateManager();
