// SuspenseEquipmentNetworkDispatcher.h
...
class EQUIPMENTSYSTEM_API USuspenseEquipmentNetworkDispatcher
...
public:
	...
	void SetOperationExecutor(TScriptInterface<ISuspenseEquipmentOperations> InExecutor);
	UFUNCTION(BlueprintCallable, Category="SuspenseCore|Equipment|Network")
