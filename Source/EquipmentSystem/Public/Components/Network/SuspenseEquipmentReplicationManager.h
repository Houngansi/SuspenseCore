...
struct FReplicatedSlotArray : public FFastArraySerializer
{
    ...
    UPROPERTY(NotReplicated) class USuspenseEquipmentReplicationManager* OwnerManager=nullptr;
...
class EQUIPMENTSYSTEM_API USuspenseEquipmentReplicationManager : public UActorComponent, public ISuspenseReplicationProvider
{
    GENERATED_BODY()
public:
