...
#include "SuspenseEquipmentAttachmentSystem.generated.h"
...
class EQUIPMENTSYSTEM_API USuspenseEquipmentAttachmentSystem : public UActorComponent, public ISuspenseAttachmentProvider
{
	GENERATED_BODY()

public:
	USuspenseEquipmentAttachmentSystem();
