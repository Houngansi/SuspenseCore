...
class EQUIPMENTSYSTEM_API USuspenseEquipmentVisualController : public UActorComponent, public ISuspenseVisualProvider
{
	GENERATED_BODY()

public:
	USuspenseEquipmentVisualController();
	...
	UFUNCTION(BlueprintCallable, Category="SuspenseCore|Equipment|Visual|Debug")
