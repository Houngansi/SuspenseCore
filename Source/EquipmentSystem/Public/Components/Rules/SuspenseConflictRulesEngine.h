...
class EQUIPMENTSYSTEM_API USuspenseConflictRulesEngine : public UObject
{
    GENERATED_BODY()
...
public:
    ...
    bool Initialize(TScriptInterface<class ISuspenseEquipmentDataProvider> InDataProvider);
