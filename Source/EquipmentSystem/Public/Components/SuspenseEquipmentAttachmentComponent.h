...
class USuspenseWeaponStanceComponent;
...
class EQUIPMENTSYSTEM_API USuspenseEquipmentAttachmentComponent : public USuspenseEquipmentComponentBase
{
    GENERATED_BODY()

public:
    USuspenseEquipmentAttachmentComponent();
