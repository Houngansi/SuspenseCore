...
class EQUIPMENTSYSTEM_API USuspenseWeaponAmmoComponent : public USuspenseEquipmentComponentBase
{
    GENERATED_BODY()

public:
    USuspenseWeaponAmmoComponent();
    ...
    void LinkAttributeComponent(class USuspenseEquipmentAttributeComponent* AttributeComponent);
...
private:
    ...
    UPROPERTY()
    class USuspenseEquipmentAttributeComponent* LinkedAttributeComponent;
