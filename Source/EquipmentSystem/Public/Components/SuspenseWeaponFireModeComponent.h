...
#include "SuspenseWeaponFireModeComponent.generated.h"

// Forward declarations
class UGameplayAbility;
class ISuspenseWeapon;
struct FSuspenseUnifiedItemData;
struct FSuspenseWeaponFireModeData;
...
class EQUIPMENTSYSTEM_API USuspenseWeaponFireModeComponent : public USuspenseEquipmentComponentBase, public ISuspenseFireModeProvider
{
    GENERATED_BODY()

public:
    USuspenseWeaponFireModeComponent();
