// SuspenseEquipmentTransactionProcessor.h
...
class EQUIPMENTSYSTEM_API USuspenseEquipmentTransactionProcessor : public UActorComponent, public ISuspenseTransactionManager
{
    GENERATED_BODY()

public:
    USuspenseEquipmentTransactionProcessor();
    virtual ~USuspenseEquipmentTransactionProcessor();
