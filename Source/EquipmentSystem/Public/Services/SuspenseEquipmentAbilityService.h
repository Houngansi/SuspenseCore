...
#include "SuspenseEquipmentAbilityService.generated.h"

// Forward declarations
class USuspenseEquipmentAbilityConnector;
...
public:
    USuspenseEquipmentAbilityService();
    virtual ~USuspenseEquipmentAbilityService();
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Equipment|Abilities")
    USuspenseEquipmentAbilityConnector* GetOrCreateConnectorForEquipment(
...
protected:
    ...
    USuspenseEquipmentAbilityConnector* CreateConnectorForEquipment(
        AActor* EquipmentActor,
        AActor* OwnerActor
    );
...
private:
    ...
    //========================================
    UPROPERTY()
    TMap<TWeakObjectPtr<AActor>, USuspenseEquipmentAbilityConnector*> EquipmentConnectors;
