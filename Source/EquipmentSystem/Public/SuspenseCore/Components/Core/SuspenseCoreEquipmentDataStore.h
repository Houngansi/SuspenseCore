...
public:
    ...
    // Events
    virtual FOnSuspenseCoreSlotDataChanged& OnSlotDataChanged() override { return OnSlotDataChangedDelegate; }
    virtual FOnSuspenseCoreSlotConfigurationChanged& OnSlotConfigurationChanged() override { return OnSlotConfigurationChangedDelegate; }
    virtual FOnSuspenseCoreDataStoreReset& OnDataStoreReset() override { return OnDataStoreResetDelegate; }
...
private:
    ...
    FOnSuspenseCoreSlotDataChanged OnSlotDataChangedDelegate;

    /** Delegate fired when slot configuration changes */
    FOnSuspenseCoreSlotConfigurationChanged OnSlotConfigurationChangedDelegate;

    /** Delegate fired when data store is reset */
    FOnSuspenseCoreDataStoreReset OnDataStoreResetDelegate;
