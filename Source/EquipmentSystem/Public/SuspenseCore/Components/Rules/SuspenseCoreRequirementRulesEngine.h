// SuspenseCoreRequirementRulesEngine.h
...
#include "SuspenseCoreRequirementRulesEngine.generated.h"

/**
 * Comparison operators for requirement checks.
 */
UENUM(BlueprintType)
enum class ESuspenseCoreComparisonOp : uint8
{
...
struct FSuspenseCoreAttributeRequirement
{
    GENERATED_BODY()
    ...
    /** Comparison operator */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Requirement")
    ESuspenseCoreComparisonOp ComparisonOp = ESuspenseCoreComparisonOp::GreaterOrEqual;
 ...
 */
USTRUCT(BlueprintType)
struct FSuspenseCoreItemRequirements
{
    GENERATED_BODY()
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Requirements")
    TArray<FSuspenseCoreAttributeRequirement> AttributeRequirements;
...
class EQUIPMENTSYSTEM_API USuspenseCoreRequirementRulesEngine : public UObject
{
    GENERATED_BODY()
public:
    USuspenseCoreRequirementRulesEngine();
...
protected:
    ...
    /** Numeric comparer. */
    bool CompareValues(float Value1, float Value2, ESuspenseCoreComparisonOp Op) const;
