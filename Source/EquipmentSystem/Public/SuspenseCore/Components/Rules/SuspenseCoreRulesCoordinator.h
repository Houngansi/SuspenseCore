// SuspenseCoreRulesCoordinator.h
...
class USuspenseCoreRequirementRulesEngine;
class USuspenseCoreConflictRulesEngine;
class USuspenseCoreCompatibilityRulesEngine;
...
class EQUIPMENTSYSTEM_API USuspenseCoreRulesCoordinator : public UObject, public ISuspenseCoreEquipmentRules
{
    GENERATED_BODY()

public:
    USuspenseCoreRulesCoordinator();

    //========================================
    // ISuspenseCoreEquipmentRules Implementation
    //========================================
...
private:
    ...
    UPROPERTY()
    USuspenseCoreWeightRulesEngine* WeightEngine = nullptr;

    UPROPERTY()
    USuspenseCoreRequirementRulesEngine* RequirementEngine = nullptr;

    UPROPERTY()
    USuspenseCoreConflictRulesEngine* ConflictEngine = nullptr;

    UPROPERTY()
    USuspenseCoreCompatibilityRulesEngine* CompatibilityEngine = nullptr;
    ...
    UPROPERTY()
    TArray<FSuspenseCoreEquipmentRule> GlobalRules;
