...
/**
 * SuspenseCore Equipment Attachment Component - handles equipment attachment to characters
 *
 * ARCHITECTURE:
 ...
 * - Full client prediction support
 */
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SuspenseCore|Equipment|Animation")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SuspenseCore|Equipment|Stance")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SuspenseCore|Equipment|Attachment|Prediction")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SuspenseCore|Equipment|Attachment|Sockets")
...
private:
	...
	UPROPERTY(EditDefaultsOnly, Category = "SuspenseCore|Equipment|Stance")
