...
/**
 * SuspenseCore Equipment Attribute Component - manages equipment attributes through GAS
 *
 * ARCHITECTURE:
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SuspenseCore|Equipment|Attributes|Prediction")
