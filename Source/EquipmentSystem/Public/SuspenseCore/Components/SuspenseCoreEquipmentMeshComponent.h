...
/**
 * SuspenseCore Equipment Mesh Component for visual representation
 *
 * ARCHITECTURE:
 * - Manages visual representation of equipment
 ...
 * - Full integration with DataTable architecture
 */
UCLASS(ClassGroup=(SuspenseCore), meta=(BlueprintSpawnableComponent))
class EQUIPMENTSYSTEM_API USuspenseCoreEquipmentMeshComponent : public USuspenseCoreEquipmentComponentBase
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SuspenseCore|Equipment|Mesh")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SuspenseCore|Equipment|Weapon")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SuspenseCore|Equipment|Visual")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SuspenseCore|Equipment|Attachment")
	...
	/**
	 * Get the mesh component (if spawned)
	 * @return Mesh component or nullptr
	 */
	UFUNCTION(BlueprintCallable, Category = "SuspenseCore|Equipment|Mesh")
...
private:
	...
	/** Primary skeletal mesh component */
	UPROPERTY()
