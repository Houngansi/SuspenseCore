...
#include "Abilities/MedComCharacterCrouchAbility.h"
...
UMedComCharacterCrouchAbility::UMedComCharacterCrouchAbility()
{
...
bool UMedComCharacterCrouchAbility::CanActivateAbility(const FGameplayAbilitySpecHandle Handle, 
...
void UMedComCharacterCrouchAbility::ActivateAbility(const FGameplayAbilitySpecHandle Handle,
    ...
    const FGameplayEventData* TriggerEventData)
{
    ...
    if (WaitReleaseTask)
    {
        WaitReleaseTask->OnRelease.AddDynamic(this, &UMedComCharacterCrouchAbility::OnCrouchInputReleased);
...
void UMedComCharacterCrouchAbility::EndAbility(const FGameplayAbilitySpecHandle Handle,
    const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo,
...
void UMedComCharacterCrouchAbility::InputReleased(const FGameplayAbilitySpecHandle Handle,
    const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo)
{
...
void UMedComCharacterCrouchAbility::OnCrouchInputReleased(float TimeHeld)
{
...
void UMedComCharacterCrouchAbility::InputPressed(const FGameplayAbilitySpecHandle Handle,
    const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo)
{
