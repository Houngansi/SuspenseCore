...
#include "Abilities/MedComWeaponSwitchAbility.h"
...
UMedComWeaponSwitchAbility::UMedComWeaponSwitchAbility()
{
...
bool UMedComWeaponSwitchAbility::CanActivateAbility(
...
void UMedComWeaponSwitchAbility::ActivateAbility(
    const FGameplayAbilitySpecHandle Handle,
    const FGameplayAbilityActorInfo* ActorInfo,
...
void UMedComWeaponSwitchAbility::EndAbility(
    const FGameplayAbilitySpecHandle Handle,
    const FGameplayAbilityActorInfo* ActorInfo,
    const FGameplayAbilityActivationInfo ActivationInfo,
...
EWeaponSwitchMode UMedComWeaponSwitchAbility::DetermineSwitchMode(const FGameplayEventData* TriggerEventData) const
{
...
int32 UMedComWeaponSwitchAbility::GetTargetSlot(EWeaponSwitchMode Mode, int32 InputSlot) const
{
    switch (Mode)
    {
...
void UMedComWeaponSwitchAbility::PerformWeaponSwitch(int32 TargetSlot)
{
    if (!CachedEquipmentInterface.GetInterface())
    {
...
void UMedComWeaponSwitchAbility::PlayHolsterAnimation()
{
...
void UMedComWeaponSwitchAbility::PlayDrawAnimation()
{
    if (!CurrentActorInfo || !CurrentActorInfo->AvatarActor.IsValid())
    {
...
void UMedComWeaponSwitchAbility::OnHolsterAnimationComplete()
{
...
void UMedComWeaponSwitchAbility::OnDrawAnimationComplete()
{
...
void UMedComWeaponSwitchAbility::ServerRequestWeaponSwitch_Implementation(int32 TargetSlot, int32 PredictionKey)
{
    if (!CurrentActorInfo)
    {
        return;
...
void UMedComWeaponSwitchAbility::ClientConfirmWeaponSwitch_Implementation(int32 NewActiveSlot, bool bSuccess, int32 PredictionKey)
{
...
TScriptInterface<IMedComEquipmentInterface> UMedComWeaponSwitchAbility::FindEquipmentInterface() const
{
...
TArray<int32> UMedComWeaponSwitchAbility::GetWeaponSlotIndices() const
{
    if (CachedEquipmentInterface.GetInterface())
    {
...
int32 UMedComWeaponSwitchAbility::GetActiveWeaponSlot() const
{
    if (CachedEquipmentInterface.GetInterface())
    {
...
int32 UMedComWeaponSwitchAbility::GetNextWeaponSlot(int32 CurrentSlot) const
{
    TArray<int32> WeaponSlots = GetWeaponSlotIndices();
    if (WeaponSlots.Num() == 0)
    {
...
int32 UMedComWeaponSwitchAbility::GetPreviousWeaponSlot(int32 CurrentSlot) const
{
    TArray<int32> WeaponSlots = GetWeaponSlotIndices();
    if (WeaponSlots.Num() == 0)
    {
...
bool UMedComWeaponSwitchAbility::IsWeaponSlot(int32 SlotIndex) const
{
    if (CachedEquipmentInterface.GetInterface())
    {
...
UEventDelegateManager* UMedComWeaponSwitchAbility::GetDelegateManager() const
{
    if (CurrentActorInfo && CurrentActorInfo->AvatarActor.IsValid())
    {
...
void UMedComWeaponSwitchAbility::SendWeaponSwitchEvent(bool bStarted, int32 FromSlot, int32 ToSlot) const
{
...
bool UMedComWeaponSwitchAbility::CanSwitchWeapons() const
{
    // Find equipment interface
...
void UMedComWeaponSwitchAbility::ApplySwitchTags(bool bApply)
{
    if (!CurrentActorInfo || !CurrentActorInfo->AbilitySystemComponent.IsValid())
    {
        return;
...
void UMedComWeaponSwitchAbility::LogSwitchDebug(const FString& Message, bool bError) const
{
