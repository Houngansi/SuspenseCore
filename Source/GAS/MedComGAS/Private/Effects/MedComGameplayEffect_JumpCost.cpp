...
#include "Effects/MedComGameplayEffect_JumpCost.h"
#include "Attributes/MedComBaseAttributeSet.h"
#include "GameplayEffectComponents/AssetTagsGameplayEffectComponent.h"
#include "GameplayTagContainer.h"

UMedComGameplayEffect_JumpCost::UMedComGameplayEffect_JumpCost()
{
    ...
    // Настраиваем модификатор стамины
    {
        ...
        StaminaCost.Attribute = UMedComBaseAttributeSet::GetStaminaAttribute();
