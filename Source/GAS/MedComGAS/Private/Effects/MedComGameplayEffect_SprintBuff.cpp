...
#include "Effects/MedComGameplayEffect_SprintBuff.h"
#include "Attributes/MedComBaseAttributeSet.h"
#include "GameplayEffectComponents/TargetTagsGameplayEffectComponent.h"

UMedComGameplayEffect_SprintBuff::UMedComGameplayEffect_SprintBuff()
{
    ...
    UE_LOG(LogTemp, Log, TEXT("UMedComGameplayEffect_SprintBuff: Sprint buff created with 50%% speed increase (0.5 multiplier) and State.Sprinting tag"));
}