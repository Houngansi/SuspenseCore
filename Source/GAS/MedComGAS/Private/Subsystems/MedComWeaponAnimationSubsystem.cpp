...
UMedComWeaponAnimationSubsystem::UMedComWeaponAnimationSubsystem()
{
...
void UMedComWeaponAnimationSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
...
void UMedComWeaponAnimationSubsystem::Deinitialize()
{
...
bool UMedComWeaponAnimationSubsystem::ShouldCreateSubsystem(UObject* Outer) const
{
...
bool UMedComWeaponAnimationSubsystem::LoadAnimationDataTable(UDataTable* InDataTable)
{
    if (!InDataTable)
    {
...
const FAnimationStateData* UMedComWeaponAnimationSubsystem::GetAnimationStateDataPtr(const FGameplayTag& WeaponType) const
{
    if (!bIsInitialized)
    {
...
void UMedComWeaponAnimationSubsystem::PreloadAnimationDataBatch(const TArray<FGameplayTag>& WeaponTypes)
{
...
void UMedComWeaponAnimationSubsystem::GetCacheMetrics(float& OutHitRate, int32& OutMemoryUsageBytes, int32& OutCacheEntries) const
{
    FScopeLock Lock(&CacheCriticalSection);
    ...
    const_cast<UMedComWeaponAnimationSubsystem*>(this)->OnCacheMetricsUpdated.Broadcast(OutHitRate, OutCacheEntries);
}
...
bool UMedComWeaponAnimationSubsystem::GetAnimationStateData_Implementation(const FGameplayTag& WeaponType, FAnimationStateData& OutAnimationData) const
{
...
UAnimMontage* UMedComWeaponAnimationSubsystem::GetDrawMontage_Implementation(const FGameplayTag& WeaponType, bool bFirstDraw) const
{
...
UAnimMontage* UMedComWeaponAnimationSubsystem::GetHolsterMontage_Implementation(const FGameplayTag& WeaponType) const
{
    const FAnimationStateData* AnimData = GetAnimationStateDataPtr(WeaponType);
    return AnimData ? AnimData->Holster.Get() : nullptr;
}

UBlendSpace* UMedComWeaponAnimationSubsystem::GetStanceBlendSpace_Implementation(const FGameplayTag& WeaponType) const
{
    const FAnimationStateData* AnimData = GetAnimationStateDataPtr(WeaponType);
    return AnimData ? AnimData->Stance.Get() : nullptr;
}

UAnimSequence* UMedComWeaponAnimationSubsystem::GetIdleAnimation_Implementation(const FGameplayTag& WeaponType) const
{
    const FAnimationStateData* AnimData = GetAnimationStateDataPtr(WeaponType);
    return AnimData ? AnimData->Idle.Get() : nullptr;
}

UAnimMontage* UMedComWeaponAnimationSubsystem::GetSwitchMontage_Implementation(const FGameplayTag& FromWeaponType, const FGameplayTag& ToWeaponType) const
{
...
UAnimMontage* UMedComWeaponAnimationSubsystem::GetReloadMontage_Implementation(const FGameplayTag& WeaponType, bool bIsEmpty) const
{
    const FAnimationStateData* AnimData = GetAnimationStateDataPtr(WeaponType);
    if (AnimData)
    {
...
FTransform UMedComWeaponAnimationSubsystem::GetWeaponTransform_Implementation(const FGameplayTag& WeaponType) const
{
    const FAnimationStateData* AnimData = GetAnimationStateDataPtr(WeaponType);
    return AnimData ? AnimData->WTransform : FTransform::Identity;
}

FTransform UMedComWeaponAnimationSubsystem::GetLeftHandGripTransform_Implementation(const FGameplayTag& WeaponType, int32 GripIndex) const
{
    const FAnimationStateData* AnimData = GetAnimationStateDataPtr(WeaponType);
    if (AnimData)
    {
...
FTransform UMedComWeaponAnimationSubsystem::GetRightHandTransform_Implementation(const FGameplayTag& WeaponType) const
{
    const FAnimationStateData* AnimData = GetAnimationStateDataPtr(WeaponType);
    return AnimData ? AnimData->RHTransform : FTransform::Identity;
}

float UMedComWeaponAnimationSubsystem::GetDrawDuration_Implementation(const FGameplayTag& WeaponType, bool bFirstDraw) const
{
...
float UMedComWeaponAnimationSubsystem::GetHolsterDuration_Implementation(const FGameplayTag& WeaponType) const
{
...
float UMedComWeaponAnimationSubsystem::GetSwitchDuration_Implementation(const FGameplayTag& FromWeaponType, const FGameplayTag& ToWeaponType) const
{
...
float UMedComWeaponAnimationSubsystem::GetReloadDuration_Implementation(const FGameplayTag& WeaponType, bool bIsEmpty) const
{
...
bool UMedComWeaponAnimationSubsystem::HasAnimationData_Implementation(const FGameplayTag& WeaponType) const
{
    return GetAnimationStateDataPtr(WeaponType) != nullptr;
}

bool UMedComWeaponAnimationSubsystem::ValidateAnimationData_Implementation(const FGameplayTag& WeaponType, TArray<FString>& OutErrors) const
{
    OutErrors.Empty();
...
TArray<FGameplayTag> UMedComWeaponAnimationSubsystem::GetAvailableWeaponTypes_Implementation() const
{
...
bool UMedComWeaponAnimationSubsystem::HasSwitchAnimation_Implementation(const FGameplayTag& FromWeaponType, const FGameplayTag& ToWeaponType) const
{
...
void UMedComWeaponAnimationSubsystem::ClearAnimationCache()
{
    FScopeLock Lock(&CacheCriticalSection);
...
void UMedComWeaponAnimationSubsystem::GetCacheStatistics(int32& OutCacheSize, int32& OutMemoryUsage) const
{
    FScopeLock Lock(&CacheCriticalSection);
...
void UMedComWeaponAnimationSubsystem::PreloadWeaponAnimations(const TArray<FGameplayTag>& WeaponTypes)
{
    PreloadAnimationDataBatch(WeaponTypes);
}

FString UMedComWeaponAnimationSubsystem::GetDebugInfo() const
{
    FScopeLock Lock(&CacheCriticalSection);
...
const FAnimationStateData* UMedComWeaponAnimationSubsystem::FindAnimationData(const FGameplayTag& WeaponType) const
{
...
FString UMedComWeaponAnimationSubsystem::BuildCacheKey(const FGameplayTag& WeaponType) const
{
    return WeaponType.ToString();
}

void UMedComWeaponAnimationSubsystem::UpdateCache(const FString& CacheKey, const FAnimationStateData* Data) const
{
    FScopeLock Lock(&CacheCriticalSection);
...
void UMedComWeaponAnimationSubsystem::EvictLRUCacheEntry() const
{
    FString LRUKey;
...
bool UMedComWeaponAnimationSubsystem::ValidateMontage(const UAnimMontage* Montage, const FString& AnimationName, TArray<FString>& OutErrors) const
{
    if (!Montage)
    {
...
int32 UMedComWeaponAnimationSubsystem::CalculateMemoryUsage() const
{
    int32 TotalMemory = 0;
...
void UMedComWeaponAnimationSubsystem::LogSystemState() const
{
