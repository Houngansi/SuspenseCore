...
#include "MedComCharacterCrouchAbility.generated.h"
 ...
 */
UCLASS()
class MEDCOMGAS_API UMedComCharacterCrouchAbility : public UGameplayAbility
{
    GENERATED_BODY()

public:
    UMedComCharacterCrouchAbility();
