...
#include "MedComCharacterJumpAbility.generated.h"
...
/**
 * Надежная способность прыжка для MedCom персонажей
 * 
 ...
 */
UCLASS()
class MEDCOMGAS_API UMedComCharacterJumpAbility : public UGameplayAbility
{
    GENERATED_BODY()

public:
    UMedComCharacterJumpAbility();
