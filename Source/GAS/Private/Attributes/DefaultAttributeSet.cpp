...
UDefaultAttributeSet::UDefaultAttributeSet()
{
	...
	// All initial values should be set through UInitialAttributesEffect
	...
	UE_LOG(LogTemp, Log, TEXT("UDefaultAttributeSet constructed - all values set to 0, waiting for InitialAttributesEffect"));
}