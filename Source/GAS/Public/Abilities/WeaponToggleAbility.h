...
#include "WeaponToggleAbility.generated.h"
 ...
 */
UCLASS()
class GAS_API UWeaponToggleAbility : public UGASAbility
{
    GENERATED_BODY()

public:
    UWeaponToggleAbility();
...
protected:
     ...
     */
    bool IsWeaponDrawn(const TScriptInterface<ISuspenseEquipment>& EquipmentInterface, int32 SlotIndex) const;
     ...
     */
    FGameplayTag GetCurrentEquipmentState(const TScriptInterface<ISuspenseEquipment>& EquipmentInterface) const;
     ...
     */
    void SetEquipmentState(const TScriptInterface<ISuspenseEquipment>& EquipmentInterface, const FGameplayTag& NewState);
     ...
     */
    FGameplayTag GetWeaponTypeForSlot(const TScriptInterface<ISuspenseEquipment>& EquipmentInterface, int32 SlotIndex) const;
...
private:
    ...
    TScriptInterface<ISuspenseWeaponAnimation> CachedAnimationInterface;
