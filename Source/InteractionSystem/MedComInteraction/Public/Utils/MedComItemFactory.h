...
#include "Interfaces/Interaction/IMedComItemFactoryInterface.h"
#include "MedComItemFactory.generated.h"
 ...
 */
UCLASS()
class MEDCOMINTERACTION_API UMedComItemFactory : public UGameInstanceSubsystem, public IMedComItemFactoryInterface
{
    GENERATED_BODY()
