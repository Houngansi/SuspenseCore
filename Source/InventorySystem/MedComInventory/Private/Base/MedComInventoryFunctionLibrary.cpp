...
#include "Base/MedComInventoryFunctionLibrary.h"
#include "ItemSystem/MedComItemManager.h"
#include "Base/MedComInventoryItem.h"
...
FInventoryItemInstance UMedComInventoryFunctionLibrary::CreateItemInstance(const FName& ItemID, int32 Quantity, const UObject* WorldContext)
{
...
int32 UMedComInventoryFunctionLibrary::CreateItemInstancesFromSpawnData(const TArray<FPickupSpawnData>& SpawnDataArray,
...
bool UMedComInventoryFunctionLibrary::GetUnifiedItemData(const FName& ItemID, const UObject* WorldContext, FMedComUnifiedItemData& OutItemData)
{
    if (ItemID.IsNone())
    {
...
AActor* UMedComInventoryFunctionLibrary::SpawnItemInWorld(const FInventoryItemInstance& ItemInstance,
                                                         UWorld* World,
...
bool UMedComInventoryFunctionLibrary::ValidateItemInstance(const FInventoryItemInstance& ItemInstance,
                                                          const UObject* WorldContext,
...
bool UMedComInventoryFunctionLibrary::IsValidItemID(const FName& ItemID, const UObject* WorldContext)
{
    if (ItemID.IsNone())
    {
        return false;
...
bool UMedComInventoryFunctionLibrary::IsValidQuantityForItem(const FName& ItemID, int32 Quantity, const UObject* WorldContext)
{
    if (Quantity <= 0)
    {
        return false;
...
bool UMedComInventoryFunctionLibrary::IndexToGridCoords(int32 Index, int32 GridWidth, int32& OutX, int32& OutY)
{
...
int32 UMedComInventoryFunctionLibrary::GridCoordsToIndex(int32 X, int32 Y, int32 GridWidth, int32 GridHeight)
{
...
bool UMedComInventoryFunctionLibrary::CanItemFitAtPosition(const FName& ItemID,
...
int32 UMedComInventoryFunctionLibrary::FindOptimalPlacementForItem(const FName& ItemID,
                                                                  int32 GridWidth, int32 GridHeight,
...
TArray<int32> UMedComInventoryFunctionLibrary::GetOccupiedSlots(const FName& ItemID,
                                                              int32 AnchorIndex,
                                                              int32 GridWidth,
                                                              bool bIsRotated,
                                                              const UObject* WorldContext)
...
FIntPoint UMedComInventoryFunctionLibrary::GetEffectiveItemSize(const FName& ItemID, bool bIsRotated, const UObject* WorldContext)
{
...
float UMedComInventoryFunctionLibrary::CalculateTotalWeightFromInstances(const TArray<FInventoryItemInstance>& ItemInstances,
                                                                        const UObject* WorldContext)
{
...
bool UMedComInventoryFunctionLibrary::CanAddItemsByWeight(float CurrentWeight,
...
float UMedComInventoryFunctionLibrary::GetItemWeight(const FName& ItemID, const UObject* WorldContext)
{
    FMedComUnifiedItemData ItemData;
    if (GetUnifiedItemData(ItemID, WorldContext, ItemData))
    {
...
bool UMedComInventoryFunctionLibrary::IsItemCompatibleWithSlot(const FName& ItemID,
...
bool UMedComInventoryFunctionLibrary::IsItemTypeAllowed(const FName& ItemID,
...
FGameplayTag UMedComInventoryFunctionLibrary::GetItemType(const FName& ItemID, const UObject* WorldContext)
{
    FMedComUnifiedItemData ItemData;
    if (GetUnifiedItemData(ItemID, WorldContext, ItemData))
    {
...
FGameplayTagContainer UMedComInventoryFunctionLibrary::GetItemTags(const FName& ItemID, const UObject* WorldContext)
{
    FMedComUnifiedItemData ItemData;
    if (GetUnifiedItemData(ItemID, WorldContext, ItemData))
    {
...
bool UMedComInventoryFunctionLibrary::CanStackInstances(const FInventoryItemInstance& Instance1,
...
bool UMedComInventoryFunctionLibrary::StackInstances(FInventoryItemInstance& SourceInstance,
...
bool UMedComInventoryFunctionLibrary::SplitInstance(FInventoryItemInstance& SourceInstance,
                                                   int32 SplitQuantity,
...
int32 UMedComInventoryFunctionLibrary::GetMaxStackSize(const FName& ItemID, const UObject* WorldContext)
{
    FMedComUnifiedItemData ItemData;
    if (GetUnifiedItemData(ItemID, WorldContext, ItemData))
    {
...
FVector2D UMedComInventoryFunctionLibrary::CalculateItemPositionInUI(int32 GridX, int32 GridY,
...
FVector2D UMedComInventoryFunctionLibrary::CalculateItemSizeInUI(const FName& ItemID,
                                                                const FVector2D& CellSize,
                                                                float CellPadding,
                                                                bool bIsRotated,
                                                                const UObject* WorldContext)
...
FText UMedComInventoryFunctionLibrary::GetItemDisplayName(const FName& ItemID, const UObject* WorldContext)
{
    FMedComUnifiedItemData ItemData;
    if (GetUnifiedItemData(ItemID, WorldContext, ItemData))
    {
...
FText UMedComInventoryFunctionLibrary::GetItemDescription(const FName& ItemID, const UObject* WorldContext)
{
    FMedComUnifiedItemData ItemData;
    if (GetUnifiedItemData(ItemID, WorldContext, ItemData))
    {
...
UTexture2D* UMedComInventoryFunctionLibrary::GetItemIcon(const FName& ItemID, const UObject* WorldContext)
{
    FMedComUnifiedItemData ItemData;
    if (GetUnifiedItemData(ItemID, WorldContext, ItemData))
    {
...
FText UMedComInventoryFunctionLibrary::FormatWeightForDisplay(float Weight, bool bShowUnit, int32 DecimalPlaces)
{
...
FLinearColor UMedComInventoryFunctionLibrary::GetItemRarityColor(const FName& ItemID, const UObject* WorldContext)
{
    FMedComUnifiedItemData ItemData;
    if (GetUnifiedItemData(ItemID, WorldContext, ItemData))
    {
...
FText UMedComInventoryFunctionLibrary::GetErrorMessage(EInventoryErrorCode ErrorCode, const FString& Context)
{
    FText BaseMessage;
...
FInventoryOperationResult UMedComInventoryFunctionLibrary::CreateSuccessResult(const FName& Context,
...
FInventoryOperationResult UMedComInventoryFunctionLibrary::CreateFailureResult(EInventoryErrorCode ErrorCode,
...
float UMedComInventoryFunctionLibrary::GetItemRuntimeProperty(const FInventoryItemInstance& ItemInstance,
...
void UMedComInventoryFunctionLibrary::SetItemRuntimeProperty(FInventoryItemInstance& ItemInstance,
                                                           const FName& PropertyName,
                                                           float Value)
{
...
bool UMedComInventoryFunctionLibrary::HasItemRuntimeProperty(const FInventoryItemInstance& ItemInstance,
                                                           const FName& PropertyName)
{
...
FString UMedComInventoryFunctionLibrary::GetItemInstanceDebugInfo(const FInventoryItemInstance& ItemInstance,
                                                                const UObject* WorldContext)
{
...
FString UMedComInventoryFunctionLibrary::GetItemManagerStatistics(const UObject* WorldContext)
{
    UMedComItemManager* ItemManager = GetItemManager(WorldContext);
    if (!ItemManager)
    {
...
UMedComItemManager* UMedComInventoryFunctionLibrary::GetItemManager(const UObject* WorldContext)
{
    if (!WorldContext)
    {
        return nullptr;
...
void UMedComInventoryFunctionLibrary::LogError(const FString& FunctionName, const FString& ErrorMessage, const FName& ItemID)
{
    if (ItemID.IsNone())
    {
        UE_LOG(LogInventory, Warning, TEXT("UMedComInventoryFunctionLibrary::%s: %s"), *FunctionName, *ErrorMessage);
    }
    else
    {
        UE_LOG(LogInventory, Warning, TEXT("UMedComInventoryFunctionLibrary::%s: %s (ItemID: %s)"),
            *FunctionName, *ErrorMessage, *ItemID.ToString());
    }
}

bool UMedComInventoryFunctionLibrary::ValidateWorldContext(const UObject* WorldContext, const FString& FunctionName)
{
    if (!WorldContext)
    {
