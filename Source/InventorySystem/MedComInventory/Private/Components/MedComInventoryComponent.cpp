...
#include "Storage/MedComInventoryStorage.h"
#include "Validation/MedComInventoryConstraints.h"
#include "Operations/MedComInventoryTransaction.h"
#include "Network/InventoryReplicator.h"
#include "Events/MedComInventoryEvents.h"
#include "Serialization/MedComInventorySerializer.h"
#include "UI/MedComInventoryUIConnector.h"
#include "Abilities/Inventory/MedComInventoryGASIntegration.h"
...
void UMedComInventoryComponent::BeginPlay()
{
    Super::BeginPlay();
...
void UMedComInventoryComponent::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
    // Clear timer
...
void UMedComInventoryComponent::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
    ...
    DOREPLIFETIME(UMedComInventoryComponent, bIsInitializedReplicated);
    DOREPLIFETIME(UMedComInventoryComponent, CurrentLoadoutID);
    DOREPLIFETIME(UMedComInventoryComponent, CurrentInventoryName);
}

void UMedComInventoryComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
//==================================================================
// IMedComInventoryInterface Implementation - Core Operations
//==================================================================

bool UMedComInventoryComponent::AddItemByID_Implementation(FName ItemID, int32 Quantity)
{
    // Validate parameters
    ...
    if (!ItemManager->GetUnifiedItemData(ItemID, UnifiedData))
    {
        ...
        IMedComInventoryInterface::BroadcastInventoryError(this, EInventoryErrorCode::InvalidItem, 
...
FInventoryOperationResult UMedComInventoryComponent::AddItemInstance(const FInventoryItemInstance& ItemInstance)
{
    // Validate instance
    ...
    {
        return FInventoryOperationResult::ItemNotFound(TEXT("AddItemInstance"), ItemInstance.ItemID);
    }
    ...
    FInventoryItemInstance InstanceToAdd = ItemInstance;
    ...
    {
        return FInventoryOperationResult::NoSpace(TEXT("AddItemInstance"));
    }
    ...
    TArray<FInventoryItemInstance> AllInstances = StorageComponent->GetAllItemInstances();
    const FInventoryItemInstance* PlacedInstance = nullptr;
    
    for (const FInventoryItemInstance& StoredInstance : AllInstances)
    {
    ...
    if (PlacedInstance)
    {
        ...
        // Broadcast events
        IMedComInventoryInterface::BroadcastItemAdded(this, *PlacedInstance, PlacedInstance->AnchorIndex);
    ...
    FInventoryOperationResult Result = FInventoryOperationResult::Success(TEXT("AddItemInstance"));
...
FInventoryOperationResult UMedComInventoryComponent::AddItemInstanceToSlot(const FInventoryItemInstance& ItemInstance, int32 TargetSlot)
{
    // Validate instance
    if (!ItemInstance.IsValid())
    {
    ...
    if (!GetItemManager() || !GetItemManager()->GetUnifiedItemData(ItemInstance.ItemID, UnifiedData))
    {
        return FInventoryOperationResult::ItemNotFound(TEXT("AddItemInstanceToSlot"), ItemInstance.ItemID);
    }
    ...
    {
        return FInventoryOperationResult::NoSpace(TEXT("AddItemInstanceToSlot"));
    }
    ...
    // Broadcast events
    IMedComInventoryInterface::BroadcastItemAdded(this, InstanceToAdd, TargetSlot);
    ...
    // Create success result
    FInventoryOperationResult Result = FInventoryOperationResult::Success(TEXT("AddItemInstanceToSlot"));
    Result.AddResultData(TEXT("ItemID"), InstanceToAdd.ItemID.ToString());
    Result.AddResultData(TEXT("Quantity"), FString::FromInt(InstanceToAdd.Quantity));
    Result.AddResultData(TEXT("InstanceID"), InstanceToAdd.InstanceID.ToString());
...
bool UMedComInventoryComponent::RemoveItemFromSlot(int32 SlotIndex, FInventoryItemInstance& OutRemovedInstance)
{
    // Check authority
    ...
    FInventoryItemInstance InstanceToRemove;
    ...
    // Broadcast events
    IMedComInventoryInterface::BroadcastItemRemoved(this, InstanceToRemove.ItemID, InstanceToRemove.Quantity, SlotIndex);
...
bool UMedComInventoryComponent::CanPlaceItemInstanceAtSlot(const FInventoryItemInstance& ItemInstance, int32 SlotIndex) const
{
    // Validate input
...
bool UMedComInventoryComponent::PlaceItemInstanceAtSlot(const FInventoryItemInstance& ItemInstance, int32 SlotIndex, bool bForcePlace)
{
    // Check authority
    ...
    FInventoryItemInstance InstanceToPlace = ItemInstance;
            ...
            if (ItemManager->GetUnifiedItemData(InstanceToPlace.ItemID, ItemData))
            {
                ...
                for (int32 OccupiedSlot : OccupiedSlots)
                {
                    ...
                    if (StorageComponent->GetItemInstanceAt(OccupiedSlot, BlockingInstance))
                    {
                        ...
                        // Update weight
                        FMedComUnifiedItemData BlockingItemData;
    ...
    if (bPlaced)
    {
        ...
        // Broadcast events
        IMedComInventoryInterface::BroadcastItemAdded(this, InstanceToPlace, SlotIndex);
...
FInventoryOperationResult UMedComInventoryComponent::RemoveItemByID(const FName& ItemID, int32 Amount)
{
    // Validate parameters
    ...
    if (bSuccess)
    {
        FInventoryOperationResult Result = FInventoryOperationResult::Success(TEXT("RemoveItemByID"));
    ...
    {
        return FInventoryOperationResult::ItemNotFound(TEXT("RemoveItemByID"), ItemID);
    }
}

FInventoryOperationResult UMedComInventoryComponent::RemoveItemInstance(const FGuid& InstanceID)
{
    ...
    {
        return FInventoryOperationResult::ItemNotFound(TEXT("RemoveItemInstance"));
    }
    ...
    FInventoryOperationResult Result = FInventoryOperationResult::Success(TEXT("RemoveItemInstance"));
...
TArray<FInventoryItemInstance> UMedComInventoryComponent::GetAllItemInstances() const
{
    if (!StorageComponent || !bIsInitialized)
    {
        return TArray<FInventoryItemInstance>();
    }
    
    return StorageComponent->GetAllItemInstances();
}

UMedComItemManager* UMedComInventoryComponent::GetItemManager() const
{
...
int32 UMedComInventoryComponent::CreateItemsFromSpawnData(const TArray<FPickupSpawnData>& SpawnDataArray)
{
    ...
    for (const FPickupSpawnData& SpawnData : SpawnDataArray)
    {
        ...
        FInventoryItemInstance Instance = SpawnData.CreateInventoryInstance();
        
        // Add to inventory
        FInventoryOperationResult Result = AddItemInstance(Instance);
        if (Result.IsSuccess())
        {
            SuccessCount++;
        }
...
int32 UMedComInventoryComponent::ConsolidateStacks(const FName& ItemID)
{
    ...
    for (auto& Pair : InstanceIndicesByID)
    {
        ...
        {
            FInventoryItemInstance& Target = AllInstances[Indices[i]];
            ...
            {
                FInventoryItemInstance& Source = AllInstances[Indices[j]];
...
FInventoryOperationResult UMedComInventoryComponent::SplitStack(int32 SourceSlot, int32 SplitQuantity, int32 TargetSlot)
{
    ...
    {
        return FInventoryOperationResult::ItemNotFound(TEXT("SplitStack"));
    }
    ...
    {
        return FInventoryOperationResult::Failure(
            EInventoryErrorCode::InsufficientQuantity,
    ...
    {
        return FInventoryOperationResult::ItemNotFound(TEXT("SplitStack"), SourceInstance.ItemID);
    }
    ...
    FInventoryItemInstance SplitInstance = SourceInstance;
    ...
    // Broadcast events
    IMedComInventoryInterface::BroadcastItemAdded(this, SplitInstance, TargetSlot);
    BroadcastInventoryUpdated();
    
    // Success result
    FInventoryOperationResult Result = FInventoryOperationResult::Success(TEXT("SplitStack"));
...
bool UMedComInventoryComponent::AddItem(const FMedComUnifiedItemData& ItemData, int32 Amount)
{
    EInventoryErrorCode ErrorCode;
    return AddItemWithErrorCode(ItemData, Amount, ErrorCode);
}

bool UMedComInventoryComponent::AddItemWithErrorCode(const FMedComUnifiedItemData& ItemData, int32 Amount, EInventoryErrorCode& OutErrorCode)
{
    // Check authority
    ...
    FInventoryItemInstance NewInstance = InventoryUtils::CreateItemInstance(this, ItemData.ItemID, Amount);
    ...
    // Add instance
    FInventoryOperationResult Result = AddItemInstance(NewInstance);
...
bool UMedComInventoryComponent::TryAddItem_Implementation(const FMedComUnifiedItemData& ItemData, int32 Quantity)
{
    return AddItem(ItemData, Quantity);
}

bool UMedComInventoryComponent::RemoveItem(const FName& ItemID, int32 Amount)
{
    // Check authority
    ...
    TArray<FInventoryItemInstance> AllInstances = GetAllItemInstances();
    TArray<FInventoryItemInstance> MatchingInstances;
    ...
    if (MatchingInstances.Num() == 0)
    {
        ...
        IMedComInventoryInterface::BroadcastInventoryError(this, EInventoryErrorCode::ItemNotFound, 
    ...
    for (const FInventoryItemInstance& Instance : MatchingInstances)
    {
        ...
        else
        {
            ...
            FInventoryItemInstance UpdatedInstance = Instance;
...
bool UMedComInventoryComponent::ReceiveItem_Implementation(const FMedComUnifiedItemData& ItemData, int32 Quantity)
{
    return AddItem(ItemData, Quantity);
}

bool UMedComInventoryComponent::CanReceiveItem_Implementation(const FMedComUnifiedItemData& ItemData, int32 Quantity) const
{
    // Validate components
...
FGameplayTagContainer UMedComInventoryComponent::GetAllowedItemTypes_Implementation() const
{
...
void UMedComInventoryComponent::SwapItemSlots(int32 SlotIndex1, int32 SlotIndex2)
{
    ...
    {
        IMedComInventoryInterface::BroadcastInventoryError(this, ErrorCode, TEXT("Swap failed"));
    }
}

int32 UMedComInventoryComponent::FindFreeSpaceForItem(const FVector2D& ItemSize, bool bAllowRotation) const
{
    if (!StorageComponent)
    {
        return INDEX_NONE;
...
bool UMedComInventoryComponent::CanPlaceItemAtSlot(const FVector2D& ItemSize, int32 SlotIndex, bool bIgnoreRotation) const
{
    if (!StorageComponent)
    {
        return false;
...
bool UMedComInventoryComponent::TryAutoPlaceItemInstance(const FInventoryItemInstance& ItemInstance)
{
    ...
    FInventoryOperationResult Result = AddItemInstance(ItemInstance);
...
bool UMedComInventoryComponent::MoveItemBySlots_Implementation(int32 FromSlot, int32 ToSlot, bool bMaintainRotation)
{
    ...
    else
    {
        ...
        FInventoryItemInstance UpdatedInstance;
        if (StorageComponent->GetItemInstance(SourceInstance.InstanceID, UpdatedInstance))
        {
            ...
            IMedComInventoryInterface::BroadcastItemMoved(this, UpdatedInstance.InstanceID, FromSlot, ToSlot, UpdatedInstance.bIsRotated);
        }
    }
...
bool UMedComInventoryComponent::MoveItemInstance(const FGuid& InstanceID, int32 NewSlot, bool bAllowRotation)
{
    ...
    FInventoryItemInstance CurrentInstance;
...
bool UMedComInventoryComponent::CanMoveItemToSlot_Implementation(int32 FromSlot, int32 ToSlot, bool bMaintainRotation) const
{
    if (FromSlot == ToSlot)
    {
        return true;
...
float UMedComInventoryComponent::GetCurrentWeight_Implementation() const
{
    return CurrentWeight;
}

float UMedComInventoryComponent::GetMaxWeight_Implementation() const
{
    return MaxWeight;
}

float UMedComInventoryComponent::GetRemainingWeight_Implementation() const
{
    return MaxWeight - CurrentWeight;
}

bool UMedComInventoryComponent::HasWeightCapacity_Implementation(float RequiredWeight) const
{
...
FVector2D UMedComInventoryComponent::GetInventorySize() const
{
...
bool UMedComInventoryComponent::GetItemInstanceAtSlot(int32 SlotIndex, FInventoryItemInstance& OutInstance) const
{
    if (!StorageComponent || !bIsInitialized)
    {
        return false;
...
int32 UMedComInventoryComponent::GetItemCountByID(const FName& ItemID) const
{
    int32 TotalCount = 0;
...
TArray<FInventoryItemInstance> UMedComInventoryComponent::FindItemInstancesByType(const FGameplayTag& ItemType) const
{
...
int32 UMedComInventoryComponent::GetTotalItemCount() const
{
    if (!bIsInitialized)
    {
        return 0;
...
bool UMedComInventoryComponent::HasItem(const FName& ItemID, int32 Amount) const
{
...
bool UMedComInventoryComponent::SwapItemsInSlots(int32 Slot1, int32 Slot2, EInventoryErrorCode& OutErrorCode)
{
    if (Slot1 == Slot2)
    {
        OutErrorCode = EInventoryErrorCode::Success;
...
bool UMedComInventoryComponent::CanSwapSlots(int32 Slot1, int32 Slot2) const
{
    ...
    FInventoryItemInstance Instance1, Instance2;
    ...
    // Get item sizes
    FMedComUnifiedItemData Data1, Data2;
...
bool UMedComInventoryComponent::RotateItemAtSlot(int32 SlotIndex)
{
...
bool UMedComInventoryComponent::CanRotateItemAtSlot(int32 SlotIndex) const
{
    if (!StorageComponent)
    {
        return false;
...
void UMedComInventoryComponent::RefreshItemsUI()
{
...
void UMedComInventoryComponent::BeginTransaction()
{
...
void UMedComInventoryComponent::CommitTransaction()
{
    if (TransactionComponent)
    {
        TransactionComponent->CommitTransaction();
...
void UMedComInventoryComponent::RollbackTransaction()
{
    if (TransactionComponent)
    {
        TransactionComponent->RollbackTransaction();
...
bool UMedComInventoryComponent::IsTransactionActive() const
{
...
bool UMedComInventoryComponent::InitializeFromLoadout(const FName& LoadoutID, const FName& InventoryName)
{
    // Get inventory manager
    UInventoryManager* InvManager = GetInventoryManager();
    if (!InvManager)
    {
...
bool UMedComInventoryComponent::InitializeWithSimpleSettings(int32 Width, int32 Height, float MaxWeightLimit, const FGameplayTagContainer& AllowedTypes)
{
...
void UMedComInventoryComponent::SetMaxWeight(float NewMaxWeight)
{
...
bool UMedComInventoryComponent::IsInventoryInitialized() const
{
    return bIsInitialized;
}

void UMedComInventoryComponent::SetAllowedItemTypes(const FGameplayTagContainer& Types)
{
...
void UMedComInventoryComponent::InitializeInventory(const FInventoryConfig& Config)
{
...
void UMedComInventoryComponent::BroadcastInventoryUpdated()
{
...
UEventDelegateManager* UMedComInventoryComponent::GetDelegateManager() const
{
    ...
    UEventDelegateManager* Manager = IMedComInventoryInterface::GetDelegateManagerStatic(this);
    if (Manager)
    {
...
void UMedComInventoryComponent::BindToInventoryUpdates(const FOnInventoryUpdated::FDelegate& Delegate)
{
    OnInventoryUpdated.Add(Delegate);
}

void UMedComInventoryComponent::UnbindFromInventoryUpdates(const FOnInventoryUpdated::FDelegate& Delegate)
{
...
bool UMedComInventoryComponent::GetInventoryCoordinates(int32 Index, int32& OutX, int32& OutY) const
{
    if (StorageComponent)
    {
...
int32 UMedComInventoryComponent::GetIndexFromCoordinates(int32 X, int32 Y) const
{
    if (StorageComponent)
    {
        int32 Index;
...
int32 UMedComInventoryComponent::GetFlatIndexForItem(int32 AnchorIndex, const FVector2D& ItemSize, bool bIsRotated) const
{
...
TArray<int32> UMedComInventoryComponent::GetOccupiedSlots(int32 AnchorIndex, const FVector2D& ItemSize, bool bIsRotated) const
{
...
FString UMedComInventoryComponent::GetInventoryDebugInfo() const
{
...
bool UMedComInventoryComponent::ValidateInventoryIntegrity(TArray<FString>& OutErrors) const
{
    OutErrors.Empty();
...
bool UMedComInventoryComponent::UpdateItemAmount(const FName& ItemID, int32 NewAmount)
{
    ...
    for (FInventoryItemInstance& Instance : AllInstances)
    {
...
TArray<FInventoryItemInstance> UMedComInventoryComponent::GetItemInstancesByType(const FGameplayTag& ItemType) const
{
    TArray<FInventoryItemInstance> Result;
...
bool UMedComInventoryComponent::SaveToFile(const FString& FilePath)
{
    ...
    return UMedComInventorySerializer::SaveInventoryToFile(this, FilePath);
}

bool UMedComInventoryComponent::LoadFromFile(const FString& FilePath)
{
...
const FLoadoutConfiguration* UMedComInventoryComponent::GetCurrentLoadoutConfig() const
{
...
void UMedComInventoryComponent::LogInventoryStatistics(const FString& Context) const
{
    if (!bIsInitialized)
    {
...
void UMedComInventoryComponent::NotifyItemPlaced(const FInventoryItemInstance& ItemInstance, int32 AnchorIndex)
{
...
void UMedComInventoryComponent::NotifyItemRemoved(const FInventoryItemInstance& ItemInstance)
{
    if (!ReplicatorComponent || GetOwnerRole() != ROLE_Authority)
    {
...
bool UMedComInventoryComponent::Server_AddItemByID_Validate(const FName& ItemID, int32 Amount)
{
    return !ItemID.IsNone() && Amount > 0;
}

void UMedComInventoryComponent::Server_AddItemByID_Implementation(const FName& ItemID, int32 Amount)
{
    AddItemByID_Implementation(ItemID, Amount);
}

bool UMedComInventoryComponent::Server_RemoveItem_Validate(const FName& ItemID, int32 Amount)
{
    return !ItemID.IsNone() && Amount > 0;
}

void UMedComInventoryComponent::Server_RemoveItem_Implementation(const FName& ItemID, int32 Amount)
{
    RemoveItem(ItemID, Amount);
}

bool UMedComInventoryComponent::Server_UpdateInventoryState_Validate()
{
    return true;
}

void UMedComInventoryComponent::Server_UpdateInventoryState_Implementation()
{
    BroadcastInventoryUpdated();
}
...
void UMedComInventoryComponent::InitializeSubComponents()
{
    // Create storage component
    StorageComponent = NewObject<UMedComInventoryStorage>(this, TEXT("StorageComponent"));
    
    // Create constraints component
    ConstraintsComponent = NewObject<UMedComInventoryConstraints>(this, TEXT("ConstraintsComponent"));
    
    // Create transaction component
    TransactionComponent = NewObject<UMedComInventoryTransaction>(this, TEXT("TransactionComponent"));
    
    // Create replicator component
    ReplicatorComponent = NewObject<UInventoryReplicator>(this, TEXT("ReplicatorComponent"));
    
    // Create events component
    EventsComponent = NewObject<UMedComInventoryEvents>(this, TEXT("EventsComponent"));
    
    // Create serializer component
    SerializerComponent = NewObject<UMedComInventorySerializer>(this, TEXT("SerializerComponent"));
    
    // Create UI adapter
    UIAdapter = NewObject<UMedComInventoryUIConnector>(this, TEXT("UIAdapter"));
...
void UMedComInventoryComponent::InitializeClientComponents()
{
    if (GetOwnerRole() == ROLE_Authority)
    {
...
void UMedComInventoryComponent::SyncItemsFromReplicator()
{
...
bool UMedComInventoryComponent::CheckAuthority(const FString& FunctionName) const
{
...
void UMedComInventoryComponent::UpdateCurrentWeight()
{
    if (!bIsInitialized)
    {
        return;
...
bool UMedComInventoryComponent::ValidateItemPlacement(const FVector2D& ItemSize, int32 TargetSlot, const FGuid& ExcludeInstanceID) const
{
    if (!StorageComponent)
    {
        return false;
...
bool UMedComInventoryComponent::ExecuteSlotSwap(int32 Slot1, int32 Slot2, EInventoryErrorCode& OutErrorCode)
{
    // Basic validation
    if (!StorageComponent)
    {
    ...
    if (!bHasItem1 && !bHasItem2)
    {
        OutErrorCode = EInventoryErrorCode::ItemNotFound;
    ...
    if (!bHasItem1 || !bHasItem2)
    {
        ...
        FInventoryItemInstance& SourceInstance = bHasItem1 ? Instance1 : Instance2;
        ...
        if (StorageComponent->MoveItem(SourceInstance.InstanceID, TargetSlot, false))
        {
            ...
            IMedComInventoryInterface::BroadcastItemMoved(this, SourceInstance.InstanceID, SourceSlot, TargetSlot, false);
    ...
    TArray<FInventoryItemInstance> BackupInstances = StorageComponent->GetAllItemInstances();
    
    // Save copies for replicator
    FInventoryItemInstance PreSwapInstance1 = Instance1;
    FInventoryItemInstance PreSwapInstance2 = Instance2;
    ...
    if (bPlaced1 && bPlaced2)
    {
        ...
        IMedComInventoryInterface::BroadcastItemMoved(this, Instance1.InstanceID, Slot1, Slot2, false);
        IMedComInventoryInterface::BroadcastItemMoved(this, Instance2.InstanceID, Slot2, Slot1, false);
    ...
    else
    {
        ...
        TArray<FInventoryItemInstance> CurrentInstances = StorageComponent->GetAllItemInstances();
        bool bItem1Found = false;
        bool bItem2Found = false;
        
        for (const FInventoryItemInstance& Instance : CurrentInstances)
        {
        ...
        if (!bItem1Found || !bItem2Found)
        {
            ...
            StorageComponent->ClearAllItems();
            for (const FInventoryItemInstance& BackupInstance : BackupInstances)
            {
...
bool UMedComInventoryComponent::TryMoveInstanceToSlot(const FGuid& InstanceID, int32 NewSlot, bool bAllowRotation, EInventoryErrorCode& OutErrorCode)
{
    if (!InstanceID.IsValid())
    {
    ...
    if (StorageComponent->MoveItem(InstanceID, NewSlot, bAllowRotation))
    {
        ...
        if (StorageComponent->GetItemInstance(InstanceID, UpdatedInstance))
        {
            ...
            IMedComInventoryInterface::BroadcastItemMoved(this, UpdatedInstance.InstanceID, OldSlot, NewSlot, UpdatedInstance.bIsRotated);
        }
...
UInventoryManager* UMedComInventoryComponent::GetInventoryManager() const
{
    ...
    UInventoryManager* Manager = GameInstance->GetSubsystem<UInventoryManager>();
    if (Manager)
    {
...
UGameInstance* UMedComInventoryComponent::GetGameInstance() const
{
    AActor* Owner = GetOwner();
    return Owner ? Owner->GetGameInstance() : nullptr;
}

void UMedComInventoryComponent::OnRep_GridSize()
{
...
void UMedComInventoryComponent::OnRep_InventoryState()
{
