...
#include "Operations/InventoryHistory.h"
...
void UInventoryHistory::AddOperation(const FInventoryOperation& Operation)
{
    ...
    TSharedPtr<FInventoryOperation> NewOperation = MakeShared<FInventoryOperation>(Operation);
...
bool UInventoryHistory::Undo()
{
    ...
    TSharedPtr<FInventoryOperation> Operation = Operations[CurrentIndex];
...
TSharedPtr<FInventoryOperation> UInventoryHistory::FindLastOperationOfType(EInventoryOperationType OperationType) const
{
