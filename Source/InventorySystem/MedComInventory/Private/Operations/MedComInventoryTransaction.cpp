...
UMedComInventoryTransaction::UMedComInventoryTransaction()
{
    Storage = nullptr;
    Constraints = nullptr;
    ItemManager = nullptr;
...
void UMedComInventoryTransaction::Initialize(UMedComInventoryStorage* InStorage, 
                                           UMedComInventoryConstraints* InConstraints, 
                                           UMedComItemManager* InItemManager,
                                           UMedComInventoryEvents* InEvents)
{
    Storage = InStorage;
...
bool UMedComInventoryTransaction::BeginTransaction(EInventoryTransactionType Type, const FName& Context)
{
...
bool UMedComInventoryTransaction::CommitTransaction()
{
...
void UMedComInventoryTransaction::RollbackTransaction()
{
    // Check if a transaction is active
    if (!bTransactionActive)
    {
...
FInventoryOperationResult UMedComInventoryTransaction::AddItemByID(const FName& ItemID, int32 Amount)
{
...
FInventoryOperationResult UMedComInventoryTransaction::AddItemFromData(const FMedComUnifiedItemData& ItemData, int32 Amount)
{
...
FInventoryOperationResult UMedComInventoryTransaction::AddItemInstance(const FInventoryItemInstance& ItemInstance)
{
...
bool UMedComInventoryTransaction::ValidateTransactionPrerequisites() const
{
...
FInventoryOperationResult UMedComInventoryTransaction::CreateItemInstanceFromID(const FName& ItemID, int32 Amount, const FName& Context)
{
    if (!ItemManager)
    {
        return FInventoryOperationResult::Failure(
...
FInventoryOperationResult UMedComInventoryTransaction::ValidateItemInstance(const FInventoryItemInstance& Instance, const FName& Context)
{
...
int32 UMedComInventoryTransaction::FindFreeSpaceForInstance(const FInventoryItemInstance& Instance)
{
...
FInventoryOperationResult UMedComInventoryTransaction::PlaceItemInstanceInStorage(const FInventoryItemInstance& Instance, int32 AnchorIndex)
{
...
void UMedComInventoryTransaction::CreateStorageBackup()
{
...
void UMedComInventoryTransaction::RestoreStorageFromBackup()
{
    if (!Storage || !Storage->IsInitialized())
    {
...
void UMedComInventoryTransaction::DestroyCreatedItems()
{
...
void UMedComInventoryTransaction::UpdateTransactionStats()
{
    OperationCount++;
}

void UMedComInventoryTransaction::LogTransactionOperation(const FString& Action, const FInventoryOperationResult& Result)
{
    if (Result.IsSuccess())
    {
...
FString UMedComInventoryTransaction::GetTransactionDebugInfo() const
{
    FString DebugInfo;
...
FInventoryOperationResult UMedComInventoryTransaction::RemoveItem(const FName& ItemID, int32 Amount)
{
...
FInventoryOperationResult UMedComInventoryTransaction::RemoveItemInstance(const FGuid& InstanceID)
{
...
FInventoryOperationResult UMedComInventoryTransaction::MoveItem(UObject* ItemObject, int32 NewAnchorIndex, bool bShouldRotate)
{
...
FInventoryOperationResult UMedComInventoryTransaction::MoveItemInstance(const FGuid& InstanceID, int32 NewAnchorIndex, bool bShouldRotate)
{
...
FInventoryOperationResult UMedComInventoryTransaction::RotateItem(UObject* ItemObject, bool bDesiredRotation)
{
...
FInventoryOperationResult UMedComInventoryTransaction::StackItems(UObject* SourceItem, UObject* TargetItem, int32 Amount)
{
...
FInventoryOperationResult UMedComInventoryTransaction::StackItemInstances(const FGuid& SourceInstanceID, const FGuid& TargetInstanceID, int32 Amount)
{
...
FInventoryOperationResult UMedComInventoryTransaction::SplitStack(UObject* SourceItem, int32 TargetPosition, int32 Amount)
{
...
FInventoryOperationResult UMedComInventoryTransaction::SwapItems(UObject* FirstItem, UObject* SecondItem)
{
...
FInventoryOperationResult UMedComInventoryTransaction::UpdateItemProperties(const FGuid& InstanceID, const TMap<FName, float>& NewProperties)
{
...
FInventoryOperationResult UMedComInventoryTransaction::CreateItemObject(const FMedComUnifiedItemData& ItemData, int32 Amount, const FName& Context)
{
...
FInventoryOperationResult UMedComInventoryTransaction::CreateItemInstanceFromData(const FMedComUnifiedItemData& ItemData, int32 Amount, const FName& Context)
{
    if (!ItemManager)
    {
        return FInventoryOperationResult::Failure(
