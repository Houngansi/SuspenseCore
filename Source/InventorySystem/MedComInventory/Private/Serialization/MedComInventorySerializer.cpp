...
// Константы класса
const FString UMedComInventorySerializer::BACKUP_EXTENSION = TEXT(".backup");

//==================================================================
// Core Serialization Implementation
//==================================================================

FSerializedInventoryData UMedComInventorySerializer::SerializeInventory(UMedComInventoryComponent* InventoryComponent)
{
...
bool UMedComInventorySerializer::DeserializeInventory(UMedComInventoryComponent* InventoryComponent, 
...
FString UMedComInventorySerializer::SerializeInventoryToJson(UMedComInventoryComponent* InventoryComponent, 
                                                           bool bPrettyPrint)
{
...
bool UMedComInventorySerializer::DeserializeInventoryFromJson(UMedComInventoryComponent* InventoryComponent, 
...
bool UMedComInventorySerializer::SaveInventoryToFile(UMedComInventoryComponent* InventoryComponent, 
...
bool UMedComInventorySerializer::LoadInventoryFromFile(UMedComInventoryComponent* InventoryComponent, 
                                                     const FString& FilePath, 
...
bool UMedComInventorySerializer::ValidateSerializedData(const FSerializedInventoryData& SerializedData,
...
bool UMedComInventorySerializer::MigrateSerializedData(FSerializedInventoryData& SerializedData)
{
    if (SerializedData.Version >= CURRENT_VERSION)
    {
...
int32 UMedComInventorySerializer::CleanupInvalidItems(FSerializedInventoryData& SerializedData)
{
...
FString UMedComInventorySerializer::GetInventoryStatistics(const FSerializedInventoryData& SerializedData)
{
    if (!SerializedData.IsValid())
    {
...
bool UMedComInventorySerializer::CompareInventoryData(const FSerializedInventoryData& DataA,
...
FString UMedComInventorySerializer::StructToJson(const FSerializedInventoryData& Data, bool bPrettyPrint)
{
    FString JsonString;
...
bool UMedComInventorySerializer::JsonToStruct(const FString& JsonString, FSerializedInventoryData& OutData)
{
    if (JsonString.IsEmpty())
    {
...
UMedComItemManager* UMedComInventorySerializer::GetItemManager(const UObject* WorldContext)
{
    // ИСПРАВЛЕНО: Используем FItemSystemAccess вместо прямого обращения
    return FItemSystemAccess::GetItemManager(WorldContext);
}

bool UMedComInventorySerializer::ValidateItemInstance(const FInventoryItemInstance& Instance, 
...
bool UMedComInventorySerializer::CreateFileBackup(const FString& OriginalPath)
{
...
bool UMedComInventorySerializer::DetectFileFormat(const FString& FilePath, bool& bOutIsJson)
{
...
void UMedComInventorySerializer::MigrateRuntimeProperties(FInventoryItemInstance& Instance)
{
