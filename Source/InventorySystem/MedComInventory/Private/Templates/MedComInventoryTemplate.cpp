...
#include "Templates/MedComInventoryTemplate.h"
...
UMedComInventoryTemplate::UMedComInventoryTemplate()
{
    ...
    UE_LOG(LogInventory, VeryVerbose, TEXT("UMedComInventoryTemplate: Constructor completed with default configuration"));
}

void UMedComInventoryTemplate::PostLoad()
{
    Super::PostLoad();
...
TMap<FName, FInventoryConfig> UMedComInventoryTemplate::ExportInventoryConfigurations() const
{
    TMap<FName, FInventoryConfig> Configurations;
...
bool UMedComInventoryTemplate::ApplyToInventoryComponent(UMedComInventoryComponent* InventoryComponent, 
                                                       const FName& InventoryName) const
{
    ...
    FInventoryConfig Config = ConfigToUse->ToInventoryConfig();
...
int32 UMedComInventoryTemplate::CreateStartingItemsInInventory(UMedComInventoryComponent* InventoryComponent,
                                                             const FName& InventoryName) const
{
    if (!InventoryComponent)
    {
...
bool UMedComInventoryTemplate::ValidateTemplate(TArray<FName>& OutMissingItems, TArray<FString>& OutValidationErrors) const
{
...
FInventoryTemplateAnalysis UMedComInventoryTemplate::AnalyzeTemplate() const
{
...
bool UMedComInventoryTemplate::IsCompatibleWithCharacterClass(const FGameplayTag& CharacterClass) const
{
...
TArray<UMedComInventoryTemplate*> UMedComInventoryTemplate::GetPredefinedTemplates(const FGameplayTag& CategoryFilter)
{
    TArray<UMedComInventoryTemplate*> Templates;
    ...
    {
        Templates.RemoveAll([&CategoryFilter](const UMedComInventoryTemplate* Template)
        {
...
UMedComInventoryTemplate* UMedComInventoryTemplate::CreateMinimalTemplate()
{
    UMedComInventoryTemplate* Template = NewObject<UMedComInventoryTemplate>();
...
UMedComInventoryTemplate* UMedComInventoryTemplate::CreateStandardTemplate()
{
    UMedComInventoryTemplate* Template = NewObject<UMedComInventoryTemplate>();
...
UMedComInventoryTemplate* UMedComInventoryTemplate::CreateExpandedTemplate()
{
    UMedComInventoryTemplate* Template = NewObject<UMedComInventoryTemplate>();
...
UMedComInventoryTemplate* UMedComInventoryTemplate::CreateSurvivalTemplate()
{
    UMedComInventoryTemplate* Template = NewObject<UMedComInventoryTemplate>();
...
UMedComInventoryTemplate* UMedComInventoryTemplate::CreateClassSpecificTemplate(const FGameplayTag& CharacterClass)
{
    UMedComInventoryTemplate* Template = NewObject<UMedComInventoryTemplate>();
...
UMedComInventoryTemplate* UMedComInventoryTemplate::CreateCustomizedCopy(const TMap<FString, FString>& Modifications) const
{
    UMedComInventoryTemplate* CustomizedTemplate = DuplicateObject<UMedComInventoryTemplate>(this, nullptr);
...
bool UMedComInventoryTemplate::AddAdditionalInventory(const FName& InventoryName, const FInventoryTemplateConfig& Configuration)
{
...
bool UMedComInventoryTemplate::RemoveAdditionalInventory(const FName& InventoryName)
{
...
UMedComItemManager* UMedComInventoryTemplate::GetItemManager() const
{
...
bool UMedComInventoryTemplate::ValidateInventoryConfig(const FInventoryTemplateConfig& Config, 
...
bool UMedComInventoryTemplate::ValidateStartingItems(const TArray<FPickupSpawnData>& StartingItems,
...
const FInventoryTemplateConfig* UMedComInventoryTemplate::GetInventoryConfig(const FName& InventoryName) const
{
...
#if WITH_EDITOR
EDataValidationResult UMedComInventoryTemplate::IsDataValid(TArray<FText>& ValidationErrors)
{
...
void UMedComInventoryTemplate::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
    ...
    if (PropertyChangedEvent.Property)
    {
        ...
        if (PropertyName == GET_MEMBER_NAME_CHECKED(UMedComInventoryTemplate, DisplayName))
        {
