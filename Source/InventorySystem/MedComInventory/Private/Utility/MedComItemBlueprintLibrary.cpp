#include "Utility/MedComItemBlueprintLibrary.h"
...
bool UMedComItemBlueprintLibrary::GetUnifiedItemData(const UObject* WorldContext, FName ItemID, FMedComUnifiedItemData& OutItemData)
{
...
UMedComItemManager* UMedComItemBlueprintLibrary::GetItemManager(const UObject* WorldContext)
{
    // Публичный метод для прямого доступа к ItemManager из Blueprint
    return GetValidatedItemManager(WorldContext);
}

bool UMedComItemBlueprintLibrary::DoesItemExistInDataTable(const UObject* WorldContext, FName ItemID)
{
...
FText UMedComItemBlueprintLibrary::GetItemName(const FMedComUnifiedItemData& ItemData)
{
...
FText UMedComItemBlueprintLibrary::GetItemDescription(const FMedComUnifiedItemData& ItemData)
{
...
UTexture2D* UMedComItemBlueprintLibrary::GetItemIcon(const FMedComUnifiedItemData& ItemData)
{
...
bool UMedComItemBlueprintLibrary::CreateItemInstance(const UObject* WorldContext, FName ItemID, int32 Quantity, FInventoryItemInstance& OutInstance)
{
...
bool UMedComItemBlueprintLibrary::GetUnifiedDataFromInstance(const UObject* WorldContext, const FInventoryItemInstance& ItemInstance, FMedComUnifiedItemData& OutItemData)
{
...
float UMedComItemBlueprintLibrary::GetRuntimeProperty(const FInventoryItemInstance& ItemInstance, const FString& PropertyName, float DefaultValue)
{
...
void UMedComItemBlueprintLibrary::SetRuntimeProperty(FInventoryItemInstance& ItemInstance, const FString& PropertyName, float Value)
{
...
bool UMedComItemBlueprintLibrary::HasRuntimeProperty(const FInventoryItemInstance& ItemInstance, const FString& PropertyName)
{
...
FText UMedComItemBlueprintLibrary::FormatItemQuantity(const FMedComUnifiedItemData& ItemData, int32 Quantity)
{
...
FText UMedComItemBlueprintLibrary::FormatItemQuantityFromInstance(const UObject* WorldContext, const FInventoryItemInstance& ItemInstance)
{
...
FText UMedComItemBlueprintLibrary::FormatItemWeight(const FMedComUnifiedItemData& ItemData, int32 Quantity, bool bIncludeUnit)
{
...
FLinearColor UMedComItemBlueprintLibrary::GetRarityColor(const FMedComUnifiedItemData& ItemData)
{
...
FText UMedComItemBlueprintLibrary::FormatItemDurability(const FInventoryItemInstance& ItemInstance, bool bAsPercentage)
{
...
TArray<FMedComUnifiedItemData> UMedComItemBlueprintLibrary::FilterItemsByType(const TArray<FMedComUnifiedItemData>& ItemDataArray, const FGameplayTag& TypeTag, bool bExactMatch)
{
...
TArray<FMedComUnifiedItemData> UMedComItemBlueprintLibrary::FilterItemsByRarity(const TArray<FMedComUnifiedItemData>& ItemDataArray, const FGameplayTag& RarityTag)
{
...
TArray<FMedComUnifiedItemData> UMedComItemBlueprintLibrary::FilterItemsByTags(const TArray<FMedComUnifiedItemData>& ItemDataArray, const FGameplayTagContainer& FilterTags, bool bRequireAll)
{
...
TArray<FMedComUnifiedItemData> UMedComItemBlueprintLibrary::SearchItems(const TArray<FMedComUnifiedItemData>& ItemDataArray, const FString& SearchText, bool bSearchDescription, bool bSearchTags)
{
...
TArray<FMedComUnifiedItemData> UMedComItemBlueprintLibrary::SortItemsByName(const TArray<FMedComUnifiedItemData>& ItemDataArray, bool bAscending)
{
...
TArray<FMedComUnifiedItemData> UMedComItemBlueprintLibrary::SortItemsByWeight(const TArray<FMedComUnifiedItemData>& ItemDataArray, bool bAscending)
{
...
TArray<FMedComUnifiedItemData> UMedComItemBlueprintLibrary::SortItemsByValue(const TArray<FMedComUnifiedItemData>& ItemDataArray, bool bAscending)
{
...
TArray<FMedComUnifiedItemData> UMedComItemBlueprintLibrary::SortItemsByRarity(const TArray<FMedComUnifiedItemData>& ItemDataArray, bool bAscending)
{
...
float UMedComItemBlueprintLibrary::GetTotalItemsWeight(const TArray<FMedComUnifiedItemData>& ItemDataArray, const TArray<int32>& QuantityArray)
{
...
float UMedComItemBlueprintLibrary::GetTotalInstancesWeight(const TArray<FInventoryItemInstance>& ItemInstances, const UObject* WorldContext)
{
...
int32 UMedComItemBlueprintLibrary::GetTotalItemsValue(const TArray<FMedComUnifiedItemData>& ItemDataArray, const TArray<int32>& QuantityArray)
{
...
FVector2D UMedComItemBlueprintLibrary::GetItemUIPosition(int32 GridX, int32 GridY, const FVector2D& CellSize, float CellSpacing)
{
...
FVector2D UMedComItemBlueprintLibrary::GetItemUISize(const FMedComUnifiedItemData& ItemData, bool bIsRotated, const FVector2D& CellSize, float CellSpacing)
{
...
bool UMedComItemBlueprintLibrary::GetCoordinatesFromIndex(int32 LinearIndex, int32 GridWidth, int32& OutX, int32& OutY)
{
...
int32 UMedComItemBlueprintLibrary::GetIndexFromCoordinates(int32 X, int32 Y, int32 GridWidth)
{
...
TArray<int32> UMedComItemBlueprintLibrary::GetOccupiedSlots(const FMedComUnifiedItemData& ItemData, int32 AnchorIndex, bool bIsRotated, int32 GridWidth)
{
...
bool UMedComItemBlueprintLibrary::IsWeapon(const FMedComUnifiedItemData& ItemData)
{
    // Проверка является ли предмет оружием
    return ItemData.bIsWeapon;
}

bool UMedComItemBlueprintLibrary::IsArmor(const FMedComUnifiedItemData& ItemData)
{
    // Проверка является ли предмет броней
    return ItemData.bIsArmor;
}

bool UMedComItemBlueprintLibrary::IsAmmo(const FMedComUnifiedItemData& ItemData)
{
    // Проверка является ли предмет боеприпасами
    return ItemData.bIsAmmo;
}

bool UMedComItemBlueprintLibrary::IsConsumable(const FMedComUnifiedItemData& ItemData)
{
    // Проверка является ли предмет расходным материалом
    return ItemData.bIsConsumable;
}

bool UMedComItemBlueprintLibrary::IsEquippable(const FMedComUnifiedItemData& ItemData)
{
    // Проверка может ли предмет быть экипирован
    return ItemData.bIsEquippable;
}

bool UMedComItemBlueprintLibrary::IsStackable(const FMedComUnifiedItemData& ItemData)
{
...
bool UMedComItemBlueprintLibrary::GetUnifiedDataFromObject(UObject* ItemObject, FMedComUnifiedItemData& OutItemData)
{
...
bool UMedComItemBlueprintLibrary::GetInstanceFromObject(UObject* ItemObject, FInventoryItemInstance& OutInstance)
{
...
bool UMedComItemBlueprintLibrary::CreatePickupDataFromUnified(const FMedComUnifiedItemData& ItemData, int32 Quantity, FMCPickupData& OutPickupData)
{
...
bool UMedComItemBlueprintLibrary::CreateEquipmentDataFromUnified(const FMedComUnifiedItemData& ItemData, FMCEquipmentData& OutEquipmentData)
{
...
bool UMedComItemBlueprintLibrary::ValidateUnifiedItemData(const FMedComUnifiedItemData& ItemData, TArray<FString>& OutErrors)
{
...
FString UMedComItemBlueprintLibrary::GetItemDebugInfo(const FMedComUnifiedItemData& ItemData)
{
...
bool UMedComItemBlueprintLibrary::ValidateItemInstance(const FInventoryItemInstance& ItemInstance, const UObject* WorldContext, TArray<FString>& OutErrors)
{
...
UMedComItemManager* UMedComItemBlueprintLibrary::GetValidatedItemManager(const UObject* WorldContext)
{
...
int32 UMedComItemBlueprintLibrary::GetRarityPriority(const FGameplayTag& RarityTag)
{
...
bool UMedComItemBlueprintLibrary::DoesTagMatch(const FGameplayTag& ItemTag, const FGameplayTag& FilterTag, bool bExactMatch)
{
...
void UMedComItemBlueprintLibrary::ClearRuntimeProperty(FInventoryItemInstance& ItemInstance, const FString& PropertyName)
{
...
TArray<FString> UMedComItemBlueprintLibrary::GetAllRuntimePropertyNames(const FInventoryItemInstance& ItemInstance)
{
...
int32 UMedComItemBlueprintLibrary::GetRuntimePropertiesCount(const FInventoryItemInstance& ItemInstance)
{
...
void UMedComItemBlueprintLibrary::ClearAllRuntimeProperties(FInventoryItemInstance& ItemInstance)
{
...
float UMedComItemBlueprintLibrary::GetItemDurability(const FInventoryItemInstance& ItemInstance)
{
    // Получение текущей прочности через unified interface
    return GetRuntimeProperty(ItemInstance, TEXT("Durability"), 0.0f);
}

void UMedComItemBlueprintLibrary::SetItemDurability(FInventoryItemInstance& ItemInstance, float Durability)
{
...
float UMedComItemBlueprintLibrary::GetItemDurabilityPercent(const FInventoryItemInstance& ItemInstance)
{
...
int32 UMedComItemBlueprintLibrary::GetItemAmmo(const FInventoryItemInstance& ItemInstance)
{
    // Получение текущих патронов в оружии
    return FMath::RoundToInt(GetRuntimeProperty(ItemInstance, TEXT("Ammo"), 0.0f));
}

void UMedComItemBlueprintLibrary::SetItemAmmo(FInventoryItemInstance& ItemInstance, int32 AmmoCount)
{
...
bool UMedComItemBlueprintLibrary::IsItemOnCooldown(const FInventoryItemInstance& ItemInstance, float CurrentTime)
{
...
void UMedComItemBlueprintLibrary::StartItemCooldown(FInventoryItemInstance& ItemInstance, float CurrentTime, float CooldownDuration)
{
...
float UMedComItemBlueprintLibrary::GetRemainingCooldown(const FInventoryItemInstance& ItemInstance, float CurrentTime)
{
