 ...
 */
UCLASS()
class MEDCOMINVENTORY_API UInventoryManager : public UGameInstanceSubsystem
{
    GENERATED_BODY()
...
public:
    ...
    int32 InitializeInventoryFromLoadout(class UMedComInventoryComponent* InventoryComponent, 
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Inventory|Initialization")
    int32 CreateStartingItemsFromLoadout(class UMedComInventoryComponent* InventoryComponent, 
 ...
 int32 InitializeEquipmentFromLoadout(UObject* EquipmentTarget,
     ...
     */
    const FInventoryConfig* GetInventoryConfigFromLoadout(const FName& LoadoutID, const FName& InventoryName = NAME_None) const;
