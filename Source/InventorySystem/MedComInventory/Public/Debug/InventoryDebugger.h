// MedComInventory/Debug/InventoryDebugger.h
...
#include "InventoryDebugger.generated.h"
...
struct MEDCOMINVENTORY_API FInventoryPerformanceMetrics
{
    GENERATED_BODY()
...
class MEDCOMINVENTORY_API UInventoryDebugger : public UObject
{
    GENERATED_BODY()
...
public:
    ...
    void Initialize(UMedComInventoryComponent* InInventoryComponent);
 ...
 TArray<FString> GetLastValidationErrors() const { return LastValidationErrors; }
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Inventory|Debug")
    UMedComInventoryComponent* CreateInventoryCopy() const;
