// MedComInventory/Events/MedComInventoryEvents.h
...
#include "MedComInventoryEvents.generated.h"
...
class MEDCOMINVENTORY_API UMedComInventoryEvents : public UActorComponent
{
    GENERATED_BODY()
