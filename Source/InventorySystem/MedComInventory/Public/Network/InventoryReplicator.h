// MedComInventory/Network/InventoryReplicator.h
...
#include "InventoryReplicator.generated.h"
...
struct FReplicatedCellsState : public FFastArraySerializer
{
    ...
    class UInventoryReplicator* OwnerComponent = nullptr;
...
struct FInventoryReplicatedState
{
    ...
    void Initialize(UInventoryReplicator* InOwner, int32 GridWidth, int32 GridHeight);
...
class MEDCOMINVENTORY_API UInventoryReplicator : public UActorComponent
{
    GENERATED_BODY()
