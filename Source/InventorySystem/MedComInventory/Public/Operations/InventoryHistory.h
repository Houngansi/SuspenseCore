...
#include "InventoryHistory.generated.h"
...
class MEDCOMINVENTORY_API UInventoryHistory : public UObject
{
    GENERATED_BODY()
...
public:
     ...
     */
    void AddOperation(const FInventoryOperation& Operation);
     ...
     */
    TSharedPtr<FInventoryOperation> FindLastOperationOfType(EInventoryOperationType OperationType) const;
...
private:
    ...
    TArray<TSharedPtr<FInventoryOperation>> Operations;
