// MedComInventory/Operations/MedComInventoryTransaction.h
...
#include "MedComInventoryTransaction.generated.h"
...
class MEDCOMINVENTORY_API UMedComInventoryTransaction : public UObject
{
    GENERATED_BODY()
...
public:
     ...
     */
    void Initialize(UMedComInventoryStorage* InStorage, 
                   UMedComInventoryConstraints* InConstraints, 
                   UMedComItemManager* InItemManager,
                   UMedComInventoryEvents* InEvents = nullptr);
...
private:
    ...
    UPROPERTY()
    UMedComInventoryStorage* Storage;
    
    /** Constraints component for validation */
    UPROPERTY()
    UMedComInventoryConstraints* Constraints;
