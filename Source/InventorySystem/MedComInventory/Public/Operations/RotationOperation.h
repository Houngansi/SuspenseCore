 ...
 */
USTRUCT()
struct MEDCOMINVENTORY_API FRotationOperation : public FInventoryOperation
{
    GENERATED_BODY()
    ...
    FRotationOperation()
        : FInventoryOperation(EInventoryOperationType::Rotate, nullptr)
    {
    }
     ...
     */
    static FRotationOperation Create(
        AMedComInventoryItem* InItem, 
        bool InTargetRotation,
     ...
     */
    static FRotationOperation CreateToggle(
        UMedComInventoryComponent* InComponent,
        AMedComInventoryItem* InItem,
        UMedComItemManager* InItemManager
    );
    ...
    virtual ~FRotationOperation() = default;
