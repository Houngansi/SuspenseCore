// MedComInventory/Serialization/MedComInventorySerializer.h
...
#include "MedComInventorySerializer.generated.h"
...
struct MEDCOMINVENTORY_API FSerializedInventoryData
{
    GENERATED_BODY()
...
class MEDCOMINVENTORY_API UMedComInventorySerializer : public UObject
{
    GENERATED_BODY()
...
public:
    ...
    static FSerializedInventoryData SerializeInventory(UMedComInventoryComponent* InventoryComponent);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Inventory|Serialization")
    static bool DeserializeInventory(UMedComInventoryComponent* InventoryComponent, 
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Inventory|Serialization")
    static FString SerializeInventoryToJson(UMedComInventoryComponent* InventoryComponent, 
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Inventory|Serialization")
    static bool DeserializeInventoryFromJson(UMedComInventoryComponent* InventoryComponent, 
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Inventory|Serialization")
    static bool SaveInventoryToFile(UMedComInventoryComponent* InventoryComponent, 
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Inventory|Serialization")
    static bool LoadInventoryFromFile(UMedComInventoryComponent* InventoryComponent, 
                                    const FString& FilePath, 
