...
#include "MedComInventoryTemplate.generated.h"
...
struct MEDCOMINVENTORY_API FInventoryTemplateConfig
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MEDCOMINVENTORY_API FInventoryTemplateAnalysis
{
    GENERATED_BODY()
...
class MEDCOMINVENTORY_API UMedComInventoryTemplate : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Inventory|Template")
    bool ApplyToInventoryComponent(UMedComInventoryComponent* InventoryComponent, 
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Inventory|Template")
    int32 CreateStartingItemsInInventory(UMedComInventoryComponent* InventoryComponent,
                                       const FName& InventoryName = NAME_None) const;
    ...
    static TArray<UMedComInventoryTemplate*> GetPredefinedTemplates(const FGameplayTag& CategoryFilter = FGameplayTag());

    /** Create minimal inventory template */
    UFUNCTION(BlueprintCallable, Category = "Inventory|Factory", CallInEditor)
    static UMedComInventoryTemplate* CreateMinimalTemplate();

    /** Create standard inventory template */
    UFUNCTION(BlueprintCallable, Category = "Inventory|Factory", CallInEditor)
    static UMedComInventoryTemplate* CreateStandardTemplate();

    /** Create expanded inventory template */
    UFUNCTION(BlueprintCallable, Category = "Inventory|Factory", CallInEditor)
    static UMedComInventoryTemplate* CreateExpandedTemplate();

    /** Create survival-focused template */
    UFUNCTION(BlueprintCallable, Category = "Inventory|Factory", CallInEditor)
    static UMedComInventoryTemplate* CreateSurvivalTemplate();

    /** Create specialized template for character class */
    UFUNCTION(BlueprintCallable, Category = "Inventory|Factory", CallInEditor)
    static UMedComInventoryTemplate* CreateClassSpecificTemplate(const FGameplayTag& CharacterClass);
    ...
    UMedComInventoryTemplate* CreateCustomizedCopy(const TMap<FString, FString>& Modifications) const;
