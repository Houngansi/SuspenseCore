...
#include "MedComInventoryUIConnector.generated.h"
 ...
 * - Supports inventory operations through FInventoryOperation system
 */
UCLASS(ClassGroup=(MedCom), meta=(BlueprintSpawnableComponent))
class MEDCOMINVENTORY_API UMedComInventoryUIConnector : public UActorComponent
{
    GENERATED_BODY()
...
public:
    ...
    void SetInventoryComponent(UMedComInventoryComponent* InInventoryComponent);
