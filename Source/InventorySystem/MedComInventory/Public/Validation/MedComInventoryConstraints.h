// MedComInventory/Validation/MedComInventoryConstraints.h
...
#include "MedComInventoryConstraints.generated.h"
...
class MEDCOMINVENTORY_API UMedComInventoryConstraints : public UObject
{
    GENERATED_BODY()
