...
USuspenseInventoryUIConnector::USuspenseInventoryUIConnector()
{
...
void USuspenseInventoryUIConnector::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void USuspenseInventoryUIConnector::SetInventoryComponent(USuspenseInventoryComponent* InInventoryComponent)
{
...
FInventoryCellUI USuspenseInventoryUIConnector::GetCellData(int32 CellIndex) const
{
    FInventoryCellUI CellUI;
    CellUI.Index = CellIndex;
...
FVector2D USuspenseInventoryUIConnector::GetInventoryGridSize() const
{
    if (InventoryComponent)
    {
...
void USuspenseInventoryUIConnector::GetWeightInfo(float& OutCurrentWeight, float& OutMaxWeight, float& OutPercentUsed) const
{
    if (InventoryComponent)
    {
...
void USuspenseInventoryUIConnector::ShowInventory()
{
...
void USuspenseInventoryUIConnector::HideInventory()
{
    if (UIBridge.GetInterface())
    {
...
void USuspenseInventoryUIConnector::ToggleInventory()
{
    if (UIBridge.GetInterface())
    {
...
void USuspenseInventoryUIConnector::RefreshUI()
{
    OnInventoryUpdated();
}
...
bool USuspenseInventoryUIConnector::StartDragOperation(UObject* ItemObject, int32 FromCellIndex)
{
...
bool USuspenseInventoryUIConnector::PreviewDrop(UObject* ItemObject, int32 TargetCellIndex, bool bWantRotate)
{
    if (!InventoryComponent || !ItemObject)
    {
        return false;
...
bool USuspenseInventoryUIConnector::CompleteDrop(UObject* ItemObject, int32 TargetCellIndex, bool bWantRotate)
{
...
void USuspenseInventoryUIConnector::CancelDrag()
{
    CurrentDragOperation.Reset();
...
bool USuspenseInventoryUIConnector::TryStackItems(UObject* SourceItem, UObject* TargetItem, int32 Amount)
{
...
bool USuspenseInventoryUIConnector::SplitItemStack(UObject* SourceItem, int32 SplitAmount, int32 TargetCellIndex)
{
...
bool USuspenseInventoryUIConnector::CanItemsStack(UObject* Item1, UObject* Item2) const
{
...
UTexture2D* USuspenseInventoryUIConnector::GetItemIcon(const FName& ItemID) const
{
    if (ItemID.IsNone())
    {
        return nullptr;
...
FText USuspenseInventoryUIConnector::FormatWeight(float Weight) const
{
...
FText USuspenseInventoryUIConnector::FormatStackQuantity(int32 Current, int32 Max) const
{
    if (Max <= 1)
    {
...
void USuspenseInventoryUIConnector::SubscribeToEvents()
{
    if (!InventoryComponent)
    {
        return;
...
void USuspenseInventoryUIConnector::UnsubscribeFromEvents()
{
    ...
    if (InventoryComponent)
    {
        if (USuspenseInventoryComponent* MedComInvComp = Cast<USuspenseInventoryComponent>(InventoryComponent))
        {
            ...
            // MedComInvComp->OnInventoryUpdated.RemoveDynamic(this, &USuspenseInventoryUIConnector::OnInventoryUpdated);
        }
    }
}

void USuspenseInventoryUIConnector::OnInventoryUpdated()
{
...
void USuspenseInventoryUIConnector::OnItemRemoved(const FName& ItemID, int32 Quantity, int32 SlotIndex)
{
    // Specific handling for item removed if needed
    OnInventoryUpdated();
}

void USuspenseInventoryUIConnector::OnItemMoved(UObject* Item, int32 OldSlot, int32 NewSlot, bool bRotated)
{
