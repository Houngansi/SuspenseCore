// MedComInventory/Components/SuspenseInventoryComponent.h
...
class INVENTORYSYSTEM_API USuspenseInventoryComponent : public UActorComponent, public IMedComInventoryInterface
{
    GENERATED_BODY()
