...
#include "MedComBaseCharacter.generated.h"
...
UCLASS()
class MEDCOMCORE_API AMedComBaseCharacter : public ACharacter, public IMedComCharacterInterface, public IMedComMovementInterface
{
    GENERATED_BODY()
public:
    AMedComBaseCharacter(const FObjectInitializer&);
    ...
    class UMedComCharacterMovementComponent* GetMedComMovementComponent() const;
...
protected:
    ...
    UPROPERTY()
    class UMedComCharacterMovementComponent* MedComMovementComponent;
