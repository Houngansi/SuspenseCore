...
#include "MedComCharacterMovementComponent.generated.h"
 ...
 */
UCLASS()
class MEDCOMCORE_API UMedComCharacterMovementComponent : public UCharacterMovementComponent
{
    GENERATED_BODY()

public:
    UMedComCharacterMovementComponent();
