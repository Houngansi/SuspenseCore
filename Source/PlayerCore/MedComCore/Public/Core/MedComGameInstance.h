...
#include "MedComGameInstance.generated.h"
 ...
 */
UCLASS()
class MEDCOMCORE_API UMedComGameInstance : public UGameInstance
{
    GENERATED_BODY()
...
public:
    ...
    /**
     * Get MedComGameInstance from world context
     * @param WorldContextObject - Any UObject with valid world context
     * @return MedComGameInstance or nullptr
     */
    UFUNCTION(BlueprintPure, Category = "MedCom|Core", meta=(WorldContext="WorldContextObject"))
    static UMedComGameInstance* GetMedComGameInstance(const UObject* WorldContextObject);
...
protected:
 ...
 /**
      ...
      * 
      * REQUIRED: Must be set in BP_MedComGameInstance
