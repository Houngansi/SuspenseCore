...
#include "Core/MedComGameState.h" // Include our custom GameState
#include "MedComGameMode.generated.h"

/**
 * Базовый класс GameMode для MedCom
 * Определяет основные правила игры и системные классы
 */
UCLASS()
class MEDCOMCORE_API AMedComGameMode : public AGameModeBase
{
    GENERATED_BODY()
