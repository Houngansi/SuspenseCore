...
#include "MedComPlayerController.generated.h"

// Forward declarations
class UInputMappingContext;
class UInputAction;
class AMedComBaseCharacter;
 ...
 */
UCLASS()
class MEDCOMCORE_API AMedComPlayerController : public APlayerController, public IMedComControllerInterface
{
    GENERATED_BODY()

public:
    AMedComPlayerController();
...
private:
 ...
 void OnWeaponSlot5(const FInputActionValue& Value);
    ...
    AMedComBaseCharacter* GetMedComCharacter() const;
