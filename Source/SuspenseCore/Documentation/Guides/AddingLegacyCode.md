...
| Legacy директория | Целевой модуль | Дата добавления | Статус | Примечание |
|-------------------|----------------|-----------------|--------|------------|
| MedComShared | BridgeSystem | 2025-11-24 | ⏳ Ожидает анализа | Общие утилиты |
| MedComGAS | GAS | 2025-11-24 | ⏳ Ожидает анализа | Старая GAS реализация |
| MedComCore | PlayerCore | 2025-11-24 | ⏳ Ожидает анализа | Character, Controller |
