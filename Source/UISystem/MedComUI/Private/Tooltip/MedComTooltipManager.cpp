...
#include "Tooltip/MedComTooltipManager.h"
#include "Widgets/Tooltip/MedComItemTooltipWidget.h"
#include "Interfaces/UI/IMedComTooltipInterface.h"
#include "Interfaces/UI/IMedComTooltipSourceInterface.h"
...
void UMedComTooltipManager::Initialize(FSubsystemCollectionBase& Collection)
{
...
void UMedComTooltipManager::Deinitialize()
{
...
void UMedComTooltipManager::UpdateConfiguration(const FTooltipConfiguration& NewConfig)
{
...
void UMedComTooltipManager::SetDefaultTooltipClass(TSubclassOf<UMedComItemTooltipWidget> InTooltipClass)
{
...
void UMedComTooltipManager::RegisterTooltipClass(TSubclassOf<UMedComItemTooltipWidget> TooltipClass, int32 PoolSize)
{
    if (!TooltipClass)
    {
    ...
    {
        if (UMedComItemTooltipWidget* NewTooltip = CreateTooltipWidget(TooltipClass))
        {
...
void UMedComTooltipManager::OnTooltipRequested(const FItemUIData& ItemData, const FVector2D& ScreenPosition)
{
...
void UMedComTooltipManager::OnTooltipHideRequested()
{
    LogVerbose(TEXT("Tooltip hide requested via event"));
    ProcessTooltipHide(nullptr);
}

void UMedComTooltipManager::OnTooltipUpdatePosition(const FVector2D& ScreenPosition)
{
    if (ActiveTooltip && ActiveTooltip->GetClass()->ImplementsInterface(UMedComTooltipInterface::StaticClass()))
    {
        IMedComTooltipInterface::Execute_UpdateTooltipPosition(ActiveTooltip, ScreenPosition);
    }
}
...
void UMedComTooltipManager::ProcessTooltipRequest(
    ...
    TSubclassOf<UUserWidget> TooltipClass)
{
    ...
    {
        bool bCanShow = true;
        if (SourceWidget->GetClass()->ImplementsInterface(UMedComTooltipSourceInterface::StaticClass()))
        {
            bCanShow = IMedComTooltipSourceInterface::Execute_CanShowTooltip(SourceWidget);
        }
    ...
    if (ActiveTooltip->GetClass()->ImplementsInterface(UMedComTooltipInterface::StaticClass()))
    {
        IMedComTooltipInterface::Execute_ShowTooltip(ActiveTooltip, ItemData, ScreenPosition);
    ...
    if (SourceWidget && SourceWidget->GetClass()->ImplementsInterface(UMedComTooltipSourceInterface::StaticClass()))
    {
        IMedComTooltipSourceInterface::Execute_OnTooltipShown(SourceWidget);
    }
}

void UMedComTooltipManager::ProcessTooltipHide(UUserWidget* SourceWidget)
{
    ...
    if (ActiveTooltip->GetClass()->ImplementsInterface(UMedComTooltipInterface::StaticClass()))
    {
        IMedComTooltipInterface::Execute_HideTooltip(ActiveTooltip);
    }
    ...
    if (CurrentSourceWidget.IsValid())
    {
        ...
        {
            if (Widget->GetClass()->ImplementsInterface(UMedComTooltipSourceInterface::StaticClass()))
            {
                IMedComTooltipSourceInterface::Execute_OnTooltipHidden(Widget);
            }
        }
    }
...
FTooltipPool& UMedComTooltipManager::GetOrCreatePool(UClass* TooltipClass)
{
...
UMedComItemTooltipWidget* UMedComTooltipManager::AcquireTooltipWidget(TSubclassOf<UUserWidget> TooltipClass)
{
    if (!TooltipClass)
    {
        return nullptr;
    ...
    UMedComItemTooltipWidget* TooltipWidget = nullptr;
...
void UMedComTooltipManager::ReleaseTooltipWidget(UMedComItemTooltipWidget* Tooltip, UClass* TooltipClass)
{
...
UMedComItemTooltipWidget* UMedComTooltipManager::CreateTooltipWidget(TSubclassOf<UUserWidget> TooltipClass)
{
    if (!TooltipClass)
    {
        return nullptr;
    ...
    UMedComItemTooltipWidget* TooltipWidget = Cast<UMedComItemTooltipWidget>(NewWidget);
    if (!TooltipWidget)
    {
        UE_LOG(LogTemp, Error, TEXT("[TooltipManager] Created widget is not derived from UMedComItemTooltipWidget"));
...
void UMedComTooltipManager::ForceHideTooltip()
{
    if (ActiveTooltip)
    {
        ProcessTooltipHide(CurrentSourceWidget.Get());
...
bool UMedComTooltipManager::IsTooltipActive() const
{
    if (ActiveTooltip && ActiveTooltip->GetClass()->ImplementsInterface(UMedComTooltipInterface::StaticClass()))
    {
        return IMedComTooltipInterface::Execute_IsTooltipVisible(ActiveTooltip);
    }
...
int32 UMedComTooltipManager::GetTotalTooltipCount() const
{
    int32 Total = 0;
...
int32 UMedComTooltipManager::GetActiveTooltipCount() const
{
    int32 Active = 0;
...
void UMedComTooltipManager::GetPoolStats(TSubclassOf<UMedComItemTooltipWidget> TooltipClass, 
...
void UMedComTooltipManager::ClearAllPools()
{
...
void UMedComTooltipManager::LogTooltipSystemState() const
{
...
void UMedComTooltipManager::CleanupTooltipPool(UClass* TooltipClass)
{
    FTooltipPool* Pool = TooltipPools.Find(TooltipClass);
    if (!Pool)
    {
    ...
    for (UMedComItemTooltipWidget* Widget : Pool->AvailableWidgets)
    {
        if (IsValid(Widget))
        {
    ...
    for (UMedComItemTooltipWidget* Widget : Pool->InUseWidgets)
    {
        if (IsValid(Widget))
        {
            Widget->RemoveFromParent();
...
void UMedComTooltipManager::CleanupAllPools()
{
    for (auto& PoolPair : TooltipPools)
    {
...
APlayerController* UMedComTooltipManager::GetOwningPlayerController() const
{
...
UEventDelegateManager* UMedComTooltipManager::GetEventManager() const
{
    if (CachedEventManager)
    {
...
TSubclassOf<UUserWidget> UMedComTooltipManager::DetermineTooltipClass(const FItemUIData& ItemData) const
{
    ...
    if (ItemData.PreferredTooltipClass && Configuration.bAllowMultipleTooltipClasses)
    {
        ...
        if (ItemData.PreferredTooltipClass->IsChildOf(UMedComItemTooltipWidget::StaticClass()))
        {
        ...
        {
            UE_LOG(LogTemp, Warning, TEXT("[TooltipManager] PreferredTooltipClass %s is not derived from UMedComItemTooltipWidget"), 
                *ItemData.PreferredTooltipClass->GetName());
        }
    }
...
void UMedComTooltipManager::LogVerbose(const FString& Message) const
{
