...
UMedComEquipmentContainerWidget::UMedComEquipmentContainerWidget(
    ...
    : Super(ObjectInitializer)
{
    ...
    if (!SlotWidgetClass)
    {
        SlotWidgetClass = UMedComEquipmentSlotWidget::StaticClass();
    }
...
// ===== UMedComBaseContainerWidget Overrides =====

void UMedComEquipmentContainerWidget::InitializeContainer_Implementation(
...
void UMedComEquipmentContainerWidget::UpdateContainer_Implementation(
    const FContainerUIData& ContainerData)
{
    if (!bIsInitialized)
    {
...
void UMedComEquipmentContainerWidget::NativePreConstruct()
{
...
void UMedComEquipmentContainerWidget::NativeConstruct()
{
    ...
    if (!UIBridge)
    {
        ...
        if (IMedComEquipmentUIBridgeWidget* BridgeInterface = 
            IMedComEquipmentUIBridgeWidget::GetEquipmentUIBridge(this))
        {
            UIBridge = Cast<UMedComEquipmentUIBridge>(BridgeInterface);
    ...
    if (UIBridge)
    {
        ...
        DataChangedHandle = UIBridge->OnEquipmentUIDataChanged.AddUObject(
            this, &UMedComEquipmentContainerWidget::HandleEquipmentDataChanged
        );
...
void UMedComEquipmentContainerWidget::NativeDestruct()
{
...
void UMedComEquipmentContainerWidget::SetUIBridge(UMedComEquipmentUIBridge* InBridge)
{
...
void UMedComEquipmentContainerWidget::HandleEquipmentDataChanged(
...
void UMedComEquipmentContainerWidget::RequestDataRefresh_Implementation()
{
...
void UMedComEquipmentContainerWidget::UpdateEquipmentDisplay(
...
void UMedComEquipmentContainerWidget::UpdateAllEquipmentSlots(
    const FEquipmentContainerUIData& EquipmentData)
{
    UE_LOG(LogTemp, Warning, 
    ...
    for (const auto& SlotPair : SlotWidgets)
    {
        ...
        UMedComBaseSlotWidget* BaseSlot = SlotPair.Value;
        ...
        if (UMedComEquipmentSlotWidget* EquipSlot = 
            Cast<UMedComEquipmentSlotWidget>(BaseSlot))
        {
...
UMedComEquipmentSlotWidget* UMedComEquipmentContainerWidget::GetEquipmentSlot(
...
UMedComEquipmentSlotWidget* UMedComEquipmentContainerWidget::GetEquipmentSlotByIndex(
    int32 GlobalIndex) const
{
    return Cast<UMedComEquipmentSlotWidget>(GetSlotWidget(GlobalIndex));
}

FGameplayTag UMedComEquipmentContainerWidget::GetSlotTypeForIndex(int32 GlobalIndex) const
{
    FGameplayTag SlotType;
    int32 LocalIndex;
...
void UMedComEquipmentContainerWidget::RefreshFromLoadoutManager()
{
...
void UMedComEquipmentContainerWidget::ApplyLoadoutConfigurationInternal(
...
void UMedComEquipmentContainerWidget::CreateEquipmentContainers()
{
...
UGridPanel* UMedComEquipmentContainerWidget::CreateGridPanelInContainer(
...
void UMedComEquipmentContainerWidget::CreateSlotsForContainer(
    FGameplayTag SlotType, FEquipmentSlotContainer& Container)
{
    ...
    UMedComEquipmentSlotWidget* SlotWidget = 
        CreateWidget<UMedComEquipmentSlotWidget>(this, SlotWidgetClass);
...
void UMedComEquipmentContainerWidget::CreateSlots()
{
...
void UMedComEquipmentContainerWidget::ClearSlots()
{
    Super::ClearSlots();
...
bool UMedComEquipmentContainerWidget::ValidateSlotsPanel() const
{
    if (!EquipmentCanvas)
    {
...
bool UMedComEquipmentContainerWidget::ValidateAllBorderBindings() const
{
    struct LocalCheck
    {
...
bool UMedComEquipmentContainerWidget::ValidateSlotContainers() const
{
    bool bAllValid = true;
...
void UMedComEquipmentContainerWidget::InitializeAllSlotContainers()
{
...
void UMedComEquipmentContainerWidget::InitializeSlotContainerMap()
{
...
FGameplayTag UMedComEquipmentContainerWidget::GetSlotTypeTag(EEquipmentSlotType SlotType) const
{
    switch (SlotType)
    {
...
int32 UMedComEquipmentContainerWidget::CalculateGlobalIndex(
    const FGameplayTag& SlotType, int32 LocalIndex) const
{
    if (const FEquipmentSlotContainer* Container = EquipmentContainers.Find(SlotType))
    {
...
bool UMedComEquipmentContainerWidget::GetContainerFromGlobalIndex(
...
bool UMedComEquipmentContainerWidget::CalculateOccupiedSlots(
...
bool UMedComEquipmentContainerWidget::CalculateOccupiedSlotsInContainer(
...
FSmartDropZone UMedComEquipmentContainerWidget::FindBestDropZone(
...
bool UMedComEquipmentContainerWidget::IsItemTypeAllowedInSlot(
...
FSlotValidationResult UMedComEquipmentContainerWidget::CanAcceptDrop_Implementation(
    const UDragDropOperation* DragOperation, int32 TargetSlotIndex) const
{
    ...
    const UMedComDragDropOperation* MedComDragOp = 
        Cast<UMedComDragDropOperation>(DragOperation);
...
void UMedComEquipmentContainerWidget::UpdateAllSlotVisibility()
{
    // Hide all first
...
void UMedComEquipmentContainerWidget::SetSlotVisibility(
...
void UMedComEquipmentContainerWidget::ShowAllSlotsForDesign()
{
    for (auto& Pair : AllSlotContainers)
    {
        if (Pair.Value)
...
void UMedComEquipmentContainerWidget::UpdateSlotWidget(
    int32 SlotIndex, const FSlotUIData& SlotData, const FItemUIData& ItemData)
{
    if (UMedComEquipmentSlotWidget* EquipSlot = 
        Cast<UMedComEquipmentSlotWidget>(GetSlotWidget(SlotIndex)))
    {
        FEquipmentSlotUIData EquipSlotData;
        EquipSlotData.SlotIndex = SlotData.SlotIndex;
        EquipSlotData.SlotType = SlotData.SlotType;
...
void UMedComEquipmentContainerWidget::InitializeWidget_Implementation()
{
...
void UMedComEquipmentContainerWidget::SubscribeToEvents()
{
    ...
    if (UEventDelegateManager* EventManager = GetDelegateManager())
    {
        EventManager->OnEquipmentSlotUpdated.AddDynamic(
            this, &UMedComEquipmentContainerWidget::OnEquipmentSlotUpdated);
        EventManager->OnLoadoutChanged.AddDynamic(
            this, &UMedComEquipmentContainerWidget::OnLoadoutChanged);
...
void UMedComEquipmentContainerWidget::UnsubscribeFromEvents()
{
    if (!bEventSubscriptionsActive) { return; }
...
void UMedComEquipmentContainerWidget::OnEquipmentSlotUpdated(
...
void UMedComEquipmentContainerWidget::OnEquipmentUIRefreshRequested(UUserWidget* Widget)
{
    // Legacy event - no longer used in new architecture
    // Kept for compatibility but does nothing
}

void UMedComEquipmentContainerWidget::OnLoadoutChanged(
...
UMedComLoadoutManager* UMedComEquipmentContainerWidget::GetLoadoutManager() const
{
    if (CachedLoadoutManager) { return CachedLoadoutManager; }
    if (UGameInstance* GI = GetGameInstance())
    {
        return GI->GetSubsystem<UMedComLoadoutManager>();
    }
    return nullptr;
}

FName UMedComEquipmentContainerWidget::GetCurrentLoadoutIDFromContext() const
{
    if (APlayerController* PC = GetOwningPlayer())
    {
        if (APlayerState* PS = PC->GetPlayerState<APlayerState>())
        {
            ...
            {
                return IMedComLoadoutInterface::Execute_GetCurrentLoadoutID(PS);
            }
        }
    }
    return NAME_None;
...
IMedComEquipmentUIBridgeWidget* UMedComEquipmentContainerWidget::GetOrCreateEquipmentBridge()
{
    // Deprecated - use direct UIBridge reference instead
    return UIBridge;
}

bool UMedComEquipmentContainerWidget::ProcessEquipmentOperationThroughBridge(
...
bool UMedComEquipmentContainerWidget::GetSlotConfigByType(
...
bool UMedComEquipmentContainerWidget::IsSlotActiveInCurrentLoadout(
    EEquipmentSlotType SlotType) const
{
    return ActiveSlotTypes.Contains(SlotType);
}

void UMedComEquipmentContainerWidget::UpdateSlotVisibilityFromConfig()
{
    UpdateAllSlotVisibility();
}

void UMedComEquipmentContainerWidget::UseDefaultLoadoutForTesting()
{
    UE_LOG(LogTemp, Warning, 
