...
UMedComHealthStaminaWidget::UMedComHealthStaminaWidget(const FObjectInitializer& ObjectInitializer)
...
void UMedComHealthStaminaWidget::NativePreConstruct()
{
...
void UMedComHealthStaminaWidget::NativeConstruct()
{
...
void UMedComHealthStaminaWidget::InitializeWidget_Implementation()
{
...
void UMedComHealthStaminaWidget::UninitializeWidget_Implementation()
{
    // Clean up
    ClearProvider();
...
void UMedComHealthStaminaWidget::InitializeMaterials()
{
...
void UMedComHealthStaminaWidget::UpdateWidget_Implementation(float DeltaTime)
{
...
void UMedComHealthStaminaWidget::InitializeWithASC_Implementation(UAbilitySystemComponent* ASC)
{
    UE_LOG(LogTemp, Warning, TEXT("[HealthStaminaWidget] InitializeWithASC is deprecated - use InitializeWithProvider instead"));
}

void UMedComHealthStaminaWidget::InitializeWithProvider(TScriptInterface<IMedComAttributeProviderInterface> Provider)
{
    ...
    if (HasValidProvider())
    {
        FMedComAttributeData HealthData = IMedComAttributeProviderInterface::Execute_GetHealthData(AttributeProvider.GetObject());
        FMedComAttributeData StaminaData = IMedComAttributeProviderInterface::Execute_GetStaminaData(AttributeProvider.GetObject());
...
void UMedComHealthStaminaWidget::ClearProvider()
{
    AttributeProvider.SetInterface(nullptr);
    AttributeProvider.SetObject(nullptr);
}

bool UMedComHealthStaminaWidget::HasValidProvider() const
{
    return AttributeProvider.GetInterface() != nullptr;
}

void UMedComHealthStaminaWidget::UpdateFromAttributeData(const FMedComAttributeData& HealthData, const FMedComAttributeData& StaminaData)
{
...
void UMedComHealthStaminaWidget::UpdateHealth_Implementation(float CurrentHealth, float MaxHealth)
{
...
float UMedComHealthStaminaWidget::GetHealthPercentage_Implementation() const
{
    return SmoothHealthPercent;
}

void UMedComHealthStaminaWidget::SetAnimateHealthChanges_Implementation(bool bAnimate)
{
    bAnimateHealth = bAnimate;
}

void UMedComHealthStaminaWidget::UpdateStamina_Implementation(float CurrentStamina, float MaxStamina)
{
...
float UMedComHealthStaminaWidget::GetStaminaPercentage_Implementation() const
{
    return SmoothStaminaPercent;
}

void UMedComHealthStaminaWidget::SetAnimateStaminaChanges_Implementation(bool bAnimate)
{
    bAnimateStamina = bAnimate;
}

void UMedComHealthStaminaWidget::SetInterpolationSpeeds_Implementation(float HealthSpeed, float StaminaSpeed, float BarSpeed)
{
...
void UMedComHealthStaminaWidget::ForceImmediateUpdate_Implementation()
{
...
void UMedComHealthStaminaWidget::UpdateHealthUI()
{
    if (HealthBar)
    {
...
void UMedComHealthStaminaWidget::UpdateStaminaUI()
{
    if (StaminaBar)
    {
...
void UMedComHealthStaminaWidget::UpdateHealthMaterialParameters()
{
    if (!HealthBarDynamicMaterial)
        return;
...
void UMedComHealthStaminaWidget::UpdateStaminaMaterialParameters()
{
    if (!StaminaBarDynamicMaterial)
        return;
...
void UMedComHealthStaminaWidget::UpdateFromProvider()
{
    if (!HasValidProvider())
        return;
...
void UMedComHealthStaminaWidget::SubscribeToEvents()
{
...
void UMedComHealthStaminaWidget::UnsubscribeFromEvents()
{
    if (UEventDelegateManager* EventManager = UMedComBaseWidget::GetDelegateManager())
    {
...
void UMedComHealthStaminaWidget::OnHealthUpdated(float Current, float Max, float Percent)
{
    UpdateHealth_Implementation(Current, Max);
}

void UMedComHealthStaminaWidget::OnStaminaUpdated(float Current, float Max, float Percent)
{
    UpdateStamina_Implementation(Current, Max);
}

#if WITH_EDITOR
void UMedComHealthStaminaWidget::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
    ...
    if (PropertyName == GET_MEMBER_NAME_CHECKED(UMedComHealthStaminaWidget, HealthBarMaterial) ||
        PropertyName == GET_MEMBER_NAME_CHECKED(UMedComHealthStaminaWidget, StaminaBarMaterial) ||
        PropertyName == GET_MEMBER_NAME_CHECKED(UMedComHealthStaminaWidget, HealthBarBackgroundTexture) ||
        PropertyName == GET_MEMBER_NAME_CHECKED(UMedComHealthStaminaWidget, StaminaBarBackgroundTexture))
    {
