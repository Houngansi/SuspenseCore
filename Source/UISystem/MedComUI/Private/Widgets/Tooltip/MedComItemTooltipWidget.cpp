...
UMedComItemTooltipWidget::UMedComItemTooltipWidget(const FObjectInitializer& ObjectInitializer)
...
void UMedComItemTooltipWidget::NativeConstruct()
{
...
void UMedComItemTooltipWidget::NativeDestruct()
{
...
void UMedComItemTooltipWidget::NativeTick(const FGeometry& MyGeometry, float InDeltaTime)
{
...
void UMedComItemTooltipWidget::ShowTooltip_Implementation(const FItemUIData& ItemData, const FVector2D& ScreenPosition)
{
...
void UMedComItemTooltipWidget::HideTooltip_Implementation()
{
    // Cancel any timers
    if (GetWorld() && HideTimerHandle.IsValid())
    {
...
void UMedComItemTooltipWidget::UpdateTooltipPosition_Implementation(const FVector2D& ScreenPosition)
{
    CurrentMousePosition = ScreenPosition;
...
bool UMedComItemTooltipWidget::IsTooltipVisible_Implementation() const
{
    return GetVisibility() != ESlateVisibility::Collapsed && 
           GetVisibility() != ESlateVisibility::Hidden;
}

void UMedComItemTooltipWidget::SetTooltipAnchor_Implementation(const FVector2D& Anchor, const FVector2D& Pivot)
{
...
void UMedComItemTooltipWidget::LoadFullItemData()
{
    FullItemData = nullptr;
    ...
    FMedComUnifiedItemData* FoundData = ItemDataTable->FindRow<FMedComUnifiedItemData>(
...
void UMedComItemTooltipWidget::UpdateDisplayData()
{
    if (!ValidateWidgetBindings())
    {
        return;
...
void UMedComItemTooltipWidget::DisplayWeaponAttributes()
{
...
void UMedComItemTooltipWidget::DisplayArmorAttributes()
{
...
void UMedComItemTooltipWidget::DisplayAmmoAttributes()
{
...
float UMedComItemTooltipWidget::ExtractAttributeValue(
...
void UMedComItemTooltipWidget::AddAttributeLine(const FString& AttributeName, float Value, const FString& Format)
{
...
void UMedComItemTooltipWidget::ClearAttributeLines()
{
    if (!AttributesContainer)
        return;
...
void UMedComItemTooltipWidget::RepositionTooltip()
{
...
FVector2D UMedComItemTooltipWidget::GetViewportSize() const
{
...
FText UMedComItemTooltipWidget::GameplayTagToText(const FGameplayTag& Tag) const
{
    if (!Tag.IsValid())
    {
...
FText UMedComItemTooltipWidget::FormatWeight(float Weight) const
{
    return FText::Format(
...
FText UMedComItemTooltipWidget::FormatGridSize(const FIntPoint& GridSize) const
{
    return FText::Format(
...
void UMedComItemTooltipWidget::UpdateFade(float DeltaTime)
{
...
void UMedComItemTooltipWidget::StartFadeIn()
{
    bIsFading = true;
    TargetFadeAlpha = 1.0f;
...
void UMedComItemTooltipWidget::StartFadeOut()
{
    bIsFading = true;
    TargetFadeAlpha = 0.0f;
}

void UMedComItemTooltipWidget::ApplyFade(float Alpha)
{
...
bool UMedComItemTooltipWidget::ValidateWidgetBindings() const
{
    bool bAllValid = true;
