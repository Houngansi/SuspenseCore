...
#include "MedComInventoryUIBridge.generated.h"

// Forward declarations
class UMedComUIManager;
class UMedComInventoryWidget;
 ...
 */
UCLASS()
class MEDCOMUI_API UMedComInventoryUIBridge : public UObject, public IMedComInventoryUIBridgeWidget
{
    GENERATED_BODY()
...
public:
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "UI|Bridge")
    void SetInventoryInterface(TScriptInterface<IMedComInventoryInterface> InInventory);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "UI|Bridge")
    void SetInventoryWidgetClass(TSubclassOf<UMedComInventoryWidget> WidgetClass);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "UI|Bridge")
    bool RemoveItemFromInventorySlot(int32 SlotIndex, FInventoryItemInstance& OutRemovedInstance);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "UI|Bridge")
    bool RestoreItemToInventory(const FInventoryItemInstance& ItemInstance);

    // =====================================================
    // IMedComInventoryUIBridgeWidget Interface
    // =====================================================
     ...
     */
    static void RegisterBridge(UMedComInventoryUIBridge* Bridge);
     ...
     */
    UMedComInventoryWidget* FindInventoryWidgetInCharacterScreen() const;

    /**
     * Initialize inventory widget with current game data
     */
    void InitializeInventoryWidgetWithData(UMedComInventoryWidget* Widget);

    /**
     * Update inventory widget with latest data
     */
    void UpdateInventoryWidgetData(UMedComInventoryWidget* Widget);
...
protected:
    ...
    TScriptInterface<IMedComInventoryInterface> GameInventory;

    /** Widget class to use for inventory display */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "UI|Bridge")
    TSubclassOf<UMedComInventoryWidget> InventoryWidgetClass;
    ...
    mutable TWeakObjectPtr<UMedComInventoryWidget> CachedInventoryWidget;
...
private:
 ...
 // =====================================================
    ...
    UMedComInventoryWidget* GetCachedInventoryWidget() const;
    ...
    class UMedComUIManager* GetUIManager() const;
