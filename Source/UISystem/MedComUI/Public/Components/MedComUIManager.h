...
#include "MedComUIManager.generated.h"

// Forward declarations
class UUserWidget;
class UMedComBaseWidget;
class UMedComBaseLayoutWidget;
class UEventDelegateManager;
class UMedComUpperTabBar;
class UMedComInventoryUIBridge;
class UMedComEquipmentUIBridge;
 ...
 */
UCLASS()
class MEDCOMUI_API UMedComUIManager : public UGameInstanceSubsystem
{
    GENERATED_BODY()
...
public:
    ...
    static UMedComUIManager* Get(const UObject* WorldContext);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "UI|Manager")
    UUserWidget* GetWidgetFromLayout(UMedComBaseLayoutWidget* LayoutWidget, FGameplayTag WidgetTag) const;
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "UI|Manager")
    UMedComInventoryUIBridge* CreateInventoryUIBridge(APlayerController* PlayerController);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "UI|Manager")
    UMedComInventoryUIBridge* GetInventoryUIBridge() const;
    ...
    UMedComEquipmentUIBridge* GetEquipmentUIBridge() const;
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "UI|Equipment")
    UMedComEquipmentUIBridge* CreateEquipmentUIBridge(APlayerController* PlayerController);
    ...
    FItemUIData ConvertUnifiedItemDataToUI(const FMedComUnifiedItemData& UnifiedData, int32 Quantity = 1) const;
 ...
 /**
      ...
      */
 void ConnectEquipmentBridgeToGameComponent(UMedComEquipmentUIBridge* Bridge, APlayerController* PlayerController);
...
protected:
     ...
     */
    void InitializeInventoryBridgeForLayout(APlayerController* PlayerController, UMedComBaseLayoutWidget* LayoutWidget);
     ...
     */
    void InitializeEquipmentBridgeForLayout(APlayerController* PlayerController, UMedComBaseLayoutWidget* LayoutWidget);
     ...
     */
    void AnalyzeLayoutAndCreateBridges(APlayerController* PlayerController, UMedComBaseLayoutWidget* LayoutWidget);
     ...
     */
    UMedComUpperTabBar* FindTabBarInCharacterScreen(UUserWidget* CharacterScreen) const;
     ...
     * @param PlayerController Controller to search for component
     */
    void ConnectInventoryBridgeToGameComponent(UMedComInventoryUIBridge* Bridge, APlayerController* PlayerController);
     ...
     */
    void SetupUniversalLayoutRefresh(UMedComBaseLayoutWidget* LayoutWidget);
     ...
     */
    void RefreshAllWidgetsInLayout(UMedComBaseLayoutWidget* LayoutWidget);
...
private:
    ...
    TMap<FGameplayTag, FMedComWidgetInfo> ConfigurationCache;
    ...
    UPROPERTY()
    UMedComInventoryUIBridge* InventoryUIBridge;
    
    // Equipment UI Bridge
    UPROPERTY()
    UMedComEquipmentUIBridge* EquipmentUIBridge;
