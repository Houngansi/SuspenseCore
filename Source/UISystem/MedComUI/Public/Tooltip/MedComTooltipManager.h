...
#include "MedComTooltipManager.generated.h"

// Forward declarations
class UMedComItemTooltipWidget;
class UUserWidget;
...
struct MEDCOMUI_API FTooltipConfiguration
{
    GENERATED_BODY()

    /** Default tooltip widget class when none specified */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Tooltip")
    TSubclassOf<UMedComItemTooltipWidget> DefaultTooltipClass;
 ...
 */
USTRUCT()
struct MEDCOMUI_API FTooltipPool
{
    GENERATED_BODY()

    /** Available widgets ready to be used */
    UPROPERTY()
    TArray<UMedComItemTooltipWidget*> AvailableWidgets;
    
    /** Widgets currently being displayed */
    UPROPERTY()
    TArray<UMedComItemTooltipWidget*> InUseWidgets;
...
class MEDCOMUI_API UMedComTooltipManager : public UGameInstanceSubsystem
{
    GENERATED_BODY()
...
public:
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Tooltip|Config")
    void SetDefaultTooltipClass(TSubclassOf<UMedComItemTooltipWidget> InTooltipClass);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Tooltip|Config")
    void RegisterTooltipClass(TSubclassOf<UMedComItemTooltipWidget> TooltipClass, int32 PoolSize = 3);
    ...
    void GetPoolStats(TSubclassOf<UMedComItemTooltipWidget> TooltipClass, int32& OutPoolSize, int32& OutInUse) const;
...
private:
    ...
    UPROPERTY()
    UMedComItemTooltipWidget* ActiveTooltip;
     ...
     */
    UMedComItemTooltipWidget* AcquireTooltipWidget(TSubclassOf<UUserWidget> TooltipClass);
     ...
     */
    void ReleaseTooltipWidget(UMedComItemTooltipWidget* Tooltip, UClass* TooltipClass);
     ...
     */
    UMedComItemTooltipWidget* CreateTooltipWidget(TSubclassOf<UUserWidget> TooltipClass);
