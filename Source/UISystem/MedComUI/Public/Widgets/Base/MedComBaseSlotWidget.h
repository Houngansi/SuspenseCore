...
#include "Interfaces/UI/IMedComSlotUIInterface.h"
#include "Interfaces/UI/IMedComDraggableInterface.h"
#include "Interfaces/UI/IMedComDropTargetInterface.h"
...
#include "MedComBaseSlotWidget.generated.h"
 ...
 */
UCLASS(Abstract)
class MEDCOMUI_API UMedComBaseSlotWidget : public UUserWidget,
    public IMedComSlotUIInterface,
    public IMedComDraggableInterface,
    public IMedComDropTargetInterface,
    public IMedComTooltipSourceInterface
{
    GENERATED_BODY()

public:
    UMedComBaseSlotWidget(const FObjectInitializer& ObjectInitializer);
...
protected:
    ...
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Slot Config|Tooltip")
    TSubclassOf<UMedComItemTooltipWidget> CustomTooltipClass;
    ...
    UPROPERTY()
    UMedComBaseContainerWidget* OwningContainer;
...
public:
    ...
    void SetOwningContainer(UMedComBaseContainerWidget* Container);
    
    /** Get the owning container widget */
    UFUNCTION(BlueprintPure, Category = "Slot")
    UMedComBaseContainerWidget* GetOwningContainer() const { return OwningContainer; }
