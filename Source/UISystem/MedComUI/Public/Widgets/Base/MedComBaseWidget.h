...
#include "MedComBaseWidget.generated.h"
 ...
 * - Implements IMedComUIWidget interface for standardized widget behavior
 ...
 */
UCLASS(Abstract)
class MEDCOMUI_API UMedComBaseWidget : public UUserWidget, public IMedComUIWidgetInterface
{
    GENERATED_BODY()

public:
    UMedComBaseWidget(const FObjectInitializer& ObjectInitializer);
    ...
    //================================================
    // IMedComUIWidget Interface Implementation
    //================================================
