...
#include "MedComDragDropOperation.generated.h"
 ...
 * All logic delegated to UMedComDragDropHandler
 */
UCLASS()
class MEDCOMUI_API UMedComDragDropOperation : public UDragDropOperation
{
    GENERATED_BODY()
...
public:
     ...
     */
    UFUNCTION(BlueprintPure, Category = "DragDrop")
    UMedComBaseSlotWidget* GetSourceWidget() const { return SourceWidget.Get(); }
...
private:
    friend class UMedComDragDropHandler; // Only handler can create/manage
    ...
    UPROPERTY()
    TWeakObjectPtr<UMedComBaseSlotWidget> SourceWidget;
    
    /** Handler managing this operation */
    UPROPERTY()
    TWeakObjectPtr<UMedComDragDropHandler> Handler;
};