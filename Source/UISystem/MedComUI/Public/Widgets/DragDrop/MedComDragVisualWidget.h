...
#include "MedComDragVisualWidget.generated.h"
 ...
 */
UCLASS()
class MEDCOMUI_API UMedComDragVisualWidget : public UUserWidget
{
    GENERATED_BODY()

public:
    UMedComDragVisualWidget(const FObjectInitializer& ObjectInitializer);
