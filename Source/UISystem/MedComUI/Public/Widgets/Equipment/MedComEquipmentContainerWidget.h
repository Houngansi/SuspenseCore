...
#include "MedComEquipmentContainerWidget.generated.h"
...
class UBorder;
class UTextBlock;
class UMedComEquipmentSlotWidget;
...
struct FEquipmentSlotContainer
{
    ...
    UPROPERTY()
    TArray<UMedComEquipmentSlotWidget*> SlotWidgets;
 ...
 */
UCLASS(Abstract)
class MEDCOMUI_API UMedComEquipmentContainerWidget : public UMedComBaseContainerWidget
{
    GENERATED_BODY()

public:
    UMedComEquipmentContainerWidget(const FObjectInitializer& ObjectInitializer);
    ...
    //~ Begin UMedComBaseContainerWidget
    ...
    //~ End UMedComBaseContainerWidget

    //~ Begin IMedComUIWidgetInterface
    virtual void InitializeWidget_Implementation() override;
    //~ End IMedComUIWidgetInterface

    //~ Begin IMedComContainerUIInterface
    ...
    //~ End IMedComContainerUIInterface
    ...
    void SetUIBridge(UMedComEquipmentUIBridge* InBridge);
     ...
     */
    UFUNCTION(BlueprintCallable, Category="Equipment")
    UMedComEquipmentUIBridge* GetUIBridge() const { return UIBridge; }
    ...
    UFUNCTION(BlueprintCallable, Category="Equipment")
    UMedComEquipmentSlotWidget* GetEquipmentSlot(const FGameplayTag& SlotType, int32 LocalIndex) const;

    /** Get equipment slot widget by global index */
    UFUNCTION(BlueprintCallable, Category="Equipment")
    UMedComEquipmentSlotWidget* GetEquipmentSlotByIndex(int32 GlobalIndex) const;
...
protected:
    ...
    UPROPERTY() UMedComLoadoutManager* CachedLoadoutManager;
...
private:
     ...
     */
    UPROPERTY()
    UMedComEquipmentUIBridge* UIBridge = nullptr;
    ...
    IMedComEquipmentUIBridgeWidget* GetOrCreateEquipmentBridge();
