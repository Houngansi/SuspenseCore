...
#include "MedComCrosshairWidget.generated.h"
 ...
 * - Inherits from UMedComBaseWidget for standardized lifecycle
 * - Implements IMedComCrosshairWidgetInterface for crosshair-specific functionality
 ...
 */
UCLASS()
class MEDCOMUI_API UMedComCrosshairWidget : public UMedComBaseWidget, public IMedComCrosshairWidgetInterface
{
    GENERATED_BODY()

public:
    UMedComCrosshairWidget(const FObjectInitializer& ObjectInitializer);

    //================================================
    // UMedComBaseWidget Interface
    //================================================
    ...
    //================================================
    // IMedComCrosshairWidget Interface
    //================================================
