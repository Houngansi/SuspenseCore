...
#include "MedComHealthStaminaWidget.generated.h"
 ...
 */
UCLASS()
class MEDCOMUI_API UMedComHealthStaminaWidget : public UMedComBaseWidget, public IMedComHealthStaminaWidgetInterface
{
    GENERATED_BODY()

public:
    UMedComHealthStaminaWidget(const FObjectInitializer& ObjectInitializer);
    ...
    // IMedComHealthStaminaWidgetInterface implementation
    ...
    void InitializeWithProvider(TScriptInterface<IMedComAttributeProviderInterface> Provider);
    ...
    UFUNCTION(BlueprintCallable, Category = "UI|Attributes")
    void UpdateFromAttributeData(const FMedComAttributeData& HealthData, const FMedComAttributeData& StaminaData);
