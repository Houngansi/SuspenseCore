...
#include "MedComMainHUDWidget.generated.h"

// Forward declarations
class UMedComHealthStaminaWidget;
class UMedComCrosshairWidget;
class UMedComWeaponUIWidget;
class UMedComInventoryWidget;
class UTextBlock;
class IMedComAttributeProviderInterface;
 ...
 */
UCLASS()
class MEDCOMUI_API UMedComMainHUDWidget : public UMedComBaseWidget, public IMedComHUDWidgetInterface
{
    GENERATED_BODY()

public:
    UMedComMainHUDWidget(const FObjectInitializer& ObjectInitializer);

    //~ Begin UMedComBaseWidget Interface
    ...
    //~ End UMedComBaseWidget Interface

    //~ Begin IMedComHUDWidgetInterface Interface
    ...
    //~ End IMedComHUDWidgetInterface Interface
    ...
    void SetupWithProvider(TScriptInterface<IMedComAttributeProviderInterface> Provider);
...
protected:
    ...
    UMedComHealthStaminaWidget* HealthStaminaWidget;
    ...
    UMedComCrosshairWidget* DynamicCrosshair;
     ...
     */
    UPROPERTY(BlueprintReadOnly, meta = (BindWidgetOptional))
    UMedComWeaponUIWidget* WeaponInfoWidget;
     ...
     */
    UPROPERTY(BlueprintReadOnly, meta = (BindWidgetOptional))
    UMedComCharacterScreen* CharacterScreen;
     ...
     */
    UPROPERTY(BlueprintReadOnly, meta = (BindWidgetOptional))
    UMedComInventoryWidget* InventoryWidget;
...
private:
    ...
    // Internal state
    UPROPERTY()
    TScriptInterface<IMedComAttributeProviderInterface> AttributeProvider;
