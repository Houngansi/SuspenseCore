...
#include "MedComInventorySlotWidget.generated.h"
 ...
 */
USTRUCT()
struct MEDCOMUI_API FInventorySlotVisualProperties
{
    GENERATED_BODY()
 ...
 */
UCLASS()
class MEDCOMUI_API UMedComInventorySlotWidget : public UMedComBaseSlotWidget
{
    GENERATED_BODY()

public:
    UMedComInventorySlotWidget(const FObjectInitializer& ObjectInitializer);
...
protected:
    ...
    UMedComInventoryWidget* GetInventoryOwner() const;
