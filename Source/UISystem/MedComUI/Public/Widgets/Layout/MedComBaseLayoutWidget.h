...
#include "Interfaces/UI/IMedComLayoutInterface.h"
#include "MedComBaseLayoutWidget.generated.h"
 ...
 */
UCLASS(Abstract)
class MEDCOMUI_API UMedComBaseLayoutWidget : public UMedComBaseWidget, public IMedComLayoutInterface
{
    GENERATED_BODY()

public:
    UMedComBaseLayoutWidget(const FObjectInitializer& ObjectInitializer);
    ...
    //~ Begin IMedComUIWidgetInterface Interface
    virtual void InitializeWidget_Implementation() override;
    virtual void UninitializeWidget_Implementation() override;
    //~ End IMedComUIWidgetInterface Interface

    //~ Begin IMedComLayoutInterface Interface
    ...
    //~ End IMedComLayoutInterface Interface
...
protected:
     ...
     */
    virtual UPanelWidget* GetLayoutPanel() const PURE_VIRTUAL(UMedComBaseLayoutWidget::GetLayoutPanel, return nullptr;);

    /**
     * Add widget to the layout panel
     * Must be overridden by derived classes for specific layout logic
     */
    virtual bool AddWidgetToPanel(UUserWidget* Widget, const FLayoutWidgetConfig* Config) PURE_VIRTUAL(UMedComBaseLayoutWidget::AddWidgetToPanel, return false;);
