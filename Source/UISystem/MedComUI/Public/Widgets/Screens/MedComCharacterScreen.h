...
#include "MedComCharacterScreen.generated.h"
 ...
 */
UCLASS()
class MEDCOMUI_API UMedComCharacterScreen : public UMedComBaseWidget, public IMedComScreenInterface
{
    GENERATED_BODY()

public:
    UMedComCharacterScreen(const FObjectInitializer& ObjectInitializer);
    ...
    //~ Begin IMedComScreenInterface Interface
    ...
    //~ End IMedComScreenInterface Interface
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "UI|Character")
    UMedComUpperTabBar* GetTabBar() const { return UpperTabBar; }
...
protected:
    ...
    UMedComUpperTabBar* UpperTabBar;
