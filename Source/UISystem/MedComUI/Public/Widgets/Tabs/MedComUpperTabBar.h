...
#include "MedComUpperTabBar.generated.h"
...
struct FMedComTabConfig
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (EditCondition = "LayoutType == ETabContentLayoutType::Layout"))
    TSubclassOf<UMedComBaseLayoutWidget> LayoutWidgetClass;
 ...
 */
UCLASS()
class MEDCOMUI_API UMedComUpperTabBar : public UMedComBaseWidget, public IMedComTabBarInterface
{
    GENERATED_BODY()

public:
    UMedComUpperTabBar(const FObjectInitializer& ObjectInitializer);

    //=============================================================================
    // IMedComTabBarInterface Implementation
    //=============================================================================
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "UI|TabBar")
    UMedComBaseLayoutWidget* GetTabLayoutWidget(int32 TabIndex) const;
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "UI|TabBar")
    FMedComTabConfig GetTabConfig(int32 TabIndex) const;
...
protected:
    ...
    TArray<FMedComTabConfig> TabConfigs;
...
private:
    ...
    UButton* CreateTabButton(const FMedComTabConfig& Config, int32 Index);
    ...
    UUserWidget* CreateSingleWidgetContent(const FMedComTabConfig& Config);
    
    /** Create layout widget content */
    UUserWidget* CreateLayoutWidgetContent(const FMedComTabConfig& Config);
