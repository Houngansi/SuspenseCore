...
#include "MedComItemTooltipWidget.generated.h"
 ...
 */
UCLASS()
class MEDCOMUI_API UMedComItemTooltipWidget : public UUserWidget, public IMedComTooltipInterface
{
    GENERATED_BODY()

public:
    UMedComItemTooltipWidget(const FObjectInitializer& ObjectInitializer);

    // === IMedComTooltipInterface Implementation ===
...
private:
     ...
     */
    const FMedComUnifiedItemData* FullItemData;
