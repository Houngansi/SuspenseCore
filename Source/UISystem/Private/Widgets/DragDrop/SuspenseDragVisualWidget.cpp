...
// Static members
TMap<FString, TWeakObjectPtr<UTexture2D>> USuspenseDragVisualWidget::IconTextureCache;
FCriticalSection USuspenseDragVisualWidget::IconCacheMutex;

USuspenseDragVisualWidget::USuspenseDragVisualWidget(const FObjectInitializer& ObjectInitializer)
...
void USuspenseDragVisualWidget::NativePreConstruct()
{
...
void USuspenseDragVisualWidget::NativeConstruct()
{
...
void USuspenseDragVisualWidget::NativeDestruct()
{
...
void USuspenseDragVisualWidget::NativeTick(const FGeometry& MyGeometry, float InDeltaTime)
{
...
void USuspenseDragVisualWidget::AutoBindWidgets()
{
    if (!WidgetTree)
    {
        return;
...
bool USuspenseDragVisualWidget::ValidateWidgetBindings() const
{
    bool bAllValid = true;
...
bool USuspenseDragVisualWidget::InitializeDragVisual(const FDragDropUIData& InDragData, float CellSize)
{
    // Validate input data
...
void USuspenseDragVisualWidget::SetDragData(const FDragDropUIData& InDragData)
{
    // Validate input
    if (!InDragData.IsValidDragData())
    {
...
void USuspenseDragVisualWidget::UpdateValidState(bool bIsValid)
{
    if (!BackgroundBorder)
    {
...
void USuspenseDragVisualWidget::SetCellSize(float CellSize)
{
    if (CellSize <= 0.0f)
    {
        return;
...
void USuspenseDragVisualWidget::ShowPlacementPreview(const FVector2D& ScreenPosition, bool bIsValid)
{
    if (!PreviewGhost)
    {
        return;
...
void USuspenseDragVisualWidget::AnimateSnapFeedback(const FVector2D& TargetPosition, float SnapStrength)
{
...
void USuspenseDragVisualWidget::PreviewRotation(bool bShowRotated)
{
...
void USuspenseDragVisualWidget::UpdateStackingFeedback(int32 StackCount, int32 MaxStack)
{
    if (!StackingText)
    {
        return;
...
void USuspenseDragVisualWidget::SetVisualMode(EDragVisualMode NewMode)
{
...
void USuspenseDragVisualWidget::SetLowPerformanceMode(bool bEnable)
{
...
bool USuspenseDragVisualWidget::UpdateVisuals()
{
...
void USuspenseDragVisualWidget::InvalidateVisual()
{
...
void USuspenseDragVisualWidget::UpdateVisualsInternal()
{
    // Validate state
...
void USuspenseDragVisualWidget::LoadIconAsync(const FString& IconPath)
{
    // Check cache first
    {
    ...
    IconStreamingHandle = StreamableManager.RequestAsyncLoad(
        SoftPath,
        FStreamableDelegate::CreateUObject(this, &USuspenseDragVisualWidget::OnIconLoaded),
        FStreamableManager::AsyncLoadHighPriority
    );
}

void USuspenseDragVisualWidget::OnIconLoaded()
{
...
void USuspenseDragVisualWidget::ResetVisual()
{
...
void USuspenseDragVisualWidget::UpdateAnimations(float DeltaTime)
{
...
void USuspenseDragVisualWidget::ApplyVisualMode()
{
...
UBorder* USuspenseDragVisualWidget::GetHighlightBorder() const
{
    if (!WidgetTree)
    {
        return nullptr;
...
void USuspenseDragVisualWidget::PlayModeAnimation(EDragVisualMode Mode)
{
