...
USuspenseEquipmentSlotWidget::USuspenseEquipmentSlotWidget(
...
void USuspenseEquipmentSlotWidget::NativePreConstruct()
{
...
void USuspenseEquipmentSlotWidget::NativeConstruct()
{
...
void USuspenseEquipmentSlotWidget::InitializeEquipmentSlot(
...
void USuspenseEquipmentSlotWidget::UpdateEquipmentSlot(
    const FEquipmentSlotUIData& SlotData)
{
...
USuspenseEquipmentContainerWidget* USuspenseEquipmentSlotWidget::GetOwningEquipmentContainer() const
{
    return Cast<USuspenseEquipmentContainerWidget>(GetOwningContainer());
}

void USuspenseEquipmentSlotWidget::InitializeSlot_Implementation(
...
void USuspenseEquipmentSlotWidget::UpdateSlot_Implementation(
    const FSlotUIData& SlotData, const FItemUIData& ItemData)
{
...
bool USuspenseEquipmentSlotWidget::CanBeDragged_Implementation() const
{
...
void USuspenseEquipmentSlotWidget::UpdateVisualState()
{
...
void USuspenseEquipmentSlotWidget::UpdateSlotTypeDisplay()
{
...
void USuspenseEquipmentSlotWidget::UpdateRequirementsDisplay()
{
...
void USuspenseEquipmentSlotWidget::UpdateDurabilityDisplay()
{
...
void USuspenseEquipmentSlotWidget::UpdateItemIcon()
{
...
void USuspenseEquipmentSlotWidget::ApplyItemIcon(const FItemUIData& ItemData)
{
...
void USuspenseEquipmentSlotWidget::ClearItemIcon()
{
    UE_LOG(LogTemp, VeryVerbose, 
...
bool USuspenseEquipmentSlotWidget::AcceptsItemType(const FGameplayTag& ItemType) const
{
    if (!ItemType.IsValid())
    {
        return false;
...
UTexture2D* USuspenseEquipmentSlotWidget::GetSlotTypeIcon() const
{
...
FLinearColor USuspenseEquipmentSlotWidget::GetSlotTypeColor() const
{
