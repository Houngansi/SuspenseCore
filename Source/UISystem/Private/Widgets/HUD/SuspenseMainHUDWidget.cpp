...
void USuspenseMainHUDWidget::SetupForPlayer_Implementation(APawn* Character)
{
    ...
    if (Character->GetClass()->ImplementsInterface(USuspenseAttributeProviderInterface::StaticClass()))
    {
        ...
        Provider.SetInterface(Cast<ISuspenseAttributeProviderInterface>(Character));
...
void USuspenseMainHUDWidget::SetupWithProvider(TScriptInterface<ISuspenseAttributeProviderInterface> Provider)
{
...
void USuspenseMainHUDWidget::InitializeChildWidgets()
{
    ...
    if (HealthStaminaWidget)
    {
        FGameplayTag CurrentTag = ISuspenseUIWidgetInterface::Execute_GetWidgetTag(HealthStaminaWidget);
        if (!CurrentTag.IsValid())
        {
            ISuspenseUIWidgetInterface::Execute_SetWidgetTag(
                HealthStaminaWidget, 
    ...
    if (DynamicCrosshair)
    {
        FGameplayTag CurrentTag = ISuspenseUIWidgetInterface::Execute_GetWidgetTag(DynamicCrosshair);
        if (!CurrentTag.IsValid())
        {
            ISuspenseUIWidgetInterface::Execute_SetWidgetTag(
                DynamicCrosshair,
    ...
    if (WeaponInfoWidget)
    {
        FGameplayTag CurrentTag = ISuspenseUIWidgetInterface::Execute_GetWidgetTag(WeaponInfoWidget);
        if (!CurrentTag.IsValid())
        {
            ISuspenseUIWidgetInterface::Execute_SetWidgetTag(
                WeaponInfoWidget,
    ...
    if (CharacterScreen)
    {
        FGameplayTag CurrentTag = ISuspenseUIWidgetInterface::Execute_GetWidgetTag(CharacterScreen);
        if (!CurrentTag.IsValid())
        {
            ISuspenseUIWidgetInterface::Execute_SetWidgetTag(
                CharacterScreen,
    ...
    if (InventoryWidget)
    {
        FGameplayTag CurrentTag = ISuspenseUIWidgetInterface::Execute_GetWidgetTag(InventoryWidget);
        if (!CurrentTag.IsValid())
        {
            ISuspenseUIWidgetInterface::Execute_SetWidgetTag(
                InventoryWidget,
