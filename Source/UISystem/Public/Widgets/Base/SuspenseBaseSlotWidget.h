...
#include "Interfaces/UI/ISuspenseSlotUIInterface.h"
#include "Interfaces/UI/ISuspenseDraggableInterface.h"
#include "Interfaces/UI/ISuspenseDropTargetInterface.h"
...
class UISYSTEM_API USuspenseBaseSlotWidget : public UUserWidget,
    public ISuspenseSlotUIInterface,
    public ISuspenseDraggableInterface,
    public ISuspenseDropTargetInterface,
    public ISuspenseTooltipSourceInterface
{
    GENERATED_BODY()
