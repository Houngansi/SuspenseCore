...
class UButton;
class UGridSlot;
class USuspenseInventorySlotWidget;
 ...
 */
UCLASS()
class UISYSTEM_API USuspenseInventoryWidget : public USuspenseBaseContainerWidget
{
    GENERATED_BODY()

public:
    USuspenseInventoryWidget(const FObjectInitializer& ObjectInitializer);
...
private:
     ...
     */
    void UpdateGridSlotSpan(USuspenseInventorySlotWidget* SlotWidget, const FItemUIData& ItemData);
