...
public:
	...
	static bool IsOperationSuccess(const FSuspenseCoreInventoryOperationResult& Result);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "SuspenseCore|Inventory|Results")
	static FString GetResultMessage(const FSuspenseCoreInventoryOperationResult& Result);
